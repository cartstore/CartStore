...
?>
 <div class="page-header">  <span class="pull-right"> <?php
...
?>  
  ...
  <?php
      echo tep_draw_radio_field('gender', 'm') . '' . MALE . '' . tep_draw_radio_field('gender', 'f') . '' . FEMALE . '' . (tep_not_null(ENTRY_GENDER_TEXT) ? '' : '');
?>
  <div>
  <?php
  }
...
?> *
  ...
  <?php
  echo tep_draw_input_field('firstname') . '' . (tep_not_null(ENTRY_FIRST_NAME_TEXT) ? '' : '');
?>
  </div>
...
?>
   * </label>
  <?php
  echo tep_draw_input_field('lastname') . '' . (tep_not_null(ENTRY_LAST_NAME_TEXT) ? '' : '');
?>
  </div>
  <?php
  if (ACCOUNT_DOB == 'true') {
...
?>
  ...
  <?php
      echo tep_draw_input_field('dob') . '' . (tep_not_null(ENTRY_DATE_OF_BIRTH_TEXT) ? '' : '');
?>
  </div>
  <?php
  }
...
?> *
  ...
  <?php
  echo tep_draw_input_field('email_address') . '' . (tep_not_null(ENTRY_EMAIL_ADDRESS_TEXT) ? '' : '');
?>
  </div>
  <?php
  if (ACCOUNT_COMPANY == 'true') {
...
?>
   * </label>
  <?php
  echo tep_draw_input_field('street_address') . '' . (tep_not_null(ENTRY_STREET_ADDRESS_TEXT) ? '' : '');
?>
  </div>
   <div class="form-group">
  <label>
...
?>
  * </label>
  <?php
  echo tep_draw_input_field('postcode') . '' . (tep_not_null(ENTRY_POST_CODE_TEXT) ? '' : '');
?>
  </div>
   <div class="form-group">
  <label>
 ...
 * </label>
  <?php
      echo tep_draw_password_field('password',null,'id="password-field"') . '' . (tep_not_null(ENTRY_PASSWORD_TEXT) ? '' : '');
?>
   </div>
...
?>
  * </label>
  <?php
      echo tep_draw_password_field('confirmation') . '' . (tep_not_null(ENTRY_PASSWORD_CONFIRMATION_TEXT) ? '' : '');
?>
  </div>
  <?php
      } else
