...
?>
			...
			<a class="button" href="<?php echo "$PHP_SELF?listing=date-asc"; ?>"><?php echo ''.IMAGE_BUTTON_UPSORT.''; ?></a><br><a class="button" href="<?php echo "$PHP_SELF?listing=date-desc"; ?>"><?php echo ''.IMAGE_BUTTON_DOWNSORT.''; ?></a></td>
...
?>
			...
			<a class="button" href="<?php echo "$PHP_SELF?listing=manufacturers"; ?>"><?php echo ''. IMAGE_BUTTON_UPSORT.''; ?></a><br><a class="button" href="<?php echo "$PHP_SELF?listing=manufacturers-desc"; ?>"><?php echo ''.IMAGE_BUTTON_DOWNSORT.''; ?></a></td>
			<td width="70%" rowspan="2" align="left" class="TableHeading">
