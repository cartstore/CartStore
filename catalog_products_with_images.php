...
$count_rows++;
				...
				<table border="0" cellspacing="0" cellpadding="2">
					<tr>
						...
						<td width="85%" rowspan="2" align="left" class="TableHeading"><?php  echo TABLE_HEADING_IMAGES;?></td>
					</tr>
				</table></td>
				<?PHP }
				...
				<table border="0" cellspacing="0" cellpadding="2">
					<tr>
						...
						<td width="70%" rowspan="2" align="left" class="TableHeading"><?php  echo TABLE_HEADING_OPTIONS;?></td>
					</tr>
				</table></td>
				<?PHP }
				...
				<table border="0" cellspacing="0" cellpadding="2">
					<tr>
						<td width="17%" align="right" valign="bottom"><a class="button" href="<?php  echo "$PHP_SELF?listing=date-asc";?>"><?php  echo '' . IMAGE_BUTTON_UPSORT . '';?></a>
						<br>
						<a class="button" href="<?php  echo "$PHP_SELF?listing=date-desc";?>"><?php  echo '' . IMAGE_BUTTON_DOWNSORT . '';?></a></td>
						<td width="83%" rowspan="2" align="left" class="TableHeading"><?php  echo TABLE_HEADING_DATE;?></td>
					</tr>
				</table></td>
				<?PHP }
				...
				<table border="0" cellspacing="0" cellpadding="2">
					<tr>
						<td width="30%" align="right" valign="bottom"><a class="button" href="<?php  echo "$PHP_SELF?listing=manufacturers";?>"><?php  echo '' . IMAGE_BUTTON_UPSORT . '';?></a>
						<br>
						<a class="button" href="<?php  echo "$PHP_SELF?listing=manufacturers-desc";?>"><?php  echo '' . IMAGE_BUTTON_DOWNSORT . '';?></a></td>
						<td width="70%" rowspan="2" align="left" class="TableHeading"><?php  echo TABLE_HEADING_MANUFACTURERS;?></td>
					</tr>
				</table></td>
				<?PHP }
				...
				<table border="0" cellspacing="0" cellpadding="2">
					<tr>
						<td width="30%" align="right" valign="bottom"><a href="<?php  echo "$PHP_SELF?listing=name";?>"><?php  echo tep_image_button('printable_catalog_up.gif', IMAGE_BUTTON_UPSORT);?></a>
						<br>
						<a href="<?php  echo "$PHP_SELF?listing=name-desc";?>"><?php  echo tep_image_button('printable_catalog_down.gif', IMAGE_BUTTON_DOWNSORT);?></a></td>
						<td width="70%" rowspan="2" align="left" class="TableHeading"><?php  echo TABLE_HEADING_PRODUCTS;?></td>
					</tr>
				</table></td>
				<?PHP }
				...
				<table border="0" cellspacing="0" cellpadding="2">
					<tr>
						<td width="30%" align="right" valign="bottom"><a href="<?php  echo "$PHP_SELF?listing=products_description";?>"><?php  echo tep_image_button('printable_catalog_up.gif', IMAGE_BUTTON_UPSORT);?></a>
						<br>
						<a href="<?php  echo "$PHP_SELF?listing=products_description-desc";?>"><?php  echo tep_image_button('printable_catalog_down.gif', IMAGE_BUTTON_DOWNSORT);?></a></td>
						<td width="70%" rowspan="2" align="left" class="TableHeading"><?php  echo TABLE_HEADING_DESCRIPTION;?></td>
					</tr>
				</table></td>
				<?PHP }
				...
				<table border="0" cellspacing="0" cellpadding="2">
					<tr>
						<td width="17%" align="right" valign="bottom"><a href="<?php  echo "$PHP_SELF?listing=categories";?>"><?php  echo tep_image_button('printable_catalog_up.gif', IMAGE_BUTTON_UPSORT);?></a>
						<br>
						<a href="<?php  echo "$PHP_SELF?listing=categories-desc";?>"><?php  echo tep_image_button('printable_catalog_down.gif', IMAGE_BUTTON_DOWNSORT);?></a></td>
						<td width="83%" rowspan="2" align="left" class="TableHeading"><?php  echo TABLE_HEADING_CATEGORIES;?></td>
					</tr>
				</table></td>
				<?PHP }
				...
				<table border="0" cellspacing="0" cellpadding="2">
					<tr>
						<td width="25%" align="right" valign="bottom"><a href="<?php  echo "$PHP_SELF?listing=model";?>"><?php  echo tep_image_button('printable_catalog_up.gif', IMAGE_BUTTON_UPSORT);?></a>
						<br>
						<a href="<?php  echo "$PHP_SELF?listing=model-desc";?>"><?php  echo tep_image_button('printable_catalog_down.gif', IMAGE_BUTTON_DOWNSORT);?></a></td>
				</td>
				<td width="75%" rowspan="2" align="left" class="TableHeading"><?php  echo TABLE_HEADING_MODEL;?></td>
			</tr>
		</table></td>
		<?PHP }
		...
		<table border="0" cellspacing="0" cellpadding="2">
			<tr>
				<td width="25%" align="right" valign="bottom"><a href="<?php  echo "$PHP_SELF?listing=upc";?>"><?php  echo tep_image_button('printable_catalog_up.gif', IMAGE_BUTTON_UPSORT);?></a>
				<br>
				<a href="<?php  echo "$PHP_SELF?listing=upc-desc";?>"><?php  echo tep_image_button('printable_catalog_down.gif', IMAGE_BUTTON_DOWNSORT);?></a></td>
		</td>
		<td width="75%" rowspan="2" align="left" class="TableHeading"><?php  echo TABLE_HEADING_UPC;?></td>
	</tr>
</table></td>
<?PHP }
...
<table border="0" cellspacing="0" cellpadding="2">
	<tr>
		<td width="25%" align="right" valign="bottom"><a href="<?php  echo "$PHP_SELF?listing=quantity";?>"><?php  echo tep_image_button('printable_catalog_up.gif', IMAGE_BUTTON_UPSORT);?></a>
		<br>
		<a href="<?php  echo "$PHP_SELF?listing=quantity-desc";?>"><?php  echo tep_image_button('printable_catalog_down.gif', IMAGE_BUTTON_DOWNSORT);?></a></td>
</td>
<td width="75%" rowspan="2" align="left" class="TableHeading"><?php  echo TABLE_HEADING_QUANTITY;?></td>
</tr>
</table></td> <?PHP }
...
<table border="0" cellspacing="0" cellpadding="2">
	<tr>
		<td width="25%" align="right" valign="bottom"><a href="<?php  echo "$PHP_SELF?listing=weight";?>"><?php  echo tep_image_button('printable_catalog_up.gif', IMAGE_BUTTON_UPSORT);?></a>
		<br>
		<a href="<?php  echo "$PHP_SELF?listing=weight-desc";?>"><?php  echo tep_image_button('printable_catalog_down.gif', IMAGE_BUTTON_DOWNSORT);?></a></td>
</td>
<td width="75%" rowspan="2" align="left" class="TableHeading"><?php  echo TABLE_HEADING_WEIGHT;?></td>
</tr>
</table>
</td> <?PHP }
...
<table border="0" cellspacing="0" cellpadding="2">
	<tr>
		<td width="30%" align="right" valign="bottom"><a href="<?php  echo "$PHP_SELF?listing=price";?>"><?php  echo tep_image_button('printable_catalog_up.gif', IMAGE_BUTTON_UPSORT);?></a>
		<br>
		<a href="<?php  echo "$PHP_SELF?listing=price-desc";?>"><?php  echo tep_image_button('printable_catalog_down.gif', IMAGE_BUTTON_DOWNSORT);?></a></td>
</td>
<td width="70%" rowspan="2" align="left" class="TableHeading"><?php  echo TABLE_HEADING_PRICE;?></td>
</tr>
</table>
</td> <?php
}
...
$discount = tep_db_result(tep_db_query("select customer_discount from " . TABLE_CUSTOMERS . " where customers_id = '" . $customer_id . "'"), 0 , 0);
}
// Number of products to display per page
$limit = tep_db_result(tep_db_query("SELECT configuration_value from  " . TABLE_CONFIGURATION . " WHERE configuration_key = 'PRODUCT_LIST_CATALOG_PERPAGE'"), 0 , 0);
//Number of text in the products description - not working yet
$description_length = tep_db_result(tep_db_query("SELECT configuration_value from  " . TABLE_CONFIGURATION . " WHERE configuration_key = 'PRODUCT_LIST_DESCRIPTION_LENGTH'"), 0 , 0);
$totalrows = tep_db_num_rows($products_query);
...
<tr class="tableRow">
	...
	?>
	<td class="tableData" align="left"><?php
// Get the options:
...
$opt_x++;
	...
	<td class="tableData" align="center">
	<div align=left>
		<?php  echo '<a href="' . tep_href_link(FILENAME_PRODUCT_INFO, 'cPath=' . $products['cPath'] . '&products_id=' . $products['products_id'], 'NONSSL') . '">' . $products['manufacturers_name'] . '</a>';?> 
	...
	<td class="tableData" align="center">
	<div align=left>
		<?php  echo '<a href="' . tep_href_link(FILENAME_PRODUCT_INFO, 'products_id=' . $products['products_id'], 'NONSSL') . '">' . $products['products_name'] . '</a>';?> 
	</div></td>
	<?PHP } else {?>
	<td class="tableData" align="center">
	<div align=left>
		<h4><?php  echo '<a href="' . tep_href_link(FILENAME_PRODUCT_INFO, 'cPath=' . $products['categories_id'] . '&products_id=' . $products['products_id'], 'NONSSL') . '">' . $products['products_name'] . '</a></h4>';?> 
	</div></td>
	<?PHP }?>
	<?PHP }?>
	...
	<td class="tableData" align="center">
	<div align=left>
		<?php  echo '<a href="' . tep_href_link(FILENAME_DEFAULT, 'cPath=' . $products['categories_id'], 'NONSSL') . '">' . $products['categories_name'] . '</a>';?> 
	</div></td>
	<?PHP }?>
	...
	<td class="tableData" align="center">
	<div align=left>
		<?php  echo $products['products_upc'];?>
	...
	<td class="tableData" align="center">
	<div align=left>
		<?php  echo $products['products_quantity'];?>
	...
	<td class="tableData" align="center">
	<div align=left>
		<?php  echo $products['products_weight'];?>
	</div></td>
	<?PHP }?>
...
<div class="ui-tabs-nav ui-helper-reset ui-helper-clearfix ui-widget-header ui-corner-all">
		...
		<center>
			...
			$displaycount_number = tep_db_result(tep_db_query("SELECT configuration_value from  " . TABLE_CONFIGURATION . " WHERE configuration_key = 'PRODUCT_LIST_PAGEBREAK_NUMBERS_PERPAGE'"), 0, 0) - 2;
			...
			for ($i = $startpage; $i <= $startpage + $displaycount; $i++) {
				if ($i > $numofpages) {
					...
					if ($i > 0)
						echo("<a href=\"$PHP_SELF?listing=" . $sort . "&page=$i\">[$i</a>]");
				}
			}
