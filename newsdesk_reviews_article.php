...
$product = tep_db_query("select newsdesk_article_name from " . TABLE_NEWSDESK_DESCRIPTION . " where language_id = '" . $languages_id . "' and newsdesk_id = '" . $_GET['newsdesk_id'] . "'");
...
<?php
$reviews = tep_db_query("select reviews_rating, reviews_id, customers_name, date_added, last_modified, reviews_read from " . TABLE_NEWSDESK_REVIEWS . " where newsdesk_id = '" . $_GET['newsdesk_id'] . "' order by reviews_id DESC");
