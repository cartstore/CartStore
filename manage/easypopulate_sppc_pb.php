          ...
          <td width="100%">
           <FORM ENCTYPE="multipart/form-data" ACTION="easypopulate_sppc_pb.php?split=0" METHOD=POST>
              ...
              <div align = "left">
                ...
                <input type="submit" class="btn btn-default" name="buttoninsert" value="Insert into db">
                <br>
                </p>
              </div>
           ...
           <FORM ENCTYPE="multipart/form-data" ACTION="easypopulate_sppc_pb.php?split=1" METHOD=POST>
              ...
              <div align = "left">
                ...
                <p></p>
                  <input name="usrfl" type="file" size="50">
                <input type="submit" class="btn btn-default" name="buttonsplit" value="Split file">
                <br>
                </p>
              </div>
