...
The summary is also the meta description seo tag as well as the short intro text show in blog listings view. The intro text wont show on the actual blog page.                        </div>
                      </div>
                  </div>   
              </div>    
...
?>
              ...
              for ($i = 0, $n = sizeof($languages); $i < $n; $i++) {
?>
              <div class="form-group"><label>Article Title</label>
...
?>
               <p> 
                <?php
                          echo tep_draw_hidden_field('newsdesk_date_added', (($pInfo->newsdesk_date_added) ? $pInfo->newsdesk_date_added : date('Y-m-d'))) . tep_image_submit('button_preview.png', IMAGE_PREVIEW) . '&nbsp;&nbsp;<a class="btn btn-default" href="' . tep_href_link(FILENAME_NEWSDESK, 'cPath=' . $cPath . '&pID=' . $_GET['pID']) . '">' . IMAGE_CANCEL . '</a>';
?></p>
                </form>
                <?php
...
?></h1></div>
     <div class="panel-group" id="accordion">
                  ...
                  <div class="panel panel-default">
                      ...
                      <div id="collapseOne" class="panel-collapse collapse">
                          <div class="panel-body"><i class="fa fa-question-circle fa-5x pull-left"></i>
wwwHelp for this section is not yet available.                          </div>
                      </div>
                  </div>   
              </div>    
...
?>
           <?php
                                          ...
                                          echo '&nbsp;&nbsp;<a class="btn btn-default" href="' . tep_href_link(FILENAME_NEWSDESK, 'cPath=' . $cPath . '&pID=' . $_GET['pID']) . '">' . IMAGE_CANCEL . '</a>';
?>
           </p>
              </form>
...
Blog</h1></div> 
     ...
     <div class="panel-group" id="accordion">
                  ...
                  <div class="panel panel-default">
                      ...
                      <div id="collapseOne" class="panel-collapse collapse">
                          <div class="panel-body"><i class="fa fa-question-circle fa-5x pull-left"></i>
This is the main section for editing blog categories and articles. Setting its sticky status shows those articles on the home page.                         </div>
                      </div>
                  </div>   
              </div>    
...
?><div class="form-group hide"><label>
                       <?php
                                      echo HEADING_TITLE_SEARCH . '</label> ' . tep_draw_input_field('search', $_GET['search']);
?> 
</div>
                          </form>
                          <?php
...
?>
                  <div class="form-group"><label><?php
                                      echo HEADING_TITLE_GOTO . '</label> ' . tep_draw_pull_down_menu('cPath', newsdesk_get_category_tree(), $current_category_id, 'onChange="this.form.submit();"');
?> </div>
                          </form>
...
?>
                        <td class="dataTableContent"><?php
                                          echo '<a href="' . tep_href_link(FILENAME_NEWSDESK, newsdesk_get_path($categories['categories_id'])) . '"><i class="fa fa-eye text-info"></i> </a>&nbsp;<b>' . $categories['categories_name'] . '</b>';
?></td>
                          <td class="dataTableContent"><?php
                                          echo '<a href="' . HTTP_SERVER . '' . DIR_WS_CATALOG . 'newsdesk_index.php?newsPath=' . $cInfo->categories_id . '" target="_BLANK"><i class="fa fa-link text-warning"></i></a>';
?> </td>
                          <td class="dataTableContent"><?php
                                          if ($categories['catagory_status'] == '1') {
                                              echo ' <a href="' . tep_href_link(FILENAME_NEWSDESK, 'action=setflag&flag=0&cID=' . $categories['categories_id'] . '&cPath=' . $cPath) . '"><i class="fa fa-check-circle-o text-success"></i></a>';
                                          } else {
                                              echo '<a href="' . tep_href_link(FILENAME_NEWSDESK, 'action=setflag&flag=1&cID=' . $categories['categories_id'] . '&cPath=' . $cPath) . '"> <i class="fa fa-times-circle-o text-danger"></i></a>&nbsp;&nbsp;';
                                          }
?>
                          </td>
                          ...
                          <td class="dataTableContent"><?php
                                          if ((is_object($cInfo)) && ($categories['categories_id'] == $cInfo->categories_id)) {
                                              ...
                                              echo '<a href="' . tep_href_link(FILENAME_NEWSDESK, 'cPath=' . $cPath . '&cID=' . $categories['categories_id']) . '"><i class="fa fa-dot-circle-o"></i></a>';
                                          }
?>
                             </td>
                        </tr>
...
?>
                        <td class="dataTableContent"><?php
                                          echo '<a href="' . tep_href_link(FILENAME_NEWSDESK, 'cPath=' . $cPath . '&pID=' . $products['newsdesk_id'] . '&action=new_product_preview&read=only') . '"><i class="fa fa-eye text-info"></i> </a> ' . $products['newsdesk_article_name'];
?>
                          </td>
                          <td class="dataTableContent"><?php
                                          echo '<a href="' . HTTP_SERVER . '' . DIR_WS_CATALOG . 'newsdesk_info.php?newsdesk_id=' . $products['newsdesk_id'] . '" target="_BLANK"><i class="fa fa-link text-warning"></i></a>';
?> </td>
                          <td class="dataTableContent"><?php
                                          if ($products['newsdesk_status'] == '1') {
                                              echo '<a href="' . tep_href_link(FILENAME_NEWSDESK, 'action=setflag&flag=0&pID=' . $products['newsdesk_id'] . '&cPath=' . $cPath) . '"><i class="fa fa-check-circle-o text-success"></i> </a>';
                                          } else {
                                              echo '<a href="' . tep_href_link(FILENAME_NEWSDESK, 'action=setflag&flag=1&pID=' . $products['newsdesk_id'] . '&cPath=' . $cPath) . '"><i class="fa fa-times-circle-o text-danger"></i> </a>';
                                          }
?>
                          </td>
                          <td class="dataTableContent"><?php
                                          if ($products['newsdesk_sticky'] == '1') {
                                              echo '<a href="' . tep_href_link(FILENAME_NEWSDESK, 'action=setflag_sticky&flag_sticky=0&pID=' . $products['newsdesk_id'] . '&cPath=' . $cPath) . '"><i class="fa fa-check-circle-o text-success"></i> </a>';
                                          } else {
                                              echo '<a href="' . tep_href_link(FILENAME_NEWSDESK, 'action=setflag_sticky&flag_sticky=1&pID=' . $products['newsdesk_id'] . '&cPath=' . $cPath) . '"><i class="fa fa-times-circle-o text-danger"></i> </a>';
                                          }
?>
                          </td>
                          <td class="dataTableContent"><?php
                                          if ((is_object($pInfo)) && ($products['newsdesk_id'] == $pInfo->newsdesk_id)) {
                                              ...
                                              echo '<a href="' . tep_href_link(FILENAME_NEWSDESK, 'cPath=' . $cPath . '&pID=' . $products['newsdesk_id']) . '"><i class="fa fa-hand-o-up"></i></a>';
                                          }
?>
                         </td>
                        </tr>
                    ...
                    <?php
                                      ...
                                      switch ($_GET['action']) {
                                          ...
                                          case 'new_category':
                                              ...
                                              $contents[] = array('align' => 'center', 'text' => '<br>' . tep_image_submit('button_save.png', IMAGE_SAVE) . ' <a class="btn btn-default" href="' . tep_href_link(FILENAME_NEWSDESK, 'cPath=' . $cPath . '&cID=' . $cInfo->categories_id) . '">' . IMAGE_CANCEL . '</a>');
                                              break;
                                          ...
                                          case 'delete_category':
                                              ...
                                              $contents[] = array('align' => 'center', 'text' => '<br>' . tep_image_submit('button_delete.png', IMAGE_DELETE) . ' <a class="btn btn-default" href="' . tep_href_link(FILENAME_NEWSDESK, 'cPath=' . $cPath . '&cID=' . $cInfo->categories_id) . '">' . IMAGE_CANCEL . '</a>');
                                              break;
                                          ...
                                          case 'move_category':
                                              ...
                                              $contents[] = array('align' => 'center', 'text' => '<br>' . tep_image_submit('button_move.png', IMAGE_MOVE) . ' <a class="btn btn-default" href="' . tep_href_link(FILENAME_NEWSDESK, 'cPath=' . $cPath . '&cID=' . $cInfo->categories_id) . '">' . IMAGE_CANCEL . '</a>');
                                              break;
                                          ...
                                          case 'delete_product':
                                              ...
                                              $contents[] = array('align' => 'center', 'text' => '<br>' . tep_image_submit('button_delete.png', IMAGE_DELETE) . ' <a class="btn btn-default" href="' . tep_href_link(FILENAME_NEWSDESK, 'cPath=' . $cPath . '&pID=' . $pInfo->newsdesk_id) . '">' . IMAGE_CANCEL . '</a>');
                                              break;
                                          ...
                                          case 'move_product':
                                              ...
                                              $contents[] = array('align' => 'center', 'text' => '<br>' . tep_image_submit('button_move.png', IMAGE_MOVE) . ' <a class="btn btn-default" href="' . tep_href_link(FILENAME_NEWSDESK, 'cPath=' . $cPath . '&pID=' . $pInfo->newsdesk_id) . '">' . IMAGE_CANCEL . '</a>');
                                              break;
                                          ...
                                          case 'copy_to':
                                              ...
                                              $contents[] = array('align' => 'center', 'text' => '<br>' . tep_image_submit('button_copy.png', IMAGE_COPY) . ' <a class="btn btn-default" href="' . tep_href_link(FILENAME_NEWSDESK, 'cPath=' . $cPath . '&pID=' . $pInfo->newsdesk_id) . '">' . IMAGE_CANCEL . '</a>');
                                              break;
                                          ...
                                          default:
                                              ...
                                              if ($rows > 0) {
                                                  if (is_object($cInfo)) {
                                                      ...
                                                      if ($cPath)
                                                          $contents[] = array('align' => 'center', 'text' => '<a class="btn btn-default" href="' . tep_href_link(FILENAME_NEWSDESK, $cPath_back . '&cID=' . $current_category_id) . '">' . IMAGE_BACK . '</a>&nbsp;');
                                                      if (!$_GET['search'])
                                                          $contents[] = array('align' => 'center', 'text' => '<a class="btn btn-default" href="' . tep_href_link(FILENAME_NEWSDESK, 'cPath=' . $cPath . '&action=new_category') . '">' . IMAGE_NEW_CATEGORY . '</a>&nbsp;<a class="btn btn-default" href="' . tep_href_link(FILENAME_NEWSDESK, 'cPath=' . $cPath . '&action=new_product') . '">' . IMAGE_NEW_STORY . '</a>');
                                                      
                                                      $contents[] = array('align' => 'center', 'text' => '
<a class="btn btn-default" href="' . tep_href_link(FILENAME_NEWSDESK, 'cPath=' . $cPath . '&cID=' . $cInfo->categories_id . '&action=edit_category') . '">' . IMAGE_EDIT . '</a> <a class="btn btn-default" href="' . tep_href_link(FILENAME_NEWSDESK, 'cPath=' . $cPath . '&cID=' . $cInfo->categories_id . '&action=delete_category') . '">' . IMAGE_DELETE . '</a> <a class="btn btn-default" href="' . tep_href_link(FILENAME_NEWSDESK, 'cPath=' . $cPath . '&cID=' . $cInfo->categories_id . '&action=move_category') . '">' . IMAGE_MOVE . '</a>');
                                                      ...
                                                      $contents[] = array('align' => 'center', 'text' => '<a class="btn btn-default" href="' . tep_href_link(FILENAME_NEWSDESK, 'cPath=' . $cPath . '&pID=' . $pInfo->newsdesk_id . '&action=new_product') . '">' . IMAGE_EDIT . '</a> <a class="btn btn-default" href="' . tep_href_link(FILENAME_NEWSDESK, 'cPath=' . $cPath . '&pID=' . $pInfo->newsdesk_id . '&action=delete_product') . '">' . IMAGE_DELETE . '</a> <a class="btn btn-default" href="' . tep_href_link(FILENAME_NEWSDESK, 'cPath=' . $cPath . '&pID=' . $pInfo->newsdesk_id . '&action=move_product') . '">' . IMAGE_MOVE . '</a> <a class="btn btn-default" href="' . tep_href_link(FILENAME_NEWSDESK, 'cPath=' . $cPath . '&pID=' . $pInfo->newsdesk_id . '&action=copy_to') . '">' . IMAGE_COPY_TO . '</a>');
