...
case 'edit':
	...
	$contents[] = array(
		'align' => 'center',
		'text' => '<br>' . tep_image_submit('button_update.png', IMAGE_UPDATE) . '&nbsp;<a class="btn btn-default" href="'
...
if (is_object($cInfo)) {
	...
	$contents[] = array(
		'align' => 'center',
		'text' => '<a class="btn btn-default" href="' . tep_href_link(FILENAME_NEWSDESK_CONFIGURATION, 'gID=' . $_GET['gID']
