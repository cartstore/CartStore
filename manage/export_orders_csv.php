...
Export Order<br><small><?php echo strftime(DATE_FORMAT_LONG); ?>
</small></b></h1></div>
...
This screen allows you to export order information to a csv file which then may be imported into other software applications.                             </div>
                      </div>
                  </div>   
              </div>    
...
<?php echo "Start Order #:"; ?></label>
<input class="form-control" name="start" size="5" value="<?php echo $start; ?>">
 </div>
 
 <div class="form-group"><label>        
<?php echo "End Order #:" ; ?></label>
<input class="form-control" name="end" size="5" value="<?php echo $end; ?>">
     </div>
...
<select class="form-control" name="submitted">
        ...
        <p>      
<input type="submit" class="btn btn-default" value="<?php echo "Generate"; ?>"></p>  
</form>
...
while($row_orders_shipping_nn = tep_db_fetch_array($orders_shipping_nn)) {
 // end //
...
while($row_orders_shipping_minderwert = tep_db_fetch_array($orders_shipping_minderwert)) {
 // end //
...
while($row_orders_coupon = tep_db_fetch_array($orders_coupon)) {
 // end //
...
while($row_customers = tep_db_fetch_array($customers)) {
    // end //
