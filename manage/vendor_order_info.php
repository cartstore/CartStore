...
?></td>
  ...
  for ($l = 0, $m = sizeof($order->products); $l < $m; $l++) {
      ...
      echo '          <tr class="dataTableRow">' . "\n" . '          <td class="dataTableContent" valign="top">' . $order->products[$l]['Vname'] . '<br>' . $ship_data_text . '<br><a class="btn button" href="' . tep_href_link('vendor_packingslip.php', 'oID=' . $oID . '&vID=' . $order->products[$l]['Vid'] . '&text=' . $ship_data_text) . '">' . IMAGE_ORDERS_PACKINGSLIP . '</a></td>' . "\n";
