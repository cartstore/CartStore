...
if ($_GET['action'] == 'sent'){
        ...
        <td><table border="0" width="100%" cellspacing="0" cellpadding="1">
         ...
         <tr>
            <td align="right" valign=bottom><br><?php echo '<a class="btn btn-default" href="' . tep_href_link(FILENAME_ORDERS) . '">' .  IMAGE_BACK . '</a>'; ?></td>
         </tr>
        </table></td>
      </tr>
...
//  $ordered_product_query = tep_db_query("SELECT * FROM " . TABLE_ORDERS_PRODUCTS . " where order_id = '" . $_GET
    ...
    echo '          <tr>' . "\n" .
         '            <td class="main" align="right" valign="top" width="60">' . tep_draw_input_field('returns_quantity', $returned_products['products_quantity'], '') . '</td>' . "\n" .
      ...
      <tr>
        <td><table border="0" width="100%" cellspacing="1" cellpadding="2" class="infoBox">
          ...
          <?php
            ...
            $select_box = '<select class="form-control" name="support_priority"  size="' . MAX_MANUFACTURERS_LIST . '">';
       ...
       <tr>
        <td><table border="0" width="100%" cellspacing="1" cellpadding="2" class="infoBox">
          ...
          <?php
            ...
            $select_box = '<select class="form-control" name="refund_method"  size="' . MAX_MANUFACTURERS_LIST . '">';
             if (MAX_MANUFACTURERS_LIST < 2) {
                     }
