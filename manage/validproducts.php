...
<?php
    ...
    $result = tep_db_query("SELECT * FROM " . TABLE_PRODUCTS . " p,  " . TABLE_PRODUCTS_DESCRIPTION . " pd WHERE p.products_id = pd.products_id and pd.language_id = '" . $languages_id . "' ORDER BY pd.products_name");
...
<p><input type="button" class="btn btn-default" value="Close Window" onClick="window.close()"></p>
