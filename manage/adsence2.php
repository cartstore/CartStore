...
Adsence Code Position 2</h1></div>
...
<form name="frmConfigration" method="post" enctype="multipart/form-data">  
    ...
    <div class="form-group">
		<textarea class="form-control" wrap="soft" cols="100" rows="25" name="categories_htc_description"><?php echo htmlspecialchars(stripslashes(file_get_contents($filPath))); ?></textarea>
    </div>
