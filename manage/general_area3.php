...
$contents = "" ; 
$filPath = "../templates/includes/modules/general_area3.php"; 
...
HTML Module Position 3</h1></div>       <div class="panel-group" id="accordion">
                  <div class="clear"></div>
...
<form name="frmConfigration" method="post">  
		...
		<textarea class="redactor" name="categories_htc_description" wrap="soft" cols="100" rows="25"><?php echo htmlspecialchars(stripslashes(file_get_contents($filPath))); ?></textarea> </div>
