...
?>
                ...
                <td class="<?php echo $current_row; ?>" align="right"><?php if ( (is_object($gInfo)) && ($groups['admin_id'] == $gInfo->admin_id) ) { echo '<i class="fa fa-long-arrow-right"></i>'; } else { echo '<a href="' . tep_href_link(FILENAME_ADMIN_MEMBERS_EDIT, 'gID=' . $groups['admin_id']) . '"><i class="fa fa-hand-o-up"></i></a>'; } ?>&nbsp;</td>
              </tr>
<?php
    $count_groups++;
  }
              ...
              <tr>
                <td colspan="2"><table border="0" width="100%" cellspacing="0" cellpadding="2">
                  <tr>
                    ...
                    <td class="smallText" valign="top" align="right"><?php echo '<a class="btn btn-default" href="' . tep_href_link(FILENAME_ADMIN_MEMBERS_EDIT) . '">' .  IMAGE_BACK . '</a> <a class="btn btn-default" href="' . tep_href_link(FILENAME_ADMIN_MEMBERS_EDIT, 'gID=' . $gInfo->admin_id . '&action=new_group') . '">' .  IMAGE_NEW_GROUP . '</a>'; ?>&nbsp;</td>
                  </tr>
                </table></td>
              </tr>
            </table>
...
?>
            <table border="0" width="100%" cellspacing="0" cellpadding="2">
              <tr class="dataTableHeadingRow">
                ...
                <td class="dataTableHeadingContent"><?php echo TABLE_HEADING_LOGNUM; ?></td>
                <td class="dataTableHeadingContent"><?php echo TABLE_HEADING_ACTION; ?>&nbsp;</td>
              </tr>
<?php
...
?>
                ...
                <td class="<?php echo $current_row; ?>" align="right"><?php if ( (is_object($mInfo)) && ($admin['admin_id'] == $mInfo->admin_id) ) { echo '<i class="fa fa-long-arrow-right"></i>'; } else { echo '<a href="' . tep_href_link(FILENAME_ADMIN_MEMBERS_EDIT, 'page=' . $_GET['page'] . '&mID=' . $admin['admin_id']) . '"><i class="fa fa-hand-o-up"></i></a>'; } ?>&nbsp;</td>
              </tr>
<?php
  }
?>
...
<?php
  ...
  switch ($_GET['action']) {
    ...
    case 'new_group':
      ...
      $contents[] = array('align' => 'center', 'text' => '<br><a class="btn btn-default" href="' . tep_href_link(FILENAME_ADMIN_MEMBERS_EDIT, 'gPath=' . $_GET['gPath']) . '">' . IMAGE_CANCEL . '</a> ' . tep_image_submit('button_next.png', IMAGE_NEXT) );
      break;
    case 'edit_group':
      ...
      $contents[] = array('align' => 'center', 'text' => '<br>' . tep_image_submit('button_save.png', IMAGE_SAVE) . ' <a class="btn btn-default" href="' . tep_href_link(FILENAME_ADMIN_MEMBERS_EDIT, 'gPath=' . $_GET['gPath']) . '">' .  IMAGE_CANCEL . '</a>');
      break;
    case 'del_group':
      ...
      if ($gInfo->admin_id == 1) {
        ...
        $contents[] = array('align' => 'center', 'text' => '<br><a class="btn btn-default" href="' . tep_href_link(FILENAME_ADMIN_MEMBERS_EDIT, 'gPath=' . $_GET['gPath']) . '">' .  IMAGE_BACK . '</a><br>&nbsp;');
      } else {
        ...
        $contents[] = array('align' => 'center', 'text' => '<br>' . tep_image_submit('button_delete.png', IMAGE_DELETE) . ' <a class="btn btn-default" href="' . tep_href_link(FILENAME_ADMIN_MEMBERS_EDIT, 'gPath=' . $_GET['gPath']) . '">' . IMAGE_CANCEL . '</a><br>&nbsp;');
      }
      break;
    case 'define_group':
      ...
      if ($_GET['gPath'] == 1) {
        $contents[] = array('align' => 'center', 'text' => '<a class="btn btn-default" href="' . tep_href_link(FILENAME_ADMIN_MEMBERS_EDIT) . '">' .  IMAGE_CANCEL . '</a><br>');
      }
      break;
...
$admin_files_id = $admin_access['admin_files_id'];
 ...
 $contents[] = array('text' => sprintf($admin_access['admin_files_name']));
	...
	$contents[] = array('align' => 'center', 'text' => '<br>' . tep_image_submit('button_save.png', IMAGE_SAVE, 'onClick="validateForm();return document.returnValue"') . ' <a class="btn btn-default" href="' . tep_href_link(FILENAME_ADMIN_MEMBERS_EDIT, 'page=' . $_GET['page'] . '&mID=' . $_GET['mID']) . '">' .  IMAGE_CANCEL . '</a>');
	  echo '</form>';
	  break;
...
while($admin_edit = tep_db_fetch_array($admin_edit_query)){
 $contents[] = array('text' => sprintf($admin_edit['admin_files_name']));
	...
	//delete -reset
	 ...
	 $contents[] = array('align' => 'center', 'text' => '<br>' . tep_image_submit('button_save.png', IMAGE_SAVE, 'onClick="validateForm();return document.returnValue"') . ' <a  class="btn btn-default" href="' . tep_href_link(FILENAME_ADMIN_MEMBERS_EDIT) . '">' .  IMAGE_CANCEL . '</a>');
	  echo '</form>';
    break;
   ...
   case 'show_group':
    ...
    default:
      if (is_object($mInfo)) {
        ...
        $contents[] = array('align' => 'center', 'text' => '<a class="btn btn-default" href="' . tep_href_link(FILENAME_ADMIN_MEMBERS_EDIT, 'gPath=' . $mInfo->admin_id . '&action=define_group') . '">' . IMAGE_FILE_PERMISSION . '</a>');
        ...
        $contents[] = array('align' => 'center', 'text' => '<a class="btn btn-default" href="' . tep_href_link(FILENAME_ADMIN_MEMBERS_EDIT, 'gPath=' . $gInfo->admin_id . '&action=define_group') . '">' .  IMAGE_FILE_PERMISSION . '</a> ');
