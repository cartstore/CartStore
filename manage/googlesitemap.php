          ...
          <table width="100%"  border="0" cellpadding="0" cellspacing="0" class="main">
            <tr>
              <td width="78%" align="left" valign="top"><p><strong><?php echo OVERVIEW_TITLE_GOOGLE_SITEMAPS; ?></strong></p>
                ...
                <p>&nbsp;</p></td>
              <td width="22%" align="right" valign="top"><table width="98%"  border="0" cellpadding="1" cellspacing="0">
                <tr>
                  <td align="center" class="menuBoxHeading"> <strong><?php echo WHATIS_TITLE_GOOGLE_SITEMAPS; ?></strong></td>
                </tr>
                <tr>
