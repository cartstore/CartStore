...
*/
  ...
  if (tep_not_null($action)) {
    ...
    $file_group_page = (isset($_GET['file_group_page']) && is_numeric($_GET['file_group_page'])) ? $_GET['file_group_page'] : 1;
    $group_file_page = (isset($_GET['group_file_page']) && is_numeric($_GET['group_file_page'])) ? $_GET['group_file_page'] : 1;
    $order_by = (isset($_GET['order_by']) && is_string($_GET['order_by'])) ? $_GET['order_by'] : '';
...
//        $values_id = tep_db_prepare_input($_POST['values_id']);
        ...
        if (DOWNLOAD_ENABLED == 'true') {
          ...
          if (DOWNLOADS_CONTROLLER_FILEGROUP_STATUS == 'Yes') {
            $product_attribute_filegroup_id = tep_db_prepare_input($_POST['filegroup_id']);
        ...
        break;
      case 'add_filegroups':
        $filegroup_id = tep_db_prepare_input($_POST['filegroup_id']);
        $file_group_array = $_POST['file_group_name'];
      ...
      case 'add_group_file':
        $filegroup_id = tep_db_prepare_input($_POST['filegroup_id']);
        $file_desc_array = $_POST['file_desc'];
        $file_name = '';
        if (isset($_POST['input_filename']) && !empty($_POST['input_filename'])) {
          $file_name = tep_db_prepare_input($_POST['input_filename']);
        }
      ...
      case 'update_filegroup_name':
        $file_group_name_array = $_POST['file_group_name'];
        $filegroup_id = tep_db_prepare_input($_POST['filegroup_id']);
      ...
      case 'update_file_desc':
        $file_desc_array = $_POST['file_desc'];
        $file_id = tep_db_prepare_input($_POST['file_id']);
      ...
      case 'delete_download_group':
        $filegroup_id = tep_db_prepare_input($_GET['filegroup_id']);
      ...
      case 'delete_file_from_group':
        $filegroup_id = tep_db_prepare_input($_GET['filegroup_id']);
        $file_id = tep_db_prepare_input($_GET['group_file_id']);
...
<!-- options and values//-->
      <tr>
        <td width="100%"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td valign="top" width="50%"><table class="table table-hover table-condensed table-responsive">
<!-- options //-->
<?php
...
?>
              <tr>
                  <td class=""><h3><?php echo $options_values['products_options_name']; ?></h3></td>
                <td> </td>
              </tr>
              <tr>
                <td><table class="table table-hover table-condensed table-responsive">
...
?>
                  ...
                  <tr>
                    <td colspan="3" class="main"><?php echo TEXT_WARNING_OF_DELETE; ?></td>
                  </tr>
                  <tr>
                    <td align="right" colspan="3" class="main"><?php echo '<a class="btn btn-default" href="' . tep_href_link(FILENAME_PRODUCTS_ATTRIBUTES, (isset($_GET['value_page']) ? 'value_page=' . $_GET['value_page'] . '&' : '') . (isset($_GET['attribute_page']) ? 'attribute_page=' . $_GET['attribute_page'] : ''), 'NONSSL') . '">'; ?><?php echo ' cancel '; ?></a></td>
                  </tr>
<?php
    } else {
?>
                  ...
                  <tr>
                    <td class="main" align="right" colspan="3"><?php echo '<a class="btn btn-default" href="' . tep_href_link(FILENAME_PRODUCTS_ATTRIBUTES, 'action=delete_option&option_id=' . $_GET['option_id'], 'NONSSL') . '">'; ?><?php echo ' delete '; ?></a><?php echo '<a class="btn btn-default" href="' . tep_href_link(FILENAME_PRODUCTS_ATTRIBUTES, (isset($_GET['order_by']) ? 'order_by=' . $_GET['order_by'] . '&' : '') . (isset($_GET['page']) ? 'page=' . $_GET['page'] : ''), 'NONSSL') . '">'; ?><?php echo ' cancel '; ?></a></td>
                  </tr>
<?php
    }
?>
...
<?php
      if (($action == 'update_option') && ($_GET['option_id'] == $options_values['products_options_id'])) {
        ...
        for ($i = 0, $n = sizeof($languages); $i < $n; $i ++) {
          ...
          $inputs .= $languages[$i]['code'] . ':<input class="form-control" type="text" name="option_name[' . $languages[$i]['id'] . ']" size="20" value="' . $option_name['products_options_name'] . '">';
        }
?>

				<td align="center" class="smallText"><?php echo $options_values['products_options_id']; ?><input type="hidden" name="option_id" value="<?php echo $options_values['products_options_id']; ?>"></td>
				<td class="smallText" colspan="3"><?php echo $inputs; ?></td>
				<td class="smallText"><?php echo TABLE_HEADING_OPT_LENGTH . ' <input type="text" class="form-control" name="option_length" size="4" value="' . $option_name['products_options_length'] . '">'; ?></td>	<!-- CLR 030212 - Add column for option length //-->
...
//++++ QT Pro: End Changed Code
?>
                <td align="center" class="smallText"><?php echo tep_image_submit('button_update.png', IMAGE_UPDATE); ?><?php echo '<a class="btn btn-default" href="' . tep_href_link(FILENAME_PRODUCTS_ATTRIBUTES, '', 'NONSSL') . '">'; ?><?php echo  IMAGE_CANCEL; ?></a></td>
...
?>
                ...
                <td align="center" class="smallText"><?php echo '<a class="btn btn-default" href="' . tep_href_link(FILENAME_PRODUCTS_ATTRIBUTES, 'action=update_option&option_id=' . $options_values['products_options_id'] . '&option_order_by=' . $option_order_by . '&option_page=' . $option_page, 'NONSSL') . '">'; ?><?php echo  IMAGE_UPDATE; ?></a><?php echo '<a class="btn btn-default" href="' . tep_href_link(FILENAME_PRODUCTS_ATTRIBUTES, 'action=delete_product_option&option_id=' . $options_values['products_options_id'], 'NONSSL') , '">'; ?><?php echo  IMAGE_DELETE; ?></a></td>
...
<?php
      ...
      $inputs = '';
      for ($i = 0, $n = sizeof($languages); $i < $n; $i ++) {
        $inputs .= $languages[$i]['code'] . ':<input class="form-control" type="text" name="option_name[' . $languages[$i]['id'] . ']" size="20">';
      }
?>

				<td align="center" class="smallText"><?php echo $next_id; ?></td>
                <td class="smallText" colspan="2"><?php echo $inputs; ?></td>
				<td class="smallText"><?php echo TABLE_HEADING_OPT_LENGTH . ' <input class="form-control" type="text" name="option_length" size="4" value="">'; ?></td>	<!-- CLR 030212 - Add column for option length //-->
...
?>
              <tr>
                  <td colspan="3" class=""> <h3><?php echo $values_values['products_options_values_name']; ?></h3></td>
                <td></td>
              </tr>
              <tr>
                <td><table >
...
?>
                  ...
                  <tr>
                    <td class="main" align="right" colspan="3"><?php echo '<a class="btn btn-default" href="' . tep_href_link(FILENAME_PRODUCTS_ATTRIBUTES, (isset($_GET['value_page']) ? 'value_page=' . $_GET['value_page'] . '&' : '') . (isset($_GET['attribute_page']) ? 'attribute_page=' . $attribute_page : ''), 'NONSSL') . '">'; ?><?php ' cancel '; ?></a></td>
                  </tr>
<?php
    } else {
?>
                  ...
                  <tr>
                    <td class="main" align="right" colspan="3"><?php echo '<a class="btn btn-default" href="' . tep_href_link(FILENAME_PRODUCTS_ATTRIBUTES, 'action=delete_value&value_id=' . $_GET['value_id'], 'NONSSL') . '">'; ?><?php echo ' delete '; ?></a><?php echo '<a class="btn btn-default" href="' . tep_href_link(FILENAME_PRODUCTS_ATTRIBUTES, '&option_page=' . $option_page . (isset($_GET['value_page']) ? '&value_page=' . $value_page : '') . (isset($_GET['attribute_page']) ? '&attribute_page=' . $attribute_page : ''), 'NONSSL') . '">'; ?><?php echo  ' cancel '; ?></a></td>
                  </tr>
<?php
    }
?>
...
?>
              <tr>
                  <td colspan="3" class=""><h3><?php echo HEADING_TITLE_VAL; ?></h3></td>
                <td></td>
              </tr>
              <tr>
                <td colspan="4" class="smallText">
...
<?php
      if (($action == 'update_option_value') && ($_GET['value_id'] == $values_values['products_options_values_id'])) {
        ...
        for ($i = 0, $n = sizeof($languages); $i < $n; $i ++) {
          ...
          $inputs .= $languages[$i]['code'] . ':<input class="form-control" type="text" name="value_name[' . $languages[$i]['id'] . ']" size="15" value="' . $value_name['products_options_values_name'] . '">';
        }
?>
...
?>
                ...
                <td align="center" class="smallText"><?php echo '<a class="btn btn-default" href="' . tep_href_link(FILENAME_PRODUCTS_ATTRIBUTES, 'action=update_option_value&value_id=' . $values_values['products_options_values_id'] . (isset($_GET['value_page']) ? '&value_page=' . $_GET['value_page'] : ''), 'NONSSL') . '">'; ?><?php echo  IMAGE_UPDATE; ?></a><?php echo '<a class="btn btn-default" href="' . tep_href_link(FILENAME_PRODUCTS_ATTRIBUTES, 'action=delete_option_value&value_id=' . $values_values['products_options_values_id'] . '&option_id=' . $option_id, 'NONSSL') , '">'; ?><?php echo  IMAGE_DELETE; ?></a></td>
<?php
      }
...
<?php
      ...
      $inputs = '';
      for ($i = 0, $n = sizeof($languages); $i < $n; $i ++) {
        $inputs .= $languages[$i]['code'] . ':<input class="form-control" type="text" name="value_name[' . $languages[$i]['id'] . ']" size="15">';
      }
?>
                </select></td>
...
?>
        <td>
            <h3>Insert<br><small>Step3</small></h3>
            
            
            
            
            <div class="nohide"><form name="attributes" action="<?php echo tep_href_link(FILENAME_PRODUCTS_ATTRIBUTES, 'action=' . $form_action . '&option_page=' . $option_page . '&value_page=' . $value_page . '&attribute_page=' . $attribute_page); ?>" method="post">
...
?>
            ...
            <td class="smallText"><select class="form-control" name="products_id">
<?php
...
?>
            ...
            <td class="smallText"><select class="form-control" name="options_id">
<?php
...
?>
            ...
            <td class="smallText"><select class="form-control" name="values_id">
<?php
...
?>
            ...
            <td align="center" class="smallText"><?php echo tep_image_submit('button_update.png', IMAGE_UPDATE); ?><?php echo '<a class="btn btn-default" href="' . tep_href_link(FILENAME_PRODUCTS_ATTRIBUTES, '&attribute_page=' . $attribute_page, 'NONSSL') . '">'; ?><?php echo  IMAGE_CANCEL; ?></a></td>
<?php
      if (DOWNLOAD_ENABLED == 'true') {
        if (DOWNLOADS_CONTROLLER_FILEGROUP_STATUS == 'Yes') {
...
?>
                <tr class="active">
                  ...
                  <td class="smallText" align="right"><?php echo TABLE_TEXT_FILEGROUP; ?></td>
                  <td class="smallText"><select class="form-control" name="filegroup_id">
<?php
...
?>
            ...
            <td align="center" class="smallText"><b><?php echo '<a class="btn btn-default" href="' . tep_href_link(FILENAME_PRODUCTS_ATTRIBUTES, 'action=delete_attribute&attribute_id=' . $_GET['attribute_id']) . '">'; ?><?php echo  IMAGE_CONFIRM; ?></a><?php echo '<a class="btn btn-default" href="' . tep_href_link(FILENAME_PRODUCTS_ATTRIBUTES, '&option_page=' . $option_page . '&value_page=' . $value_page . '&attribute_page=' . $attribute_page, 'NONSSL') . '">'; ?><?php echo  IMAGE_CANCEL; ?></a></b></td>
<?php
    } else {
?>
            ...
            <td align="center" class="smallText"><?php echo '<a class="btn btn-default" href="' . tep_href_link(FILENAME_PRODUCTS_ATTRIBUTES, 'action=update_attribute&attribute_id=' . $attributes_values['products_attributes_id'] . '&attribute_page=' . $attribute_page, 'NONSSL') . '">'; ?><?php echo  IMAGE_UPDATE; ?></a><?php echo '<a class="btn btn-default" href="' . tep_href_link(FILENAME_PRODUCTS_ATTRIBUTES, 'action=delete_product_attribute&attribute_id=' . $attributes_values['products_attributes_id'] . '&attribute_page=' . $attribute_page, 'NONSSL') , '">'; ?><?php echo  IMAGE_DELETE; ?></a></td>
<?php
    }
...
?>
            ...
            <td align="right" class="smallText"><input class="form-control" type="text" name="value_price" size="6"></td>
            <td align="right" class="smallText"><input class="form-control" type="text" name="price_prefix" size="2" value="+"></td>
            <td align="center" class="smallText"><?php echo tep_image_submit('button_insert.png', IMAGE_INSERT); ?></td>
          </tr>
<?php
      if (DOWNLOAD_ENABLED == 'true') {
...
?>
          ...
          <tr class="active">
            ...
            <td colspan="7">
              <table class="table table-hover table-condensed table-responsive">
                <tr class="<?php echo (!($rows % 2)? 'attributes-even' : 'attributes-odd');?>">
                    <td class=""><b><?php echo TABLE_HEADING_DOWNLOAD; ?></b></td>
                  <td class="smallText" align="right"><?php echo TABLE_TEXT_FILENAME; ?></td>
                  <td class="smallText"><?php echo tep_draw_input_field('products_attributes_filename', $products_attributes_filename, 'size="15"'); ?></td>
                  <td class="smallText" align="right"><?php echo TABLE_TEXT_MAX_DAYS; ?></td>
                  <td class="smallText"><?php echo tep_draw_input_field('products_attributes_maxdays', $products_attributes_maxdays, 'size="5"'); ?></td>
                  <td class="smallText" align="right"><?php echo TABLE_TEXT_MAX_COUNT; ?></td>
                  <td class="smallText"><?php echo tep_draw_input_field('products_attributes_maxcount', $products_attributes_maxcount, 'size="5"'); ?></td>
                </tr>
              </table>
            </td>
