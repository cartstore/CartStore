...
<table border="0" width="100%" cellspacing="0" cellpadding="2">
	...
	<tr class="dataTableHeadingRow">
		...
		<td class="dataTableHeadingContent"><?php echo TABLE_HEADING_STICKY; ?></td>
...
echo '<i class="fa fa-check-circle-o"></i> <a href="' 
...
. '&cPath=' . $cPath) . '"> <i class="fa fa-times-circle-o text-danger"></i> </a> ';
...
echo '<a href="' . tep_href_link(FILENAME_FAQDESK, 'cPath=' . $cPath . '&cID=' . $categories['categories_id']) . '"><i class="fa fa-hand-o-up"></i></a>';
...
if ($products['faqdesk_status'] == '1') {
	...
	echo '<i class="fa fa-check-circle-o"></i> <a href="' . tep_href_link(FILENAME_FAQDESK, 'action=setflag&flag=0&pID=' . $products['faqdesk_id'] . '&cPath=' . $cPath) . '">' . tep_image(DIR_WS_IMAGES . 'icon_status_red_light.png', IMAGE_ICON_STATUS_RED_LIGHT, 10, 10) . '</a>';

} else {

	echo '<a href="' . tep_href_link(FILENAME_FAQDESK, 'action=setflag&flag=1&pID=' . $products['faqdesk_id'] . '&cPath=' . $cPath) . '"> <i class="fa fa-times-circle-o"></i></a>&nbsp;&nbsp;' . tep_image(DIR_WS_IMAGES . ';
...
if ($products['faqdesk_sticky'] == '1') {
	...
	echo '<i class="fa fa-check-circle-o"></i> <a href="' . tep_href_link(FILENAME_FAQDESK, 'action=setflag_sticky&flag_sticky=0&pID=' . $products['faqdesk_id'] . '&cPath=' . $cPath) . '">' . tep_image(DIR_WS_IMAGES . 'icon_status_red_light.png', IMAGE_ICON_STATUS_RED_LIGHT, 10, 10) . '</a>';

} else {

	echo '<a href="' . tep_href_link(FILENAME_FAQDESK, 'action=setflag_sticky&flag_sticky=1&pID=' . $products['faqdesk_id'] . '&cPath=' . $cPath) . '"><i class="fa fa-times-circle-o text-danger"></i></a>&nbsp;&nbsp;';
...
if ( (is_object($pInfo)) && ($products['faqdesk_id'] == $pInfo->faqdesk_id) ) {
	...
	echo '<a href="' . tep_href_link(FILENAME_FAQDESK, 'cPath=' . $cPath . '&pID=' . $products['faqdesk_id']) . '"><i class="fa fa-hand-o-up"></i></a>';
