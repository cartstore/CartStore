...
define('TEXT_PRODUCTS_VENDORS', 'Products Vendors');
define('TEXT_VENDORS_PROD_COMMENTS', 'Vendors Comments or Special Instructions');
...
define('HEADING_TITLE_GOTO', '<b>Quick Jump:</b>');
define('TABLE_HEADING_ID', 'ID');
define('TABLE_HEADING_CATEGORIES_PRODUCTS', 'Categories and Products');
...
define('TEXT_PRODUCTS_MPN', 'Products MPN:');
define('TEXT_PRODUCTS_GTIN', 'Products GTIN:');
...
define('INDIV_SHIPPING_PRICE', 'Shipping price');
define('EACH_ADDITIONAL_PRICE', 'Each additional price');
// stop indivship
?>