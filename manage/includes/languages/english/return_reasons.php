...
define('TEXT_INFO_INSERT_INTRO', 'Please enter the new ticket status with its related data');
define('TEXT_INFO_DELETE_INTRO', 'Are you sure you want to delete this ticket status?');
define('TEXT_INFO_HEADING_NEW_ORDERS_STATUS', 'New Ticket Status');
define('TEXT_INFO_HEADING_EDIT_ORDERS_STATUS', 'Edit Ticket Status');
define('TEXT_INFO_HEADING_DELETE_ORDERS_STATUS', 'Delete Ticket Status');
