...
define('TEXT_CANCEL_POINTS', 'Cancel');
...
define('BUTTON_TEXT_ADJUST_POINTS', 'Adjust');
define('BUTTON_TEXT_CANCEL_PENDING_POINTS', 'Cancel');
define('BUTTON_TEXT_CONFIRM_PENDING_POINTS', 'Confirm');
define('BUTTON_TEXT_REMOVE_RECORD', 'Delete');
