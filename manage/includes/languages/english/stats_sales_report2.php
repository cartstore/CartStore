...
define('TEXT_COMPARE', 'compared to:');

define('REPORT_COMP_FILTER', 'compare to');
define('REPORT_COMP_NO', 'no compare');
define('REPORT_COMP_DAY', 'previous day');
define('REPORT_COMP_MONTH', 'previous month');
define('REPORT_COMP_YEAR', 'previous year');

define('REPORT_VENDOR_FILTER', 'Filter By Vendor');
