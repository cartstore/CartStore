...
class Pagination
{
    ...
    public $first_link = '<i class="fa fa-chevron-left"></i> First';
    public $next_link = '<i class="fa fa-chevron-right"></i>';
    public $prev_link = '<i class="fa fa-chevron-left"></i>';
    public $last_link = 'Last <i class="fa fa-chevron-right"></i>';
    ...
    public $cur_tag_open = '<li class="active"><a href="javascript:void(0);">';
    ...
    public function create_links()
    {
        ...
        $this->cur_page = isset($_GET[$this->query_string_segment])?$_GET[$this->query_string_segment]:0;
        ...
        if ($this->first_link !== FALSE and $this->cur_page > ($this->num_links + 1)) {
            ...
            $output .= $this->first_tag_open . '<a ' . $this->anchor_class . 'href="' . $first_url . '">' .
        ...
        if ($this->prev_link !== FALSE and $this->cur_page != 1) {
            ...
            if ($i == 0 && $this->first_url != '') {
                $output .= $this->prev_tag_open . '<a ' . $this->anchor_class . 'href="' . $this->first_url . '">' .
                     $this->prev_link . '</a>' . $this->prev_tag_close;
            } else {
                $i = ($i == 0) ? '' : $this->prefix . $i . $this->suffix;
                $output .= $this->prev_tag_open . '<a ' . $this->anchor_class . 'href="' . $this->base_url . $i . '">' .
                     $this->prev_link . '</a>' . $this->prev_tag_close;
            }
        }
            ...
            for ($loop = $start - 1; $loop <= $end; $loop++) {
                ...
                if ($i >= $base_page) {
                    if ($this->cur_page == $loop) {
                        ...
                        if ($n == '' && $this->first_url != '') {
                            $output .= $this->num_tag_open . '<a ' . $this->anchor_class . 'href="' . $this->first_url .
                                 '">' . $loop . '</a>' . $this->num_tag_close;
                        } else {
                            $n = ($n == '') ? '' : $this->prefix . $n . $this->suffix;

                            $output .= $this->num_tag_open . '<a ' . $this->anchor_class . 'href="' . $this->base_url .
        ...
        if ($this->next_link !== FALSE and $this->cur_page < $num_pages) {
            ...
            $output .= $this->next_tag_open . '<a ' . $this->anchor_class . 'href="' . $this->base_url . $this->prefix .
                 $i . $this->suffix . '">' . $this->next_link . '</a>' . $this->next_tag_close;
        }
        ...
        if ($this->last_link !== FALSE and ($this->cur_page + $this->num_links) < $num_pages) {
            ...
            $output .= $this->last_tag_open . '<a ' . $this->anchor_class . 'href="' . $this->base_url . $this->prefix .
                 $i . $this->suffix . '">' . $this->last_link . '</a>' . $this->last_tag_close;
        }
