  ...
  class recover_cart_sales {
    ...
    function processSearch() {
      ...
      $this->infoBoxContents[] = array(
        ...
        0 => array(
          'params' => 'class="dataTableHeadingContent" colspan="2" width="10%" nowrap',
          'text' => TABLE_HEADING_CONTACT),
        1 => array(
          'params' => 'class="dataTableHeadingContent" colspan="1" width="15%" nowrap',
          'text' => TABLE_HEADING_DATE),
        2 => array(
          'params' => 'class="dataTableHeadingContent" colspan="1" width="30%" nowrap',
          'text' => TABLE_HEADING_CUSTOMER),
        3 => array(
          'params' => 'class="dataTableHeadingContent" colspan="2" width="30%" nowrap',
          'text' => TABLE_HEADING_EMAIL),
        4 => array(
          'params' => 'class="dataTableHeadingContent" colspan="2" width="15%" nowrap',
      ...
      $this->infoBoxContents[] = array(
        ...
        2 => array(
          'params' => 'class="dataTableHeadingContent" colspan="2" width="55%" nowrap',
          'text' => TABLE_HEADING_DESCRIPTION),
        3 => array(
          'params' => 'class="dataTableHeadingContent" colspan="1" width="5%" nowrap',
          'text' => TABLE_HEADING_QUANTY),
        4 => array(
          'params' => 'class="dataTableHeadingContent" colspan="1" width="5%" nowrap',
          'text' => TABLE_HEADING_PRICE),
        5 => array(
          'params' => 'class="dataTableHeadingContent" colspan="1" width="10%" nowrap',
      ...
      for ($i = 0; $i <= $knt; $i++)
      {
        ...
        if ($curcus != $inrec['cid'])
        {
          ...
          if ($curcus != "" && !$skip) {
            $this->infoBoxContents[] = array(
              0 => array(
                'params' => 'class="dataTableContent" colspan="8"',
                'text' => '<b>' . TABLE_CART_TOTAL . '</b>' . $currencies->format($tprice)));
            $this->infoBoxContents[] = array(
              0 => array(
                'params' => 'class="dataTableContent" colspan="6"',
                'text' => '<a class="btn btn-default" href="' . tep_href_link(FILENAME_RECOVER_CART_SALES, 'action=delete&customer_id=' . $curcus . '&tdate=' . $this->basedays . '&sdate=' . $this->skipdays) . '">' .  IMAGE_DELETE . '</a>'));
          }
          ...
          if ($curcus != "")
            ...
            $this->infoBoxContents[] = array(
              ...
              1 => array(
                'params' => 'class="dataTableContent" width="9%" nowrap',
                'text' => '<b>' . $sentInfo . '</b>'),
              2 => array(
                'params' => 'class="dataTableContent" width="15%" nowrap',
                'text' => $this->cart_date_short($inrec['bdate'])),
              3 => array(
                'params' => 'class="dataTableContent" width="30%" nowrap',
                'text' => '<a href="' . tep_href_link(FILENAME_CUSTOMERS, 'search=' . $inrec['lname'], 'NONSSL') . '">' . $customer . '</a>' . $status),
              4 => array(
                'params' => 'class="dataTableContent" colspan="2" width="30%" nowrap',
                'text' => '<a href="' . tep_href_link('mail.php', 'selected_box=tools&customer=' . $inrec['email']) . '">' . $inrec['email'] . '</a>'),
              5 => array(
                'params' => 'class="dataTableContent" colspan="2" width="15%" nowrap',
                'text' => $inrec['phone']));
		      }
        }
        ...
        if ($inrec['qty'] != 0)
        {
          ...
          $this->infoBoxContents[] = array(
            ...
            0 => array(
              'params' => 'class="dataTableContent" valign="top" colspan="2" width="12%" nowrap',
              'text' => '&nbsp;'),
            1 => array(
              'params' => 'class="dataTableContent" valign="top" width="13%" nowrap',
              'text' => $inrec2['model'] . '&nbsp;'),
            2 => array(
              'params' => 'class="dataTableContent" valign="top" colspan="2" width="55%" nowrap',
            ...
            3 => array(
              'params' => 'class="dataTableContent" valign="top" width="5%" nowrap',
              'text' => $inrec['qty']),
            4 => array(
              'params' => 'class="dataTableContent" valign="top" width="5%" nowrap',
              'text' => $pprice_formated),
            5 => array(
              'params' => 'class="dataTableContent" valign="top" width="10%" nowrap',
    ...
    function processEmail($custids) {
      ...
      $this->infoBoxContents[] = array(
        ...
        1 => array(
          ...
          'text' => '&nbsp;'),
        2 => array(
          'params' => 'class="dataTableHeadingContent" colspan="1" width="25%" nowrap',
          'text' => '&nbsp;'),
        3 => array(
          'params' => 'class="dataTableHeadingContent" colspan="1" width="10%" nowrap',
          'text' => '&nbsp;'),
      ...
      $this->infoBoxContents[] = array(
        ...
        unset($email);
          ...
          $inrec = tep_db_fetch_array($query1);
              ...
              $this->infoBoxContents[] = array(
                0 => array(
                  'params' => 'class="dataTableContent" colspan="6" nowrap',
                  'text' => '<b>' . TABLE_CART_TOTAL . '</b>' . $currencies->format($tprice)));

              $this->infoBoxContents[] = array(
                0 => array(
                  'params' => 'align="right" colspan="6"',
                  'text' => '<a class="btn btn-default" href="' . tep_href_link(FILENAME_RECOVER_CART_SALES, "action=delete&customer_id=" . $cid . "&tdate=" . $this->basedays . "&sdate=" . $this->skipdays) . '">' .  IMAGE_DELETE . '</a>'));
			      }
            ...
            $this->infoBoxContents[] = array(
              ...
              0 => array(
                ...
                'text' => $inrec2['model'] . '&nbsp;'),
              1 => array(
                'params' => 'class="dataTableContent" colspan="2" width="55%"',
              ...
              2 => array(
                'params' => 'class="dataTableContent" width="10%" nowrap',
                'text' => $inrec['qty']),
              3 => array(
                'params' => 'class="dataTableContent" width="10%" nowrap',
                'text' => $pprice_formated),
