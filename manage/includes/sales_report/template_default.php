                ...
                <td valign="top">
                  <table border="0" width="100%" cellspacing="0" cellpadding="2">
                    <tr class="dataTableHeadingRow">
                      <td class="dataTableHeadingContent"><?php echo  SR_TABLE_HEADING_DATE; ?></td>
                      <td class="dataTableHeadingContent"><?php echo  SR_TABLE_HEADING_ORDERS;?></td>
                      <td class="dataTableHeadingContent"><?php echo  SR_TABLE_HEADING_ITEMS; ?></td>
                      <td class="dataTableHeadingContent"><?php echo  SR_TABLE_HEADING_REVENUE;?></td>
                      <td class="dataTableHeadingContent"><?php echo  SR_TABLE_HEADING_SHIPPING;?></td>
                    </tr>
<?php
$sum = 0;
while ($sr->hasNext()) {
...
<?php
    switch ($srView) {
      case '3':
?>
                      <td class="dataTableContent"><?php echo tep_date_long(date("Y-m-d\ H:i:s", $sr->showDate)) . " - " . tep_date_short(date("Y-m-d\ H:i:s", $sr->showDateEnd)); ?></td>
<?php
        break;
      case '4':
?>
                      <td class="dataTableContent"><?php echo tep_date_long(date("Y-m-d\ H:i:s", $sr->showDate)); ?></td>
<?php
        break;
      default;
?>
                      <td class="dataTableContent"><?php echo tep_date_short(date("Y-m-d\ H:i:s", $sr->showDate)) . " - " . tep_date_short(date("Y-m-d\ H:i:s", $sr->showDateEnd)); ?></td>
<?php
    }
?>
                      <td class="dataTableContent"><?php echo $info[0]['order']; ?></td>
                      <td class="dataTableContent"><?php echo $info[$last - 1]['totitem']; ?></td>
                      <td class="dataTableContent"><?php echo $currencies->format($info[$last - 1]['totsum']);?></td>
                      <td class="dataTableContent"><?php echo $currencies->format($info[0]['shipping']);?></td>
                    </tr>
<?php
  if ($srDetail) {
    for ($i = 0; $i < $last; $i++) {
...
?>
                    ...
                    <td class="dataTableContent"><a href="<?php echo tep_catalog_href_link("product_info.php?products_id=" . $info[$i]['pid']) ?>" target="_blank"><?php echo $info[$i]['pname']; ?></a>
<?php
...
?>                    </td>
                    <td class="dataTableContent"><?php echo $info[$i]['pquant']; ?></td>
<?php
          if ($srDetail == 2) {?>
                    <td class="dataTableContent"><?php echo $currencies->format($info[$i]['psum']); ?></td>
<?php
          } else { ?>
                    <td class="dataTableContent">&nbsp;</td>
<?php
...
<?php
  ...
  <?php
      switch ($srView) {
        case '3':
  ?>
                        <td class="dataTableContent"><?php echo tep_date_long(date("Y-m-d\ H:i:s", $sr2->showDate)) . " - " . tep_date_short(date("Y-m-d\ H:i:s", $sr2->showDateEnd)); ?></td>
  <?php
          break;
        case '4':
  ?>
                        <td class="dataTableContent"><?php echo tep_date_long(date("Y-m-d\ H:i:s", $sr2->showDate)); ?></td>
  <?php
          break;
        default;
  ?>
                        <td class="dataTableContent"><?php echo tep_date_short(date("Y-m-d\ H:i:s", $sr2->showDate)) . " - " . tep_date_short(date("Y-m-d\ H:i:s", $sr2->showDateEnd)); ?></td>
  <?php
      }
  ?>
                        <td class="dataTableContent"><?php echo $info[0]['order']; ?></td>
