...
<?php
echo tep_draw_textarea_field_redactor('newsdesk_article_description_' . $languages[$i]['id'] . '', 'soft', '50', '15', stripbr((($newsdesk_article_description[$languages[$i]['id']]) ? stripslashes($newsdesk_article_description[$languages[$i]['id']]) : newsdesk_get_newsdesk_article_description($pInfo->newsdesk_id, $languages[$i]['id']))));
?>
