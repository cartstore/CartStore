...
?></td>
          ...
          <tr>
            <td class="main"><?php echo ENTRY_CUSTOMERS_DBA; ?></td>
            <td class="main">
<?php
  if ($is_read_only) {
    echo $account['customers_dba'];
  } else {
    echo tep_draw_input_field('customers_dba', $account['customers_dba']);
  }
?></td>
          </tr>
...
?>
  <tr>
    <td colspan="2" class="formAreaTitle"><h3><?php echo CATEGORY_COMPANY; ?></h3></td>
  </tr>
...
?>
  <tr>
    <td colspan="2" class="formAreaTitle"><h3><?php echo CATEGORY_ADDRESS; ?></h3></td>
  </tr>
...
?></td>
  ...
  <tr>
    <td colspan="2" class="formAreaTitle"><h3><?php echo CATEGORY_CONTACT; ?></h3></td>
  </tr>
...
?></td>
  ...
  <tr>
    <td colspan="2" class="formAreaTitle"><h3><?php echo CATEGORY_OPTIONS; ?></h3></td>
  </tr>
  <tr>
