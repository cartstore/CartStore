  ...
  class newsletter {
	...
	$mail['count'] = ($mail1['count'] + $mail2['count'] );
      ...
      $confirm_string = '<table border="0" cellspacing="0" cellpadding="2">' . "\n" .
                        ...
                        '  </tr>' . "\n" .
                        '  <tr>' . "\n" .
                        '    <td align="right"><a class="btn btn-default" href="' . tep_href_link(FILENAME_NEWSLETTERS, 'page=' . $_GET['page'] . '&nID=' . $_GET['nID'] . '&action=confirm_send') . '">' . IMAGE_SEND . '</a> <a class="btn btn-default" href="' . tep_href_link(FILENAME_NEWSLETTERS, 'page=' . $_GET['page'] . '&nID=' . $_GET['nID']) . '">' .  IMAGE_CANCEL . '</a></td>' . "\n" .
                        '  </tr>' . "\n" .
                        '</table>';
