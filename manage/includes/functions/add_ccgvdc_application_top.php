...
// Output a day/month/year dropdown selector
  function tep_draw_date_selector($prefix, $date='') {
    ...
    $month = $usedate['mon'];
    $year = $usedate['year'];
    $date_selector = '<select class="form-control" name="'. $prefix .'_day">';
    for ($i=1;$i<32;$i++){
    ...
    $date_selector .= '<select class="form-control" name="'. $prefix .'_month">';
    for ($i=1;$i<13;$i++){
      $date_selector .= '<option value="' . $i . '"';
    ...
    $date_selector .= '</select>';
    $date_selector .= '<select class="form-control" name="'. $prefix .'_year">';
    for ($i=2001;$i<2019;$i++){
      $date_selector .= '<option value="' . $i . '"';
