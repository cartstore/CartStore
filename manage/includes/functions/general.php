...
function tep_get_categories($categories_array = '', $parent_id = '0', $indent = '') {
  ...
  function tep_get_system_information()
  {
	  ...
	  if (class_exists('mysqli'))
	     $mysql_version = (function_exists('mysqli_get_server_info') ? mysqli_get_server_info($db_link) : '');
	  else 
	     $mysql_version = (function_exists('mysql_get_server_info') ? mysql_get_server_info() : '');
      return array('date' => tep_datetime_short(date('Y-m-d H:i:s')), 'system' => $system, 'kernel' => $kernel, 'host' => $host, 'ip' => gethostbyname($host), 'uptime' => @exec('uptime'), 'http_server' => $_SERVER['SERVER_SOFTWARE'], 'php' => PHP_VERSION, 'zend' => (function_exists('zend_version') ? zend_version() : ''), 'db_server' => DB_SERVER, 'db_ip' => gethostbyname(DB_SERVER), 
      'db_version' => 'MySQL ' . $mysql_version, 'db_date' => tep_datetime_short($db['datetime']));
  }
...
///////////////////start mail manager////////////////////////////////////////start mail manager////////////////////////////////////////start mail manager/////////////////////
