...
<?php
    ...
    echo '<input type="submit" class="btn btn-default" value="'. ENTRY_SUBMIT .'">';
    echo '</td></form>';
...
?>
                ...
                <td class="dataTableContent"><?php echo $currencies->format($ads['total_value']); ?>&nbsp;</td>
              </tr>
<?php
...
?>
                ...
                <td class="dataTableContent"><b><?php echo $currencies->format($grand_total_value); ?></b>&nbsp;</td>
              </tr>
            </table></td>
          </tr>
          <tr>
