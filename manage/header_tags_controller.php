...
<h1><?php echo HEADING_TITLE_CONTROLLER; ?></h1>
<p><?php echo TEXT_PAGE_TAGS; ?></p>



 <p>
 <?php echo TEXT_INFORMATION_ADD_PAGE; ?> </p>
 <?php echo tep_draw_form('header_tags', FILENAME_HEADER_TAGS_CONTROLLER, '', 'post') . tep_draw_hidden_field('action', 'process'); ?> 
    ...
    <table class="table">
           ...
           <tr>
            ...
            <td colspan="2">
            <div class="form-group"><label><?php echo HEADING_TITLE_CONTROLLER_PAGENAME; ?> </label>

       <?php echo tep_draw_input_field('page', tep_not_null($page) ? $page : '', 'maxlength="255"', false); ?>  </div>

      <table border="0" width="100%">

           <tr class="active">

            <td class="smallText" >Switches:</td>

            <td class="smallText">HTTA: <?php echo tep_draw_checkbox_field('htta', '', FALSE, ''); ?> </td>

       

            <td class="smallText">HTDA: <?php echo tep_draw_checkbox_field('htda', '', FALSE, ''); ?> </td>

 

            <td class="smallText">HTKA: <?php echo tep_draw_checkbox_field('htka', '', FALSE, ''); ?> </td>

      

            <td class="smallText">HTCA: <?php echo tep_draw_checkbox_field('htca', '', FALSE, ''); ?> </td>
           ...
           <tr>
            ...
            <td class="smallText" style="font-weight: bold;"><?php echo HEADING_TITLE_CONTROLLER_TITLE; ?></td>
   ...
   <?php echo (tep_image_submit('button_update.png', IMAGE_UPDATE) ) . ' <a href="' . tep_href_link(FILENAME_HEADER_TAGS_CONTROLLER, '') .'">' . '</a>'; ?>
</p>
<hr>
 ...
 <div class="form-group"><p>
      <?php echo TEXT_INFORMATION_DELETE_PAGE; ?></p>
<?php echo tep_draw_form('header_tags_delete', FILENAME_HEADER_TAGS_CONTROLLER, '', 'post') . tep_draw_hidden_field('action_delete', 'process'); ?></div>

<div class="form-group"><label>
<?php echo HEADING_TITLE_CONTROLLER_PAGENAME; ?></label>
<?php   echo tep_draw_pull_down_menu('delete_page', $deleteArray, '', '', false);?></div>
...
<div class="form-group"><p>
<?php echo TEXT_INFORMATION_CHECK_PAGES; ?></p>

<?php echo tep_draw_form('header_tags_auto', FILENAME_HEADER_TAGS_CONTROLLER, '', 'post') . tep_draw_hidden_field('action_check', 'process'); ?></div>

<div class="form-group"><label>
<?php echo HEADING_TITLE_CONTROLLER_PAGENAME; ?></label>

<?php   echo tep_draw_pull_down_menu('new_files', $newfiles, '', '', false);?></div>

<p>
   
<?php echo (tep_image_submit('button_update.png', IMAGE_UPDATE) ) . ' <a href="' . tep_href_link(FILENAME_HEADER_TAGS_CONTROLLER, '') .'">' . '</a>'; ?></p>
