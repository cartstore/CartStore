...
$contents = "" ; 
$filPath = "../templates/includes/boxes/adsence3.php"; 
...
Adsence Code Position 3</h1></div>          <div class="panel-group" id="accordion">
                  <div class="clear"></div>
...
<form name="frmConfigration" method="post" enctype="multipart/form-data">  
    ...
    <div class="form-group">
		<textarea class="form-control" wrap="soft" cols="100" rows="25" name="categories_htc_description">
                    <?php echo htmlspecialchars(stripslashes(file_get_contents($filPath))); ?></textarea>
