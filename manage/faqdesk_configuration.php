...
if ($_GET['action']) {
	...
	case 'save':
		...
		tep_redirect(tep_href_link(FILENAME_FAQDESK_CONFIGURATION, 'gID=' . $_GET['gID'] . '&cID=' . $cID));
...
"select configuration_group_title from " . TABLE_FAQDESK_CONFIGURATION_GROUP . " where configuration_group_id = '" . $_GET['gID'] . "'"
...
<?php
 ...
 "select configuration_id, configuration_title, configuration_value, use_function from " . TABLE_FAQDESK_CONFIGURATION . " where configuration_group_id = '" . $_GET['gID'] . "' order by sort_order"
...
if ( (is_object($cInfo)) && ($configuration['configuration_id'] == $cInfo->configuration_id) ) {
	...
	. $configuration['configuration_id']) . '"><i class="fa fa-hand-o-up"></i></a>';
