...
*/
 ...
 if (!$this_is_an_mvs_order) {//shipping_tax is only an input to the orders table on a non-MVS order
  ...
  if (($check_status['orders_status'] != $_POST['status']) || (tep_not_null($_POST['comments'])) || tep_not_null($_POST['admin_comments'])) {
...
<div class="page-header"><h1> <a class="pull-right" data-toggle="collapse" data-parent="#accordion" href="#collapseOne">
 ...
 <?php echo HEADING_TITLE . '&nbsp;(' . HEADING_TITLE_NUMBER . '&nbsp;' . $oID . '&nbsp;' . HEADING_TITLE_DATE  . '&nbsp;' . tep_datetime_short($order->info['date_purchased']) . ')'; ?></h1></div>
 <div class="panel-group" id="accordion">
                  <div class="clear"></div>
                  <div class="panel panel-default">

                      <div id="collapseOne" class="panel-collapse collapse">
                          <div class="panel-body"><i class="fa fa-pencil fa-5x pull-left"></i>
The edit orders screen allows you to edit shipping, customer and billing address, payment method, products ordered and totals.
                         </div>
                      </div>
                  </div>   
              </div>    
<p>
<?php echo '<a class="btn btn-default" href="' . tep_href_link(FILENAME_ORDERS, tep_get_all_get_params(array('oID', 'action')) . 'oID=' . $_GET['oID'] . '&action=edit') . '">' .  IMAGE_EDIT . '</a> <a class="btn btn-default" href="' . tep_href_link(FILENAME_ORDERS_INVOICE, 'oID=' . $_GET['oID']) . '" TARGET="_blank">' .  IMAGE_ORDERS_INVOICE . '</a> <a class="btn btn-default" href="' . tep_href_link(FILENAME_ORDERS_PACKINGSLIP, 'oID=' . $_GET['oID']) . '" TARGET="_blank">' . IMAGE_ORDERS_PACKINGSLIP . '</a> <a class="btn btn-default" href="' . tep_href_link(FILENAME_ORDERS, tep_get_all_get_params(array('action'))) . '">' . IMAGE_BACK . '</a> '; ?>
</p>
...
<!-- Begin Addresses Block -->
   ...
   <p><?php echo HINT_PRESS_UPDATE; ?> 
   <?php echo tep_image_submit('button_update.png', IMAGE_UPDATE); ?>   </p> 
   <hr>
    

<h3><?php echo MENUE_TITLE_CUSTOMER; ?></h3>

 <div class="form-group"><label>QuickBooks ID:</label>  <input class="form-control" type="text" width="30" name="quickbooksid" value="<?php echo tep_html_quotes($order->info['quickbooksid']); ?>"></div>

<table border="0" class="table" cellpadding="2" cellspacing="0">
  <tr class="dataTableHeadingRow">
    <td class="dataTableHeadingContent"></td>
    <td class="dataTableHeadingContent"><?php echo ENTRY_CUSTOMER_ADDRESS; ?></td>
    <td class="dataTableHeadingContent"></td>
    <td class="dataTableHeadingContent" onMouseover="ddrivetip('<?php echo HINT_SHIPPING_ADDRESS; ?>')"; onMouseout="hideddrivetip()"><?php echo ENTRY_SHIPPING_ADDRESS; ?> <i class="fa fa-truck"></i></td>
	 <td class="dataTableHeadingContent"></td>
    <td class="dataTableHeadingContent"><?php echo ENTRY_BILLING_ADDRESS; ?></td>
  </tr>
 <?php
...
?>
  <tr class="dataTableProducts">
    ...
    <td><span class="main"><input class="form-control" name="update_customer_name" size="30" value="<?php echo tep_html_quotes($order->customer['name']); ?>" /></span></td>
    <td>&nbsp;</td>
    <td><span class="main"><input class="form-control"  name="update_delivery_name" size="30" value="<?php echo tep_html_quotes($order->delivery['name']); ?>" /></span></td>
	<td>&nbsp;</td>
    <td><span class="main"><input class="form-control"  name="update_billing_name" size="30" value="<?php echo tep_html_quotes($order->billing['name']); ?>" /></span></td>
  </tr>
  <tr class="dataTableProducts">
    <td class="main"><b><?php echo ENTRY_ADDRESS; ?>: </b></td>
    <td><span class="main"><input class="form-control"  name="update_customer_street_address" size="30" value="<?php echo tep_html_quotes($order->customer['street_address']); ?>" /></span></td>
    <td>&nbsp;</td>
    <td><span class="main"><input class="form-control"  name="update_delivery_street_address" size="30" value="<?php echo tep_html_quotes($order->delivery['street_address']); ?>" /></span></td>
	<td>&nbsp;</td>
    <td><span class="main"><input class="form-control"  name="update_billing_street_address" size="30" value="<?php echo tep_html_quotes($order->billing['street_address']); ?>" /></span></td>
  </tr>
  <?php
...
?>
  <tr class="dataTableProducts">
    ...
    <td><span class="main"><input class="form-control"  name="update_customer_suburb" size="30" value="<?php echo tep_html_quotes($order->customer['suburb']); ?>" /></span></td>
    <td>&nbsp;</td>
    <td><span class="main"><input class="form-control"  name="update_delivery_suburb" size="30" value="<?php echo tep_html_quotes($order->delivery['suburb']); ?>" /></span></td>
	<td>&nbsp;</td>
    <td><span class="main"><input class="form-control"  name="update_billing_suburb" size="30" value="<?php echo tep_html_quotes($order->billing['suburb']); ?>" /></span></td>
  </tr>
  <?php
  }
?>
  <tr class="dataTableProducts">
    ...
    <td><span class="main"><input class="form-control"  name="update_customer_city" size="30" value="<?php echo tep_html_quotes($order->customer['city']); ?>" /></span></td>
    <td>&nbsp;</td>
    <td><span class="main"><input class="form-control"  name="update_delivery_city" size="30" value="<?php echo tep_html_quotes($order->delivery['city']); ?>" /></span></td>
	<td>&nbsp;</td>
    <td><span class="main"><input class="form-control"  name="update_billing_city" size="30" value="<?php echo tep_html_quotes($order->billing['city']); ?>" /></span></td>
  </tr>
  <?php
...
?>
  <tr class="dataTableProducts">
    ...
    <td><span class="main"><input class="form-control"  name="update_customer_state" size="30" value="<?php echo tep_html_quotes($order->customer['state']); ?>" /></span></td>
    <td>&nbsp;</td>
    <td><span class="main"><input class="form-control"  name="update_delivery_state" size="30" value="<?php echo tep_html_quotes($order->delivery['state']); ?>" /></span></td>
	<td>&nbsp;</td>
    <td><span class="main"><input class="form-control"  name="update_billing_state" size="30" value="<?php echo tep_html_quotes($order->billing['state']); ?>" /></span></td>
  </tr>
  <?php
  }
?>
  <tr class="dataTableProducts">
    ...
    <td><span class="main"><input class="form-control"  name="update_customer_postcode" size="30" value="<?php echo $order->customer['postcode']; ?>" /></span></td>
    <td>&nbsp;</td>
    <td><span class="main"><input class="form-control"  name="update_delivery_postcode" size="30" value="<?php echo $order->delivery['postcode']; ?>" /></span></td>
	 <td>&nbsp;</td>
    <td><span class="main"><input class="form-control"  name="update_billing_postcode" size="30" value="<?php echo $order->billing['postcode']; ?>" /></span></td>
  </tr>
  <tr class="dataTableProducts">
    <td class="main"><b><?php echo ENTRY_CUSTOMER_COUNTRY; ?>: </b></td>
    <td><span class="main"><input class="form-control"  name="update_customer_country" size="30" value="<?php echo tep_html_quotes($order->customer['country']); ?>" /></span></td>
    <td>&nbsp;</td>
    <td><span class="main"><input class="form-control"  name="update_delivery_country" size="30" value="<?php echo tep_html_quotes($order->delivery['country']); ?>" /></span></td>
	<td>&nbsp;</td>
    <td><span class="main"><input class="form-control"  name="update_billing_country" size="30" value="<?php echo tep_html_quotes($order->billing['country']); ?>" /></span></td>
  </tr>
   <tr class="dataTableProducts">
    <td class="main"><b><?php echo ENTRY_CUSTOMER_PHONE; ?>: </b></td>
    <td><span class="main"><input class="form-control"  name="update_customer_telephone" size="30" value="<?php echo $order->customer['telephone']; ?>" /></span></td>
   <td colspan="4"></td>
  </tr>
  <tr class="dataTableProducts">
    <td class="main"><b><?php echo ENTRY_CUSTOMER_EMAIL; ?>: </b></td>
    <td><span class="main"><input class="form-control"  name="update_customer_email_address" size="30" value="<?php echo $order->customer['email_address']; ?>" /></span></td>
  <td colspan="4"></td>
	</tr>
</table>
...
<h3>
<?php echo MENUE_TITLE_PAYMENT; ?></h3>


  <p>
 <?php echo ENTRY_CURRENCY_TYPE; ?></p>
<p><?php echo ENTRY_CURRENCY_VALUE; ?></p>
 ...
 $enabled_payment[] = array('id' => 'Other', 'text' => 'Other');
		//draw the dropdown menu for payment methods and default to the order value
	  		echo '<p>'. tep_draw_pull_down_menu('update_info_payment_method', $enabled_payment, $order->info['payment_method'], 'id="update_info_payment_method" onChange="init()"').'</p>';
		}
	  	else {
	 ...
	 <div class="form-group">  
	  ...
	  <input class="form-control"  name="update_info_payment_method" size="35" value="<?php echo $order->info['payment_method']; ?>" id="update_info_payment_method" onKeyUp="init()"/>
...
echo '<div class="form-group">'. tep_draw_pull_down_menu('update_info_payment_currency', $currencies_array, $order->info['currency'], 'id="update_info_payment_currency" onChange="currency()"').'</div>';

?>
<div class="form-group">
<input class="form-control"  name="update_info_payment_currency_value" size="15" readonly="readonly" id="update_info_payment_currency_value" value="<?php echo $order->info['currency_value']; ?>" />

</div>

<div class="form-group"><label>
<?php echo ENTRY_CREDIT_CARD_TYPE; ?></label>


<input class="form-control"  name="update_info_cc_type" size="10" value="<?php echo $order->info['cc_type']; ?>" />
</div>

<div class="form-group"><label>
<?php echo ENTRY_CREDIT_CARD_OWNER; ?></label>
<input class="form-control"  name="update_info_cc_owner" size="20" value="<?php echo $order->info['cc_owner']; ?>" />
</div>

<div class="form-group"><label>
<?php echo ENTRY_CREDIT_CARD_NUMBER; ?></label>
<input class="form-control"  name="update_info_cc_number" size="20" value="<?php echo $order->info['cc_number']; ?>" />
</div>

<div class="form-group"><label>
<?php echo ENTRY_CREDIT_CARD_EXPIRES; ?></label>
<input class="form-control"  name="update_info_cc_expires" size="4" value="<?php echo $order->info['cc_expires']; ?>" maxlength="4" />
</div>
	...
	<h3> <?php echo MENUE_TITLE_STATUS; ?> </h3>

<table class="table">
  <tr class="dataTableHeadingRow">
    <td class="dataTableHeadingContent"><?php echo TABLE_HEADING_DATE_ADDED; ?></td>
     <td class="dataTableHeadingContent"><?php echo TABLE_HEADING_CUSTOMER_NOTIFIED; ?></td>
     <td class="dataTableHeadingContent"><?php echo HEADING_TITLE_STATUS; ?></td>
     <td class="dataTableHeadingContent" width="25%"><?php echo TABLE_HEADING_COMMENTS; ?></td>
     <td class="dataTableHeadingContent" width="25%"><?php echo TABLE_HEADING_ADMIN_COMMENTS; ?></td>
   </tr>
<?php
...
if (tep_db_num_rows($orders_history_query)) {
  while ($orders_history = tep_db_fetch_array($orders_history_query)) {
   ...
   echo '    ' . "\n" .
           ...
           '    <td class="smallText">' . nl2br(tep_db_output($orders_history['admin_comments'])) . '&nbsp;</td>' . "\n";
  echo '  </tr>' . "\n";
  }
} else {
  echo '  <tr class="dataTableProducts">' . "\n" .
...
<table class="table">
  <tr class="dataTableHeadingRow">
    ...
    <br>
    <div class="dataTableHeadingContent"><?php echo TABLE_HEADING_ADMIN_COMMENTS; ?></div>
    <?php echo tep_draw_textarea_field('admin_comments', 'soft', '40', '5', ''); ?>
    </td>
  </tr>
</table>
    ...
    <h3>
<?php echo MENUE_TITLE_UPDATE; ?></h3>

 <p> <?php echo HINT_PRESS_UPDATE; ?> <?php echo tep_image_submit('button_update.png', IMAGE_UPDATE); ?> </p> 
...
?>
			...
			<div class="page-header"><h1>	 <?php echo ADDING_TITLE; ?> (No. <?php echo $oID; ?>) </h1></div>
				 
				 <p>
   <?php echo '<a class="btn btn-default" href="' . tep_href_link(FILENAME_ORDERS_EDIT, tep_get_all_get_params(array('action'))) . '">' .  IMAGE_BACK . '</a>'; ?> 
			 </p>
			 <hr>
...
<?php
	...
	echo '<table class="table">' . "\n";
		...
		// Set Defaults
			...
			echo '<td class="dataTableContent"><b>' . ADDPRODUCT_TEXT_STEP . ' 1:</b></td>' .  "\n";
		...
		// Step 2: Choose Product
		   ...
		   {
           echo '<tr class="dataTableRow">' . tep_draw_form('addProduct', FILENAME_ORDERS_EDIT,'oID=' . $_GET['oID'] . '&action=' . $_GET['action']) . "\n";
           echo '<td class="dataTableContent"><b>' . ADDPRODUCT_TEXT_STEP . ' 2: </b></td>' . "\n";
           echo '<td class="dataTableContent" valign="top">' . "\n";
		   //echo '<input type="text" name="search" onKeyUp="searchDropdown(this.value,\'appid\');" />';
           echo '<select class="form-control" name="add_product_products_id" onChange="this.form.submit();" id="appid">' . "\n";
    ...
    if ($products_attributes['total'] == 0) {
				...
				echo '<td class="dataTableContent"><b>' . ADDPRODUCT_TEXT_STEP . ' 3: </b></td>' . "\n";
			...
			{
			echo '<tr class="dataTableRow">' . tep_draw_form('addProduct', FILENAME_ORDERS_EDIT,'oID=' . $_GET['oID'] . '&action=' . $_GET['action']) . "\n";
				echo '<td class="dataTableContent"><b>' . ADDPRODUCT_TEXT_STEP . ' 3: </b></td><td class="dataTableContent" valign="top">';
      ...
      while ($products_options_name = tep_db_fetch_array($products_options_name_query)) {
        ...
        if(isset($_POST['add_product_options'])) {
          ...
          $selected_attribute = false;
			...
			echo tep_draw_pull_down_menu('add_product_options[' . $products_options_name['products_options_id'] . ']', $products_options_array, $selected_attribute) . '<br />' . "\n";
				...
				echo '</td>';
				echo '<td class="dataTableContent"><input type="submit" class="btn btn-default" value="' . ADDPRODUCT_TEXT_OPTIONS_CONFIRM . '">';
				echo '<input type="hidden" name="add_product_categories_id" value=' . $_POST['add_product_categories_id']. '>';
...

		{
			...
			echo '<td class="dataTableContent" valign="top"><input class="form-control"  name="add_product_quantity" size="2" value="1"> ' . ADDPRODUCT_TEXT_CONFIRM_QUANTITY . '</td>';
			echo '<td class="dataTableContent"><input class="form-control"  type="submit" value="' . ADDPRODUCT_TEXT_CONFIRM_ADDNOW . '">';
