...
if (isset($_GET['action']) && ($_GET['action'] == 'send_vendor_email')) {
	...
	class PDF extends FPDF {
		//Page header
		function Header() {
			$this -> SetTitle("Packing Slip Order #" . $_GET['oID']);
			//Logos
	...
	//$vendors_id = tep_db_prepare_input($_GET['vID']);
...
if ($_GET['action'] == 'success') {
									...
									<tr>
										...
										echo '<a class="btn btn-default" href="' . tep_href_link(FILENAME_ORDERS) . '">' . IMAGE_BACK . '</a>';
										?></td>
										<?php
										} //if ($_GET["s_235"] == "s_236")
										...
										<tr>
											...
											<table border="0" width="100%" cellpadding="0" cellspacing="2">
												<tr>
													...
													?></td>
													<td align="center"><?php
													echo '<a classs="btn btn-default" href="' . tep_href_link(FILENAME_VENDORS_EMAIL_SEND, '&vID=' . $_GET['vID'] . '&oID=' . $_GET['oID'] . '&vOS=' . $_GET['vOS']) . '">' . IMAGE_BACK . '</a><a class="btn btn-default" href="' . tep_href_link(FILENAME_ORDERS_VENDORS, '&vID=' . $vendors_id) . '">' . IMAGE_CANCEL . '</a></td>';
													?></td>
...
if ($debug == 'yes') {
		...
		<tr>
			...
			<table border="0" width="100%" cellpadding="0" cellspacing="2">
				<tr>
					...
					?></td>
					<td align="center"><?php
					echo '<a class="btn btn-default" href="' . tep_href_link(FILENAME_ORDERS_VENDORS, '&vID=' . $vendors_id) . '">' . IMAGE_CANCEL . '</a></td>';
					?></td>
		...
		<tr>
			...
			<tr>
				...
				<br>
				<?php
				echo tep_draw_textarea_field_redactor('email', 'soft', '120', '25', stripslashes($email));
				?> </td>
			</tr>
			<?php
