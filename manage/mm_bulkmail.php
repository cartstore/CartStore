<?php
/*
  $Id: mm_bulkmail.php 1739 2011-07-02 http://www.css-oscommerce.com 00:00:00Z hpdl $
  adapted from newsletters.php 2.2RC2a osCommerce, Open Source E-Commerce Solutions
...
?>
      ...
      <tr>
        <td><table border="0" width="100%" cellspacing="0" cellpadding="2">
          <tr>
            <td class="main" align="right"><?php echo (($form_action == 'insert') ? tep_image_submit('button_save.gif', IMAGE_SAVE) : tep_image_submit('button_update.gif', IMAGE_UPDATE)). '&nbsp;&nbsp;<a class="btn btn-default" href="' . tep_href_link(FILENAME_MM_BULKMAIL, (isset($HTTP_GET_VARS['page']) ? 'page=' . $HTTP_GET_VARS['page'] . '&' : '') . (isset($HTTP_GET_VARS['nID']) ? 'nID=' . $HTTP_GET_VARS['nID'] : '')) . '">CANCEL</a>'; ?></td>
          </tr>
        </table></td>
      </form></tr>
<?php
...
?>
      <tr>
        <td align="right"><?php echo '<a class="btn btn-default" href="' . tep_href_link(FILENAME_MM_BULKMAIL, 'page=' . $HTTP_GET_VARS['page'] . '&nID=' . $HTTP_GET_VARS['nID']) . '">BACK </a>'; ?></td>
      </tr>      
...
<?php
    ...
    echo '<tr><td><a class="btn btn-default" href="' . tep_href_link(FILENAME_MM_BULKMAIL, 'page=' . $HTTP_GET_VARS['page'] . '&nID=' . $HTTP_GET_VARS['nID']) . '">BACK</a></td></tr>';
////////////////////////////////////////////////SEND      SEND            SEND  
  } elseif ($action == 'send') {  
	...
	if ($newsletter['module'] != 'product_notification') {	
	  echo '<tr><td><b>' . TEXT_NEWSLETTER_TITLE.' '.$newsletter['module'].'<br /> '.sprintf(TEXT_COUNT_CUSTOMERS, $count['count']) . '</b></td></tr>
 	      <tr><td><a class="btn btn-default" href="' . tep_href_link(FILENAME_MM_BULKMAIL, 'page=' . $HTTP_GET_VARS['page'] . '&nID=' . $HTTP_GET_VARS['nID'] . '&action=confirm_send') . '">SEND</a> <a class="btn btn-default" href="' . tep_href_link(FILENAME_MM_BULKMAIL, 'page=' . $HTTP_GET_VARS['page'] . '&nID=' . $HTTP_GET_VARS['nID']) . '">CANCEL</a></td></tr>
	...
	if (($newsletter['module'] == 'product_notification') && isset($HTTP_GET_VARS['global']) && ($HTTP_GET_VARS['global'] == 'true')) {
		echo '<tr><td><b>' . TEXT_NEWSLETTER_TITLE.' '.$newsletter['module'].'<br /> '.sprintf(TEXT_COUNT_CUSTOMERS, $count['count']) . '</b></td></tr>
		<tr><td><a class="btn btn-default" href="' . tep_href_link(FILENAME_MM_BULKMAIL, 'page=' . $HTTP_GET_VARS['page'] . '&nID=' . $HTTP_GET_VARS['nID'] . '&action=confirm_send&global=true') . '">SEND</a> <a class="btn btn-default" href="' . tep_href_link(FILENAME_MM_BULKMAIL, 'page=' . $HTTP_GET_VARS['page'] . '&nID=' . $HTTP_GET_VARS['nID']) . '">CANCEL</a></td></tr>
		  <tr><td class="main">'.TEXT_PREVIEW.'</td></tr><tr><td class="main"><br />Subject: '.$output_subject.'</td></tr><tr><td>' .$output_content_html . '<br /></td></tr>';
		} 
	elseif ($newsletter['module'] == 'product_notification') {
		...
		echo $ids;
		echo '<tr><td><b>' . TEXT_NEWSLETTER_TITLE.' '.$newsletter['module'].'<br /> '.sprintf(TEXT_COUNT_CUSTOMERS, $count['count']) . '</b></td></tr>
		<tr><td><a class="btn btn-default" href="' . tep_href_link(FILENAME_MM_BULKMAIL, 'page=' . $HTTP_GET_VARS['page'] . '&nID=' . $HTTP_GET_VARS['nID'] . '&action=confirm_send&chosen='.$ids) . '">SEND</a> <a class="btn btn-default" href="' . tep_href_link(FILENAME_MM_BULKMAIL, 'page=' . $HTTP_GET_VARS['page'] . '&nID=' . $HTTP_GET_VARS['nID']) . '">CANCEL</a></td></tr>
		<tr><td class="main">'.TEXT_PREVIEW.'</td></tr><tr><td class="main"><br />Subject: '.$output_subject.'</td></tr><tr><td>' .$output_content_html . '<br /></td></tr>';
	}
...
?>
      ...
      <tr><td><?php echo '<a class="btn btn-default" href="' . tep_href_link(FILENAME_MM_BULKMAIL, 'page=' . $HTTP_GET_VARS['page'] . '&nID=' . $HTTP_GET_VARS['nID']) . '">BACK</a>'; ?></td></tr>
      <?php
...
?>              
                <td class="dataTableContent"><?php echo '<a class="" href="' . tep_href_link(FILENAME_MM_BULKMAIL, 'page=' . $HTTP_GET_VARS['page'] . '&nID=' . $newsletters['newsletters_id'] . '&action=preview') . '"><i class="fa fa-eye"></i></a>&nbsp;' . $newsletters['title']; ?></td>
                ...
                <td class="dataTableContent" align="center"><?php if ($newsletters['status'] == '1') { echo '<i class="fa fa-times-circle-o text-danger"></i>'; } else { echo '<i class="fa fa-times-circle-o text-danger"></i>'; } ?></td>
                <td class="dataTableContent" align="center"><?php if ($newsletters['locked'] > 0) { echo '<i class="fa fa-lock text-success"></i>'; } else { echo '<i class="fa fa-unlock-alt text-danger"></i>'; } ?></td>
                <td class="dataTableContent" align="right"><?php if (isset($nInfo) && is_object($nInfo) && ($newsletters['newsletters_id'] == $nInfo->newsletters_id) ) { echo '<i class="fa fa-long-arrow-right"></i>'; } else { echo '<a href="' . tep_href_link(FILENAME_MM_BULKMAIL, 'page=' . $HTTP_GET_VARS['page'] . '&nID=' . $newsletters['newsletters_id']) . '"><i class="fa fa-hand-o-up"></i></a>'; } ?>&nbsp;</td>
              </tr>
<?php
    }
?>
              <tr>
                <td colspan="6"><table border="0" width="100%" cellspacing="0" cellpadding="2">
                  ...
                  <tr>
                    ...
                    <td align="right"><?php echo '<a class="btn btn-default" href="' . tep_href_link(FILENAME_MM_BULKMAIL, 'action=new') . '">NEW</a>'; ?></td>
                  </tr>
                </table></td>
              </tr>
            </table></td>
<?php
  ...
  switch ($action) {
    case 'delete':
      ...
      $contents[] = array('align' => 'center', 'text' => '<br>' . tep_image_submit('button_delete.gif', IMAGE_DELETE) . ' <a class="btn btn-default" href="' . tep_href_link(FILENAME_MM_BULKMAIL, 'page=' . $HTTP_GET_VARS['page'] . '&nID=' . $HTTP_GET_VARS['nID']) . '">CANCEL</a>');
      break;
    default:
      if (is_object($nInfo)) {
        $heading[] = array('text' => '<b>' . $nInfo->title . '</b>');
        ...
        if ($nInfo->locked > 0) {
          ...
          $contents[] = array('align' => 'center', 'text' => '
          				<a class="btn btn-default" href="' . tep_href_link(FILENAME_MM_BULKMAIL, 'page=' . $HTTP_GET_VARS['page'] . '&nID=' . $nInfo->newsletters_id . '&action=new') . '">EDIT</a> 
          				<a class="btn btn-default"  href="' . tep_href_link(FILENAME_MM_BULKMAIL, 'page=' . $HTTP_GET_VARS['page'] . '&nID=' . $nInfo->newsletters_id . '&action=delete') . '"> DELETE</a> 
          				<a class="btn btn-default" href="' . tep_href_link(FILENAME_MM_BULKMAIL, 'page=' . $HTTP_GET_VARS['page'] . '&nID=' . $nInfo->newsletters_id . '&action=preview') . '">PREVIEW</a> 
          				<a class="btn btn-default" href="' . tep_href_link(FILENAME_MM_BULKMAIL, 'page=' . $HTTP_GET_VARS['page'] . '&nID=' . $nInfo->newsletters_id . '&action=send') . '">SEND</a> 
          				<a class="btn btn-default" href="' . tep_href_link(FILENAME_MM_BULKMAIL, 'page=' . $HTTP_GET_VARS['page'] . '&nID=' . $nInfo->newsletters_id . '&action=test') . '">TEST</a>          				
          				<a class="btn btn-default" href="' . tep_href_link(FILENAME_MM_BULKMAIL, 'page=' . $HTTP_GET_VARS['page'] . '&nID=' . $nInfo->newsletters_id . '&action=unlock') . '">UNLOCK</a>
          				');
                         
          //buttons if newsletter unlocked
        } else {
          $contents[] = array('align' => 'center', 'text' => '<a class="btn btn-default" href="' . tep_href_link(FILENAME_MM_BULKMAIL, 'page=' . $HTTP_GET_VARS['page'] . '&nID=' . $nInfo->newsletters_id . '&action=preview') . '">PREVIEW</a> <a class="btn btn-default" href="' . tep_href_link(FILENAME_MM_BULKMAIL, 'page=' . $HTTP_GET_VARS['page'] . '&nID=' . $nInfo->newsletters_id . '&action=lock') . '">LOCK</a>');
        }
