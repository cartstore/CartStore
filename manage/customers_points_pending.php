...
?>
  ...
  switch ($action) {
      case 'confirm':
          ...
          $contents[] = array('align' => 'center', 'text' => '<br>' . tep_image_submit('button_confirm_points.png', BUTTON_TEXT_CONFIRM_PENDING_POINTS) . ' <a class="btn button" href="' . tep_href_link(FILENAME_CUSTOMERS_POINTS_PENDING, tep_get_all_get_params(array('uID', 'action')) . 'uID=' . $uInfo->unique_id) . '">' . IMAGE_CANCEL . '</a>');
          break;
      case 'cancel':
          ...
          $contents[] = array('text' => tep_draw_hidden_field('orders_id', $uInfo->orders_id) . tep_draw_hidden_field('customers_id', $uInfo->customers_id) . tep_draw_hidden_field('customers_email_address', $uInfo->customers_email_address) . tep_draw_hidden_field('date_purchased', $uInfo->date_purchased) . tep_draw_hidden_field('orders_status_name', $uInfo->orders_status_name) . tep_draw_hidden_field('points_pending', $uInfo->points_pending));
          $contents[] = array('align' => 'center', 'text' => '<br>' . tep_image_submit('button_cancel_points.png', BUTTON_TEXT_CANCEL_PENDING_POINTS) . ' <a class="btn button" href="' . tep_href_link(FILENAME_CUSTOMERS_POINTS_PENDING, tep_get_all_get_params(array('uID', 'action')) . 'uID=' . $uInfo->unique_id) . '">' . IMAGE_CANCEL . '</a>');
          break;
      case 'adjust':
          ...
          $contents[] = array('text' => $value_field);
          $contents[] = array('align' => 'center', 'text' => '<br>' . tep_image_submit('button_adjust_points.png', BUTTON_TEXT_ADJUST_POINTS) . ' <a class="btn button" href="' . tep_href_link(FILENAME_CUSTOMERS_POINTS_PENDING, tep_get_all_get_params(array('uID', 'action')) . 'uID=' . $uInfo->unique_id) . '">' . IMAGE_CANCEL . '</a>');
          break;
      case 'rollback':
          ...
          $contents[] = array('align' => 'center', 'text' => '<br>' . tep_image_submit('button_rollback_points.png', BUTTON_TEXT_ROLL_POINTS) . ' <a class="btn button" href="' . tep_href_link(FILENAME_CUSTOMERS_POINTS_PENDING, tep_get_all_get_params(array('uID', 'action')) . 'uID=' . $uInfo->unique_id) . '">' . IMAGE_CANCEL . '</a>');
          break;
      case 'delete':
          ...
          $contents[] = array('align' => 'center', 'text' => '<br>' . tep_image_submit('button_delete.png', BUTTON_TEXT_REMOVE_RECORD) . ' <a class="btn button" href="' . tep_href_link(FILENAME_CUSTOMERS_POINTS_PENDING, tep_get_all_get_params(array('uID', 'action')) . 'uID=' . $uInfo->unique_id) . '">' . IMAGE_CANCEL . '</a>');
          break;
      default:
          if (isset($uInfo) && is_object($uInfo)) {
              ...
              if ($uInfo->points_status == 1) {
                  $contents[] = array('align' => 'center', 'text' => '<a class="btn button" href="' . tep_href_link(FILENAME_CUSTOMERS_POINTS_PENDING, tep_get_all_get_params(array('uID', 'action')) . 'uID=' . $uInfo->unique_id . '&action=confirm') . '">' . BUTTON_TEXT_CONFIRM_PENDING_POINTS . '</a> <a class="btn button" href="' . tep_href_link(FILENAME_CUSTOMERS_POINTS_PENDING, tep_get_all_get_params(array('uID', 'action')) . 'uID=' . $uInfo->unique_id . '&action=cancel') . '">' . BUTTON_TEXT_CANCEL_PENDING_POINTS . '</a> <a class="btn button" href="' . tep_href_link(FILENAME_CUSTOMERS_POINTS_PENDING, tep_get_all_get_params(array('uID', 'action')) . 'uID=' . $uInfo->unique_id . '&action=adjust') . '">' . BUTTON_TEXT_ADJUST_POINTS . '</a> <a class="btn button" href="' . tep_href_link(FILENAME_MAIL, 'selected_box=tools&customer=' . $uInfo->customers_email_address) . '">' . IMAGE_EMAIL . '</a> <a class="btn button" href="' . tep_href_link(FILENAME_CUSTOMERS_POINTS_PENDING, tep_get_all_get_params(array('uID', 'action')) . 'uID=' . $uInfo->unique_id . '&action=delete') . '">' . BUTTON_TEXT_REMOVE_RECORD . '</a>');
              }
              if ($uInfo->points_status == 2) {
                  $contents[] = array('align' => 'center', 'text' => '<a class="btn button" href="' . tep_href_link(FILENAME_CUSTOMERS_POINTS_PENDING, tep_get_all_get_params(array('action')) . 'uID=' . $uInfo->unique_id . '&action=rollback') . '">' . BUTTON_TEXT_ROLL_POINTS . '</a> <a class="btn button" href="' . tep_href_link(FILENAME_MAIL, 'selected_box=tools&customer=' . $uInfo->customers_email_address) . '">' . IMAGE_EMAIL . '</a> <a class="btn button" href="' . tep_href_link(FILENAME_CUSTOMERS_POINTS_PENDING, tep_get_all_get_params(array('uID', 'action')) . 'uID=' . $uInfo->unique_id . '&action=delete') . '">' . BUTTON_TEXT_REMOVE_RECORD . '</a>');
              }
              if ($uInfo->points_status == 3) {
                  $contents[] = array('text' => '<a class="btn button" href="' . tep_href_link(FILENAME_CUSTOMERS_POINTS_PENDING, tep_get_all_get_params(array('uID', 'action')) . 'uID=' . $uInfo->unique_id . '&action=confirm') . '">' . BUTTON_TEXT_CONFIRM_PENDING_POINTS . '</a> <a class="btn button" href="' . tep_href_link(FILENAME_CUSTOMERS_POINTS_PENDING, tep_get_all_get_params(array('uID', 'action')) . 'uID=' . $uInfo->unique_id . '&action=adjust') . '">' . BUTTON_TEXT_ADJUST_POINTS . '</a> <a class="btn button" href="' . tep_href_link(FILENAME_ORDERS . '?oID=' . $uInfo->orders_id . '&action=edit') . '">' . IMAGE_DETAILS . '</a> <a class="btn button" href="' . tep_href_link(FILENAME_MAIL, 'selected_box=tools&customer=' . $uInfo->customers_email_address) . '">' . IMAGE_EMAIL . '</a> <a class="btn button" href="' . tep_href_link(FILENAME_CUSTOMERS_POINTS_PENDING, tep_get_all_get_params(array('uID', 'action')) . 'uID=' . $uInfo->unique_id . '&action=delete') . '">' . BUTTON_TEXT_REMOVE_RECORD . '</a>');
              }
              if ($uInfo->points_status == 4) {
                  $contents[] = array('align' => 'center', 'text' => '<a class="btn button" href="' . tep_href_link(FILENAME_ORDERS . '?oID=' . $uInfo->orders_id . '&action=edit') . '">' . IMAGE_DETAILS . '</a> <a class="btn button" href="' . tep_href_link(FILENAME_MAIL, 'selected_box=tools&customer=' . $uInfo->customers_email_address) . '">' . IMAGE_EMAIL . '</a> <a class="btn button" href="' . tep_href_link(FILENAME_CUSTOMERS_POINTS_PENDING, tep_get_all_get_params(array('uID', 'action')) . 'uID=' . $uInfo->unique_id . '&action=delete') . '">' . BUTTON_TEXT_REMOVE_RECORD . '</a>');
              }
