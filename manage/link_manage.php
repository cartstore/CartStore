...
<div class="page-header"><h1><?php echo L_TITLE ; ?></h1></div>


 
<a href=<?php echo tep_href_link('link_manage.php').'><b>'.MAINLIST?> </b></a> |<a href=<?php echo tep_href_link('link_manage.php','action=add1'.$page.$sort).'><b> '.ADDLINK;?> </b></a> |<a href=<?php echo tep_href_link('link_manage.php','action=checkall'.$page.$sort).'><b> '.'Check All ' . ($sort_category ? ($sort_category == 999 ? 'Unallocated ' :  $categories[$sort_category]) . ' ' : '') . 'Links';?> </b></a>
<?php if ($rows && !$edit_mode) { ?>

<div class="form-group"><label>
<?php echo tep_draw_form('sort', 'link_manage.php', 'action=sel_cat', 'post').'View category: </label>' . tep_draw_pull_down_menu('sort_category', $sort_category_array, $sort_category, 'onChange="this.form.submit();" rel="nofollow"'); ?><noscript><input title="View" name="" type="submit" value="Go"></noscript></form>
</div>
...
<?php } ?>
		...
		<tr class="dataTableHeadingRow"><td align="center" class="dataTableHeadingContent"><?php echo LM_HEAD1; ?></td><td class="dataTableHeadingContent"align="center"><?php echo LM_HEAD2; ?></td><td class="dataTableHeadingContent"><?php echo LM_HEAD3; ?></td><td align="center" class="dataTableHeadingContent"><?php echo 'Category'; ?></td><td align="center" class="dataTableHeadingContent"><?php echo LM_HEAD4; ?></td><td align="center" class="dataTableHeadingContent"><?php echo LM_HEAD5; ?></td><td class="dataTableHeadingContent"><?php echo LM_HEAD6; ?></td><td class="dataTableHeadingContent"><?php echo LM_HEAD8; ?></td><td class="dataTableHeadingContent"><?php echo LM_HEAD7; ?></td></tr>
 <?php
...
<tr class="dataTableHeadingRow"><td class="dataTableHeadingContent"><?php echo MLTITLE; ?></td><td align="center" class="dataTableHeadingContent">Order</td><td align="center" class="dataTableHeadingContent"><?php echo LM_HEAD4; ?></td><td class="dataTableHeadingContent"><?php echo LM_HEAD8; ?></td><td class="dataTableHeadingContent">Modified</td><td class="dataTableHeadingContent"><?php echo LM_HEAD7; ?></td></tr>
<?php $category_query = tep_db_query("select * from links_categories order by sort_order, category_name");
	...
	<tr class="dataTableRow" onMouseOver="this.className='dataTableRowOver';this.style.cursor='hand'" onMouseOut="this.className='dataTableRow'">
<!-- name -->
<td class="dataTableContent" width="30%"><?php echo tep_draw_input_field('category_name', $category['category_name'], 'maxLength=32 size=32'); ?></td>
<!-- sort_order -->
...
?>  </td><td class="dataTableRow" align="right"><?php echo $e_info['new_category'] ? ' Suggested Category: ' .  $e_info['new_category'] : ''; ?></td><td width="70" align="center"><?php echo $e_info['new_category'] ? tep_draw_checkbox_field('accept_new') . ' Use' : ''; ?></td></tr>
  ...
  <tr>
	...
	echo '<a class="btn btn-default" href="' . tep_href_link($back_url, $back_url_params) . '">' .  IMAGE_CANCEL. '</a>' . '<a class="btn btn-default" href="' . tep_href_link($back_url, $back_url_params . '&action=delete'.$aa.($sess_id ? '' : '#' . $e_info['links_id'])) . '">' .  IMAGE_DELETE . '</a>'; ?></td></tr>
  </tr>
