...
<div class="page-header"><h1><a class="pull-right" data-toggle="collapse" data-parent="#accordion" href="#collapseOne">
                  ...
                  </a><?php echo $pageTitle; ?></h1></div>    <div class="panel-group" id="accordion">
                  <div class="clear"></div>
...
// Find all of the Current Option's Available Values
        ...
        if ($matches2) {
           ...
           while ($line = tep_db_fetch_array($result2, MYSQL_ASSOC)) {
                ...
                while($line = tep_db_fetch_array($result3, MYSQL_ASSOC)) {
...
// Add Support for multiple text input option types (for Chandra's contribution).. and using ' to begin/end strings.. less of a mess.
                        ...
                        echo "</TD>";
                        echo "<TD class=\"main\" align=\"left\"><input type=\"text\" class=\"form-control\" name=\"" . $current_value_id . "_price\" value=\"" . $attribute_value_price . "\" size=\"10\"></TD>";
                        ...
                        if ( $optionTypeInstalled == "1" ) {
                                ...
                                echo "<TD class=\"main\" align=\"left\"><select class=\"form-control\"  name=\"" . $current_value_id . "_type\">";
                                ...
                                echo "<TD class=\"main\" align=\"left\"><select class=\"form-control\"  name=\"" . $current_value_id . "_prefix\"> <OPTION value=\" \"" . $zeroCheck . "> <OPTION value=\"+\"" . $posCheck . ">+<OPTION value=\"-\"" . $negCheck . ">-</SELECT></TD>";
                        ...
                        if ( $optionSortCopyInstalled == "1" ) {
                                ...
                                echo "<TD class=\"main\" align=\"left\"><select class=\"form-control\"  name=\"" . $current_value_id . "_weight_prefix\">";
...
<p><INPUT class="btn btn-default" TYPE="submit" value="Save">
   <a class="btn btn-default" href="javascript:history.back()">Cancel</A></p>
