...
<i class="fa fa-magic fa-5x pull-left"></i>
Recover cart sales allows you to see visitors that added items to there cart began checking out to a point there email address was captured but didn't complete checkout. You then may select one or many of these visitors and send them a message via email.
...
if (count($custid) > 0 ) {  ?>
            <tr>
              <td class="pageHeading" align="left" colspan=2 width="50%"> </td>
              <td class="pageHeading" align="left" colspan=4 width="50%"><?php echo HEADING_EMAIL_SENT; ?> </td>
            </tr>
            <tr class="dataTableHeadingRow">
              <td class="dataTableHeadingContent" colspan="1" width="15%" nowrap><?php echo TABLE_HEADING_CUSTOMER; ?></td>
              <td class="dataTableHeadingContent" colspan="1" width="30%" nowrap>&nbsp;</td>
              <td class="dataTableHeadingContent" colspan="1" width="25%" nowrap>&nbsp;</td>
              <td class="dataTableHeadingContent" colspan="1" width="10%" nowrap>&nbsp;</td>
              <td class="dataTableHeadingContent" colspan="1" width="10%" nowrap>&nbsp;</td>
              <td class="dataTableHeadingContent" colspan="1" width="10%" nowrap>&nbsp;</td>
            </tr><tr>&nbsp;<br></tr>
            <tr class="dataTableHeadingRow">
              <td class="dataTableHeadingContent"   colspan="1"  width="15%" nowrap><?php echo TABLE_HEADING_MODEL; ?></td>
              <td class="dataTableHeadingContent"   colspan="2"  width="55%" nowrap><?php echo TABLE_HEADING_DESCRIPTION; ?></td>
              <td class="dataTableHeadingContent" colspan="1"  width="10%" nowrap> <?php echo TABLE_HEADING_QUANTY; ?></td>
              <td class="dataTableHeadingContent"  colspan="1"  width="10%" nowrap><?php echo TABLE_HEADING_PRICE; ?></td>
              <td class="dataTableHeadingContent"  colspan="1"  width="10%" nowrap><?php echo TABLE_HEADING_TOTAL; ?></td>
            </tr>
<?php
...
?>
        ...
        <div class="form-group"> 
                    ...
                    <input class="form-control" type=text size=4 width=4 value=<?php echo $sdate; ?> name=sdate> - 
                    <input class="form-control" type=text size=4 width=4 value=<?php echo $tdate; ?> name=tdate><?php echo DAYS_FIELD_POSTFIX; ?>
...
<form method=post action=<?php echo $PHP_SELF; ?>>
            <tr class="dataTableHeadingRow">
              <td class="dataTableHeadingContent" colspan="2" width="10%" nowrap><?php echo TABLE_HEADING_CONTACT; ?></td>
              <td class="dataTableHeadingContent" colspan="1" width="15%" nowrap><?php echo TABLE_HEADING_DATE; ?></td>
              <td class="dataTableHeadingContent" colspan="1" width="30%" nowrap><?php echo TABLE_HEADING_CUSTOMER; ?></td>
              <td class="dataTableHeadingContent" colspan="2" width="30%" nowrap><?php echo TABLE_HEADING_EMAIL; ?></td>
              <td class="dataTableHeadingContent" colspan="2" width="15%" nowrap><?php echo TABLE_HEADING_PHONE; ?></td>
            </tr><tr>&nbsp;<br></tr>
            <tr class="dataTableHeadingRow">
              <td class="dataTableHeadingContent"   colspan="2"  width="10%" nowrap>&nbsp; </td>
              <td class="dataTableHeadingContent"   colspan="1"  width="15%" nowrap><?php echo TABLE_HEADING_MODEL; ?></td>
              <td class="dataTableHeadingContent"   colspan="2" width="55%" nowrap><?php echo TABLE_HEADING_DESCRIPTION; ?></td>
              <td class="dataTableHeadingContent" colspan="1" width="5%" nowrap> <?php echo TABLE_HEADING_QUANTY; ?></td>
              <td class="dataTableHeadingContent"  colspan="1"  width="5%" nowrap><?php echo TABLE_HEADING_PRICE; ?></td>
              <td class="dataTableHeadingContent"  colspan="1" width="10%" nowrap><?php echo TABLE_HEADING_TOTAL; ?></td>
            </tr>
<?php
