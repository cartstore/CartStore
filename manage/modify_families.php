...
?>
                ...
                <td class="dataTableContent"><?php if (isset($f_Info) && is_object($f_Info) && ($families['family_id'] == $f_Info->family_id) ) { echo '<i class="fa fa-long-arrow-right"></i>'; } else { echo '<a href="' . tep_href_link(FILENAME_MODIFY_FAMILIES, 'f_Id=' . $families['family_id']) . '"><i class="fa fa-hand-o-up"></i></a>'; } ?>&nbsp;</td>
              </tr>
<?php
    }
?>
