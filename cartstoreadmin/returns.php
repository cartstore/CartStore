  ...
  <tr>
    ...
    ?>
              ...
              <tr>
                ...
                <td width=65% class=main><? echo $order->info['department']; ?></td>
              </tr>
              <tr>
                <td class="main" width=25% valign=top><b><?php echo ENTRY_PAYMENT_METHOD; ?></b></td>
                <td width=65% class=main><? echo $order->info['customer_method']; ?></td>
              </tr>
              <tr>
              ...
              ?>
              <tr>
                <td class="main" width=25%><b><? echo ENTRY_PAYMENT_AMOUNT; ?></b></td>
                <td width=65% class=main><? echo $currencies->format($price_new ); ?></td>
              </tr>
              <tr>
...
<td><table border="0" cellspacing="0" cellpadding="2">
    <tr>
      <td><table border="0" cellspacing="0" cellpadding="2">
          <tr>
            <td class="main" width=25%><b><font color="CC0000"><? echo ENTRY_STATUS; ?></font></b></td>
          ...
          <tr>
            ...
            <td width=65% class=main><? echo tep_draw_pull_down_menu('department', $support_departments); ?></td>
          </tr>
          <tr>
            <td class=main width=25% valign=top><b><? echo TEXT_CUSTOM_PREF_METHOD; ?></b></td>
            <td width=65% class=main><b><? echo $order->info['department']; ?></b></td>
          </tr>
          <tr>
            <td class="main" width=25% valign=top><b><?php echo ENTRY_PAYMENT_REFERENCE; ?></b></td>
          ...
          <?php
              ...
              ?>
          <tr>
            <td class="main" width=25%><b><font color="CC0000"><? echo ENTRY_PAYMENT_AMOUNT; ?></font></b></td>
            <td width=65% class=main><? echo tep_draw_input_field('refund_amount', $price_new ); ?></td>
          </tr>
          <tr>
            <td class="main" width=25%><b><? echo ENTRY_PAYMENT_DATE; ?></b></td>
          ...
          <?php
              ...
              ?>
          <tr>
            <td class="main" width=25%><b><? echo ENTRY_RESTOCK_CHARGE; ?></b></td>
          ...
          <tr>
            <td class="main" width=25%><b><? echo SUCCESS_RETURNED_GIFT; ?></b></td>
            <td width=65% class=main><?php echo tep_draw_checkbox_field('gv_refund', '', false); ?></td>
          </tr>
          <tr>
            <td class=main valign=top><b><? echo TEXT_GIFT_COMMENT; ?></b></td>
          ...
          <tr>
            <td class="main" align="left" width="30%"><b><? echo TEXT_COMPLETE_RETURN; ?></b><?php echo tep_draw_checkbox_field('complete', '', false); ?></td>
            <td class="main" align="left" width="30%"><b><? echo TEXT_BACK_TO_STOCK; ?></b><?php echo tep_draw_checkbox_field('restock_products', '', false); ?></td>
          </tr>
        </table></td>
    <tr>
      <td><?php echo tep_draw_separator('pixel_trans.gif', '1', '10'); ?></td>
