...
// Headings
define('PAY_METHOD', 'Quickbooks Methods');
define('PAY_TYPE', 'Type');
// Messages
define('PAY_NOT_PAID', 'Not prepaid');
define('PAY_PRE_PAID', 'Paid online');
// Buttons
define('PAY_TYPE_BUTTON', 'Update Payment Types');

define('SETUP_FAIL', 'No payment items found in the iif file!');
?>