...
define('OVERVIEW_GOOGLE_SITEMAPS', 'This module automatically generates several XML Google compliant site maps for your CartStore store: a main site map, one for categories, and one for your products.');
define('INSTRUCTIONS_TITLE_GOOGLE_SITEMAPS', 'INSTRUCTIONS: ');
define('INSTRUCTIONS_STEP1_GOOGLE_SITEMAPS', 'STEP 1:');
define('INSTRUCTIONS_CLICK_GOOGLE_SITEMAPS', ' Click ');
define('INSTRUCTIONS_END1_GOOGLE_SITEMAPS', ' to create / update your site map. ');
...
define('INSTRUCTIONS_END2_GOOGLE_SITEMAPS', ' to PING the google server to notify them of the update to your XML sitemap.');
define('INSTRUCTIONS_COMPLETE_GOOGLE_SITEMAPS', 'COMPLETE!');
...
define('EXEC_GOOGLE_SITEMAPS', '[HERE]');
?>
