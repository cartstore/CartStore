...
define('HEADING_TITLE_EP', '<h1>Advanced Easy Populate with SSP, QPPB and Extra Fields</h1>');
...
define('DOWNLOAD_EP_2', 'Download .csv file with comma delimited to edit ');
define('COMPLETE_EP', '( Complete ) ');
define('MODEL_PRICE_QUANTITY_EP', '( Model / Price / Quantity ) ');
define('MODEL_CATEGORY_EP', '( Model / Category ) ');
...
define('MODEL_ATTRIBUTES_EP', '( Model / Attributes ) ');
...
define('NO_NEW_PRODUCT_EP', 'No products_model field in record. This line was not imported.' );
define('NEW_PRODUCT_EP', ' !New Product!' );
define('INSERED_EP', ' Inserted' );
?>
