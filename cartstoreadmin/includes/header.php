...
?>">
          <?=BOX_REPORTS_RECOVER_CART_SALES?>
          </a></li>
        <li><a
...
?><?php
  echo DIR_WS_ADMIN;
?>coupon_admin.php?selected_box=gv_admin">Coupons</a></li>
        <li><a
...
?>export_orders_csv.php">Export Orders</a></li>
  ...
  echo HTTP_CATALOG_SERVER;
?><?php
  echo DIR_WS_ADMIN . FILENAME_RETURNS;
?>">
              <?=BOX_RETURNS_MAIN?>
              </a></li>
            <li><a
  ...
  echo HTTP_CATALOG_SERVER;
?><?php
  echo DIR_WS_ADMIN . FILENAME_RETURNS_REASONS;
?>">
              <?=BOX_RETURNS_REASONS?>
              </a></li>
            <li><a
...
?><?php
  echo DIR_WS_ADMIN;
?>products_attributes.php">Create Product Options</a></li>
        <li><a href="<?php
  echo HTTP_CATALOG_SERVER;
?><?php
  echo DIR_WS_ADMIN;
...
?><?php
  echo DIR_WS_ADMIN;
?>analytics.php">Analytics Code Editor</a></li>
