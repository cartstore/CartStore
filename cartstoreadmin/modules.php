  ...
  if (tep_not_null($action)) {
    switch ($action) {
	  ...
	  ///////////////////////////////////////////////////////////////////////////////
       ...
       //   if ($key == 'MODULE_PAYMENT_CHECKOUTBYAMAZON_AWSSECRETKEY' ||
         //      $key == 'MODULE_PAYMENT_CHECKOUTBYAMAZON_CBAMERCHANTPASSWORD') {
        //     if (trim($value) == "") {
        //        continue;
        //     }
        //     else {
                // encrypt in the database for security reasons
        //        $keyFile = DIR_FS_CATALOG . ".checkout_by_amazon_key";
         //       $fh = fopen($keyFile, 'r');
         //       $encryptionKey = fread($fh, filesize($keyFile));
         //       fclose($fh);
