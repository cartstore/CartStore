...
?></td>
                <td class="pageHeading" align="left"><?php
      echo '<a class="button" href="' . tep_href_link(FILENAME_ORDERS_VENDORS) . '">' . IMAGE_BACK . '</a>';
?></td>
                <?php
  } //if ($_GET["s_235"] == "s_236")
...
?></td>
                      <td align="center"><?php
      echo '<a href="' . tep_href_link(FILENAME_VENDORS_EMAIL_SEND, '&vID=' . $vID . '&oID=' . $oID . '&vOS=' . $vOS) . '">' . tep_image_button('button_back.png', IMAGE_BACK) . '</a>&nbsp;<a href="' . tep_href_link(FILENAME_ORDERS_VENDORS, '&vID=' . $vendors_id) . '">' . tep_image_button('button_cancel.png', IMAGE_CANCEL) . '</a></td>';
?></td>
                      <tr>
                        <td colspan="3"><?php
      echo tep_draw_separator();
...
?>
                      ...
                      <?php
      echo tep_draw_hidden_field('vID', stripslashes($vID));
?>
                      </td>
                    </tr>
                    <td align="right"><?php
...
?></td>
                  ...
                  <tr>
                    ...
                    <br> <?php
          echo tep_draw_textarea_field('email', 'soft', '120', '25', stripslashes($email));
?>
                    
                    </td>
                  </tr>
                  <?php
          echo tep_draw_hidden_field('vID', $vID);
?>
                  </td>
                  <?php
...
?>
                  ...
                  <?php
          echo tep_draw_hidden_field('vOS', $vOS);
?>
                  </td>
                  <td align="right"><?php
