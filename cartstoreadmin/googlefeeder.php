...
define('DOMAIN_NAME', 'www.4x4groupbuy.com/store'); //your correct domain name (don't include www unless it is used)
define('FTP_USERNAME', '4x4groupbuy'); //from your googlebase account
define('FTP_PASSWORD', 'G5dHjsw739'); //from your googlebase account
