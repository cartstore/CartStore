     ...
     <tr>
      ...
      <table class="smallText" border=1 cellpadding=2 cellspacing=0>
       ...
       <tr>
        ...
        <td >Alexa Traffic Ranking</td><td align='right'><? echo "{$results['alexa'][0]}"; ?> (<a target="_blank" href='<? echo "{$results['alexa'][1]}"; ?>'>view</a>)</td>

				 <?php if ($show_second_link) { ?> <td align='right'><? echo "{$results_2['alexa'][0]}"; ?> (<a target="_blank" href='<? echo "{$results_2['alexa'][1]}"; ?>'>view</a>)</td> <?php } ?>
       ...
       <tr>
        ...
        <td>Present in DMOZ</td><td align='right'><? echo "{$results['dmoz'][0]}"; ?> (<a target="_blank" href='<? echo "{$results['dmoz'][1]}"; ?>'>view</a>)</td>

			   <?php if ($show_second_link) { ?> <td align='right'><? echo "{$results_2['dmoz'][0]}"; ?> (<a target="_blank" href='<? echo "{$results_2['dmoz'][1]}"; ?>'>view</a>)</td> <?php } ?>
        ...
        <td>Present in Zeal</td><td align='right'><? echo "{$results['zeal'][0]}"; ?> (<a target="_blank" href='<? echo "{$results['zeal'][1]}"; ?>'>view</a>)</td>

				<?php if ($show_second_link) { ?> <td align='right'><? echo "{$results_2['zeal'][0]}"; ?> (<a target="_blank" href='<? echo "{$results_2['zeal'][1]}"; ?>'>view</a>)</td> <?php } ?>
        ...
        <td>AlltheWeb</td><td align='right'><? echo "{$results['alltheweb'][0]}"; ?> (<a target="_blank" href='<? echo "{$results['alltheweb'][1]}"; ?>'>view</a>)</td>

				<?php if ($show_second_link) { ?> <td align='right'><? echo "{$results_2['alltheweb'][0]}"; ?> (<a target="_blank" href='<? echo "{$results_2['alltheweb'][1]}"; ?>'>view</a>)</td> <?php } ?>
        ...
        <td>AltaVista</td><td align='right'><? echo "{$results['altavista'][0]}"; ?> (<a target="_blank" href='<? echo "{$results['altavista'][1]}"; ?>'>view</a>)</td>

			   <?php if ($show_second_link) { ?> <td align='right'><? echo "{$results_2['altavista'][0]}"; ?> (<a target="_blank" href='<? echo "{$results_2['altavista'][1]}"; ?>'>view</a>)</td> <?php } ?>
        ...
        <td>Google</td><td align='right'><? echo "{$results['google'][0]}"; ?> (<a target="_blank" href='<? echo "{$results['google'][1]}"; ?>'>view</a>)</td>

			   <?php if ($show_second_link) { ?> <td align='right'><? echo "{$results_2['google'][0]}"; ?> (<a target="_blank" href='<? echo "{$results_2['google'][1]}"; ?>'>view</a>)</td> <?php } ?>
        ...
        <td align='right'><? echo "{$results['hotbot'][0]}"; ?> (<a target="_blank" href='<? echo "{$results['hotbot'][1]}"; ?>'>view</a>)</td>

			   <?php if ($show_second_link) { ?> <td align='right'><? echo "{$results_2['hotbot'][0]}"; ?> (<a target="_blank" href='<? echo "{$results_2['hotbot'][1]}"; ?>'>view</a>)</td> <?php } ?>
        ...
        <td align='right'><? echo "{$results['msn'][0]}"; ?> (<a target="_blank" href='<? echo "{$results['msn'][1]}"; ?>'>view</a>)</td>

				<?php if ($show_second_link) { ?> <td align='right'><? echo "{$results_2['msn'][0]}"; ?> (<a target="_blank" href='<? echo "{$results_2['msn'][1]}"; ?>'>view</a>)</td> <?php } ?>
        ...
        <td align='right'><? echo "{$results['yahoo'][0]}"; ?> (<a target="_blank" href='<? echo "{$results['yahoo'][1]}"; ?>'>view</a>)</td>

			   <?php if ($show_second_link) { ?> <td align='right'><? echo "{$results_2['yahoo'][0]}"; ?> (<a target="_blank" href='<? echo "{$results_2['yahoo'][1]}"; ?>'>view</a>)</td> <?php } ?>
        ...
        <td align='right'><b><? echo number_format($total); ?></b></td>

				<?php if ($show_second_link) { ?>	<td align='right'><b><? echo number_format($total_2); ?></b></td> <?php } ?>		
