...
<label>Descrption</label><textarea name="desc" class="ckeditor" cols="30" rows="10"/><?=$row['description'];?></textarea>
<br /><br />
...
<? echo "Event ".stripslashes($name)."<br />"; ?>
<? echo "Description ".stripslashes($desc)."<br />"; ?>
<? echo "location ".stripslashes($location)."<br />"; ?>
<? echo "Date ".$date."<br />"; ?>
<? echo "From ".$from."<br />"; ?>
<? echo "Until ".$until."<br />"; ?>
...
<input type="hidden" name="desc" value="<?=stripslashes($desc); ?>" />
<input type="hidden" name="location" value="<?=stripslashes($location); ?>" />
<input type="hidden" name="date" value="<? echo $date; ?>" />
<input type="hidden" name="from" value="<? echo $from; ?>" />
<input type="hidden" name="until" value="<? echo $until; ?>" />
