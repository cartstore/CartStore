...
<label>Date</label><input class="edit_search" type="text" name="date" id="datepicker" value="<?=$date?>" />
...
<label>Name</label><input type="text" name="name" value="<?=stripslashes($row['event']);?>" /><br />
<label>Descrption</label><textarea name="desc" class="ckeditor" cols="30" rows="10"/><?=stripslashes($row['description']);?></textarea>

<br /><br />

<label>Location</label><input type="text" name="location" value="<?=stripslashes($row['location']);?>" />
...
<select name="from">
<option selected value="<?=$from[0].$from[1]?>"><?=$from[0].$from[1]?></option>
...
<select name="from2">
<option selected value="<?=$from[2].$from[3]?>"><?=$from[2].$from[3]?></option>
<option value="15">15</option>
...
<select name="until">
<option selected value="<?=$until[0].$until[1]?>"><?=$until[0].$until[1]?></option>
<option value="01">01</option>
<option value="02">02</option>
<option value="03">03</option>
<option value="04">04</option>
...
<select name="until2">
<option selected value="<?=$until[2].$until[3]?>"><?=$until[2].$until[3]?></option>
<option value="15">15</option>
<option value="30">30</option>
<option value="45">45</option>
<option value="00">00</option>
