  ...
  switch ($action) {
   ...
   $num_orders = 'no';
        ...
        $heading[] = array('text' => '<b>' . $vInfo->vendors_name . ' ' . $vInfo->vendors_contact . '</b>');
                ...
                $contents[] = array('align' => 'center', 'text' => '<a class="button" href="' . tep_href_link(FILENAME_VENDORS, tep_get_all_get_params(array('vendors_id', 'action')) . 'vendors_id=' . $vInfo->vendors_id . '&action=edit') . '">' .  IMAGE_EDIT . '</a> <a class="button" href="' . tep_href_link(FILENAME_VENDORS, tep_get_all_get_params(array('vendors_id', 'action')) . 'vendors_id=' . $vInfo->vendors_id . '&action=confirm') . '">' . IMAGE_DELETE . '</a><br><a class="button" href="' . tep_href_link(FILENAME_VENDOR_MODULES, 'set=shipping&vendors_id=' . $vInfo->vendors_id) . '">' .  IMAGE_MANAGE . '</a>&nbsp;<a class="button" href="' . tep_href_link(FILENAME_VENDORS, tep_get_all_get_params(array('vendors_id', 'action')) . 'action=new') . '">' . IMAGE_INSERT . '</a><br><a class="button" href="' . tep_href_link(FILENAME_ORDERS_VENDORS, '&vendors_id=' . $vInfo->vendors_id) . '">' .  IMAGE_ORDERS . '</a><br><br>There are <b>' . $num_orders . '</b> orders for this Vendor.<br>This Vendor has <b>' . $num_products . '</b> products.<br>Click <a href="' . tep_href_link(FILENAME_PRODS_VENDORS, '&vendors_id=' . $vInfo->vendors_id) . '"><b>here </b></a>for Products Report<br>Click <a href="' . tep_href_link(FILENAME_STATS_VENDORS, '&vID=' . $vInfo->vendors_id) . '"><b>here </b></a>for Vendor Sales Report<b>(Coming Soon)</b>');
