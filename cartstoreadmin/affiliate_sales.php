...
<?php 
  if ($_GET['acID'] > 0) {
?>
            <td class="pageHeading" align="right"><?php echo '<a class="button" href="' . tep_href_link(FILENAME_AFFILIATE_STATISTICS, tep_get_all_get_params(array('action'))) . '">' .  IMAGE_BACK . '</a>'; ?></td>
<?php
  } else {
?>
            <td class="pageHeading" align="right"><?php echo '<a class="button" href="' . tep_href_link(FILENAME_AFFILIATE_SUMMARY, '') . '">' .  IMAGE_BACK . '</a>'; ?></td>
<?php
  }
?>
          </tr>
