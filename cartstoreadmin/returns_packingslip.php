...
<table border="0" width="100%" cellspacing="0" cellpadding="2">
  ...
  <tr>
    <td><table border="0" cellspacing="0" cellpadding="2">
              <tr>
                 <td class="main" valign=top><b><? echo "Comments:"; ?></b></td><td class=main><?php echo nl2br($order->info['comments']); ?></td>
               </tr>
              <tr>
                <?php
				...
				?>
                <td class="main" width=25%><b><? echo "Status:"; ?></b></td><td width=65% class=main><?php echo $order_status['returns_status_name']; ?></td>
              </tr>
              <tr>
                <td class="main" width=25% valign=top><b><? echo "Refund Method:"; ?></b></td><td width=65% class=main><? echo $order->info['department']; ?></td>
              </tr>
