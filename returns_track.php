...
<div class="page-header">
            <h1><?php if ($_GET['action'] == 'returns_show') { echo TEXT_SUPPORT_STATUS . ': ' . $returns_status; } else { echo HEADING_TITLE; } ; ?></h1></div>
...
<p>' . TEXT_TRACK_DETAILS_2 . '</p>

<div class="form-group">
<label>' . TEXT_YOUR_RMA_NUMBER . '</label><input type="text" name="rma" value="" size="20" class="form-control"></div>

<input class="btn btn-default" type=submit name="submit" value="' . TEXT_FIND_RETURN . '">
...
<i class="fa fa-info-circle"></i> If you would like to start a new return please <a href="return_product.php">click here.</a>
