...
require (DIR_WS_BOXES . 'also_purchased_products_box.php');

$sts->restart_capture ( 'also_purchased_products_box', 'box' ); // Get information box



require (DIR_WS_MODULES . 'viewed_products.php');

$sts->restart_capture ( 'viewed_products', 'box' ); // Get information box
...
$sts->restart_capture ( 'cartbox2', 'box' ); // Get shopping cart box
...
$sts->restart_capture ( 'banner_rotator', 'box' ); // Get special box
