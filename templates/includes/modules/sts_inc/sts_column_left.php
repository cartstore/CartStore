...
include (DIR_WS_BOXES . 'most_popular.php');

$sts -> restart_capture('most_popular', 'box');
...
include (DIR_WS_MODULES . 'newsdesk_sticky.php');

$sts -> restart_capture('newsdeksticky', 'box');
