...
<span class="ourprice_name">Our Price:</span> <span class="our_price_price"><a href="login.php">Login for Price</a></span>';
                                  ...
                                  if ($new_products[$i]['products_url'] != "") {
                                      $newArea = '<a class="buy-it-now" href=' . $new_products[$x]['products_url'] . '" title="' . $new_products[$x]['products_name'] . '" >Partner Buy </a></div>';
                                  } //if ($new_products[$i]['products_url'] != "")
                                  ...
                                  elseif ($new_products[$x]['products_price'] > 0) {
                                      $newArea = ' <a class="buy-it-now" href="' . tep_href_link(basename($PHP_SELF), tep_get_all_get_params(array('action')) . 'action=buy_now&products_id=' . $new_products[$x]['products_id']) . '" title="Order/Purchase ' . $new_products[$x]['products_name'] . '">Add to Cart</a>';
                                  } //elseif ($new_products[$x]['products_price'] > 0)

                                  else {
                                      $newArea = '<a class="buy-it-now" href="' . tep_href_link(FILENAME_PRODUCT_INFO, 'products_id=' . $new_products[$x]['products_id']) . '">More Info</a>';
                                  } //else
                                  ...
                                  if ($new_products[$x]['products_price'] > 0) {
                                      $button = '<input class="buy-it-now" type="submit" value="Add to Cart" />';
                                  } //if ($new_products[$x]['products_price'] > 0)
	...
	<div class="product-box col-md-4 col-sm-4">
                  ...
                  <a class="" href="' . tep_href_link(FILENAME_PRODUCT_INFO, 'products_id=' . $new_products[$x]['products_id']) . '">' . tep_image(DIR_WS_IMAGES . $new_products[$x]['products_image'], $new_products[$x]['products_name'], SMALL_IMAGE_WIDTH, SMALL_IMAGE_HEIGHT) . '</a>        
								</div>
