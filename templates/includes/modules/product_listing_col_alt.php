    ...
    <div class="modal-content">
      ...
      <div class="modal-header">
		...
		<ul class="nav nav-pills pull-right">
    	  <li class="active">
    	    <a href="#title_price" data-toggle="pill">Title/Price</a>
    	  </li>
    	  <li><a href="#ymmodel" data-toggle="pill">Year Make Model</a></li>
     	</ul>
	  ...
	  <div class="modal-body">
       ...
       <div class="tab-content">
			  ...
			  <div class="tab-pane active" id="title_price">
              ...
              for ($col = 0, $n = sizeof($column_list); $col < $n; $col++) {
                  ...
                  switch ($column_list[$col]) {
                      case 'PRODUCT_LIST_MODEL':
                          $lc_align = '';
                          $lc_text = '<small>' . $listing[$x]['products_model'] . '</small>';
                          break;
                      ...
                      case 'PRODUCT_LIST_PRICE':
                          ...
                          if ($listing[$x]['map_price'] != 0.00 && !isset($_SESSION['customer_id'])){
                          	...
                          	$prod_price = '<a href="login.php"><i class="fa fa-lock"></i> Login for Price</a>';
                          }
                          break;
...
<span class="msrp_name">MSRP:</span> <span class="msrp_price">' . $currencies->display_price($listing[$x]['msrp_price'], tep_get_tax_rate($listing[$x]['products_tax_class_id'])) . '</span>';
              ...
              if ($listing[$x]['products_url'] != "" && $_SESSION['customers_email_address'] == '') {
                  $newArea = '<a class="btn btn-small" href="' . $listing[$x]['products_url'] . '" title="' . $listing[$x]['products_url'] . '"  >Partner Buy </a>';
              } elseif (HIDE_PRICE_NON_LOGGED == "true" && $_SESSION['customers_email_address'] == '') {
                  $newArea = '';
              } elseif ($listing[$x]['products_price'] > 0) {
                  $newArea = '
        <div class="form-group"> <input name="qty" type="text" class="form-control" value="1" size="5"/>
     </div> <p> <input class="btn btn-primary btn-small" type="submit" value="Cart"/></p>';
              } else {
                  $newArea = '';
              }
              if (HIDE_PRICE_NON_LOGGED == "true" && $_SESSION['customers_email_address'] == '') {
                  ...
                  $whats_new_price = '<a href="' . $urlContactUs . '"><i class="fa fa-envelope"></i> eMail for Price</a>';
              }
  ...
  <tr>
    ...
    <td><h3>' . $prod_name . '<br><small>' . $listing[$x]['products_model'] . '</small></h3>');
    ...
    print ('</td>
    <td><span class="text-success lead">' . $whats_new_price . '</span></td>
    <td>' . $newArea . '</td>
  </tr>
