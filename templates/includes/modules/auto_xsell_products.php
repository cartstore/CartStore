...
<span> ' . $extra_images['products_model'] . '</span>
...
<span>' . $extra_images['manufacturers_name'] . '</span>
                        ...
                        <a class="button" href="' . tep_href_link('index.php', 'products_id=' . $extra_images['products_id']) . '&action=buy_now">Add to Cart</a>
