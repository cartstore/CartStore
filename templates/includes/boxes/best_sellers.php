...
?>
<!-- best_sellers //-->
<div class="moduletable-green blog">
						<h3>Best Sellers</h3>
                                                <ul>
           <?php
      ...
      while ($best_sellers = tep_db_fetch_array($best_sellers_query)) {
          $rows++;
          $bestsellers_list .= '<li><a class="l3" href="' . tep_href_link(FILENAME_PRODUCT_INFO, 'products_id=' . $best_sellers['products_id']) . '">' . $best_sellers['products_name'] . '</a></li>';
      }
      $bestsellers_list .= '';
      $info_box_contents = array();
