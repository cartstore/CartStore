...
<?php
  ...
  function tep_make_cat_ullist2($rootcatid = 0, $maxlevel = 2)
  {
      ...
      if (count($table) > 0){
        $output .= '<ul class="nav navbar-nav"><li><a href="index.php">HOME</a></li>';
        $output .= tep_make_cat_ulbranch2($rootcatid, $table, 0, $maxlevel, $limitCat);
        for ($nest = 0; $nest <= $GLOBALS['this_level']; $nest++) {
          $output .= '<li><a href="services-a-1.html">SERVICES</a></li>
								<li><a href="company-a-2.html"> COMPANY</a></li></ul>';
       }
      }
      return $output;
  }
