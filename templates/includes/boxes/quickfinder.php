...
<div class="block-content">
      ...
      $info_box_contents = array();
      $info_box_contents[] = array('text' => '<form method="get" action="' . tep_href_link(FILENAME_DEFAULT, '', 'NONSSL', false) . '" name="manufacturers"> <div class="form-group">' . tep_draw_pull_down_menu('manufacturers_id', $manufacturers_array, (isset($_GET['manufacturers_id']) ? $_GET['manufacturers_id'] : ''), 'onChange="return getCategory();" ') . tep_hide_session_id());
