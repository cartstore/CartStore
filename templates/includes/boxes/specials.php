...
<div class="special-product">
          ...
          <a href="' . tep_href_link(FILENAME_PRODUCT_INFO, 'products_id=' . $random_product["products_id"]) . '">' . tep_image(DIR_WS_IMAGES . $random_product['products_image'], $random_product['products_name'], 114, SMALL_IMAGE_HEIGHT) . '</a>
          <h4><a href="' . tep_href_link(FILENAME_PRODUCT_INFO, 'products_id=' . $random_product['products_id']) . '">' . $random_product['products_name'] . '</a></h4>
<p>' . $random_product['products_short'] . '</p>
<div class="price">' . $currencies->display_price($random_product['products_price'], tep_get_tax_rate($random_product['products_tax_class_id'])) . '</div>
...
';
              if ($random_product['products_url'] != "") {
                  $newArea = '<a class="buy" href=' . $random_product['products_url'] . '" title="' . $random_product['products_url'] . '" >Partner Buy </a>';
...
<input class="btn buy" type="submit" value="Add to Cart" /></form>';
              } else {
                  $newArea = '<a class="buy" href="' . tep_href_link(FILENAME_PRODUCT_INFO, 'products_id=' . $random_product['products_id']) . '">Read More</a>';
              }
	...
	<div class="special-product">
<a class="" href="' . tep_href_link(FILENAME_PRODUCT_INFO, 'products_id=' . $random_product["products_id"]) . '">' . tep_image(DIR_WS_IMAGES . $random_product['products_image'], $random_product['products_name'], 80, SMALL_IMAGE_HEIGHT) . '</a>
