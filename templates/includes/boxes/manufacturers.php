				...
				<ul class="nav nav-pills nav-stacked">
					...
					if ($number_of_rows <= MAX_DISPLAY_MANUFACTURERS_IN_A_LIST) {
						...
						while ($manufacturers = tep_db_fetch_array($manufacturers_query)) {
							...
							$manufacturers_list .= '<li><a href="' . tep_href_link(FILENAME_DEFAULT, 'manufacturers_id=' . $manufacturers['manufacturers_id']) . '"><span>' . $manufacturers_name . '</span></a></li>';
						}//while ($manufacturers = tep_db_fetch_array($manufacturers_query))
				//		$manufacturers_list = substr($manufacturers_list, 0, -3);
