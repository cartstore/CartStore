<?php
	if (isset($_COOKIE['osCAdminID'])):
		...
		if ($is_admin && isset($_GET['reviews_id'])):
?>
        <!--[if lt IE 9]>
        ...
        <a data-target="#edit-review" data-toggle="modal"><i class="fa fa-pencil"></i></a>
        
<div id="edit-review" class="modal fade front-admin-editor" aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" style="display: none;">
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
                ...
                <iframe src="manage/reviews.php?page=1&rID=<?php echo (int)$_GET['reviews_id']; ?>&action=edit" style="position:absolute;top:0px;width:100%;height:100%;" frameborder="0" height="100%" width="100%" id="information-page-edit">
                </iframe>
            </div>
