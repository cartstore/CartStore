...
?>
        ...
        <style type="text/css">
           #edit-all-reviews.modal .modal-dialog {
                left: 20px;
                margin: 0;
                position: fixed;
                right: 20px;
           ...
           #edit-all-reviews.modal .modal-content {
                height: 100%;
                border-radius: 0;
            }
          #edit-all-reviews.modal .modal-body {
                min-height: 100%;
                padding:0px;

            }

           #edit-all-reviews.modal.fade.in {
        ...
        <a data-target="#edit-all-reviews" data-toggle="modal"><i class="fa fa-pencil"></i></a>
        
<div id="edit-all-reviews" class="modal fade front-admin-editor" aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" style="display: none;">
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
                ...
                <iframe src="manage/reviews.php" frameborder="0" style="position:absolute;top:0px;width:100%;height:100%;" id="information-page-edit">
                </iframe>
            </div>
