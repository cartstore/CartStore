...
?>
            ...
            <td width="30%" valign="top"><table border="0" width="100%" cellspacing="0" cellpadding="2"  class="table table-bordered">
...
?>
      ...
      <tr>
        ...
        <td class="main">    <hr><h3><?php echo HEADING_BILLING_INFORMATION; ?></h3></td>
          ...
          <tr class="infoBoxContents">
            ...
            <td width="30%" valign="top"><table border="0" width="100%" cellspacing="0" cellpadding="2">
              ...
              <tr>
                ...
                <td class="main"><br><b><?php echo HEADING_PAYMENT_METHOD; ?></b></td>
...
?>
              <tr>
                ...
                <td class="main" align="left"><a class="btn btn-default" target="_blank" href="http://trkcnfrm1.smi.usps.com/PTSInternetWeb/InterLabelInquiry.do?origTrackNum=<?php echo $order->info['usps_track_num']; ?>"><?php echo $order->info['usps_track_num']; ?></a></td>
                <td class="main" align="left"><a class="btn btn-default" target="_blank" href="http://trkcnfrm1.smi.usps.com/PTSInternetWeb/InterLabelInquiry.do?origTrackNum=<?php echo $order->info['usps_track_num']; ?>">Track</a></td>
			  </tr>
...
?>
              <tr>
                ...
                <td class="main" align="left"><a class="btn btn-default" target="_blank" href="http://trkcnfrm1.smi.usps.com/PTSInternetWeb/InterLabelInquiry.do?origTrackNum=<?php echo $order->info['usps_track_num']; ?>"><?php echo $order->info['usps_track_num2']; ?></a></td>
                <td class="main" align="left"><a class="btn btn-default" target="_blank" href="http://trkcnfrm1.smi.usps.com/PTSInternetWeb/InterLabelInquiry.do?origTrackNum=<?php echo $order->info['usps_track_num2']; ?>">Track</a></td>
              </tr>
<?php
}
...
?>
              <tr>
                ...
                <td class="main" align="left"><a class="btn btn-default" target="_blank" href="http://www.fedex.com/Tracking?tracknumbers=<?php echo $order->info['fedex_track_num']; ?>&action=track&language=english&cntry_code=us"><?php echo $order->info['fedex_track_num']; ?></a></td>
                <td class="main" align="left"><a class="btn btn-default" target="_blank" href="http://www.fedex.com/Tracking?tracknumbers=<?php echo $order->info['fedex_track_num']; ?>&action=track&language=english&cntry_code=us">Track</a></td>
			  </tr>
<?php
}
...
?>
              <tr>
                ...
                <td class="main" align="left"><a class="btn btn-default" target="_blank" href="http://www.fedex.com/Tracking?tracknumbers=<?php echo $order->info['fedex_track_num2']; ?>&action=track&language=english&cntry_code=us"><?php echo $order->info['fedex_track_num']; ?></a></td>
                <td class="main" align="left"><a class="btn btn-default" target="_blank" href="http://www.fedex.com/Tracking?tracknumbers=<?php echo $order->info['fedex_track_num2']; ?>&action=track&language=english&cntry_code=us">Track</a></td>
			  </tr>
<?php
}
...
?>
              <tr>
                ...
                <td class="main" align="left"><a class="btn btn-default" target="_blank" href="http://track.dhl-usa.com/atrknav.asp?ShipmentNumber=<?php echo $order->info['dhl_track_num']; ?>&action=track&language=english&cntry_code=us"><?php echo $order->info['dhl_track_num']; ?></a></td>
                <td class="main" align="left"><a class="btn btn-default" target="_blank" href="http://track.dhl-usa.com/atrknav.asp?ShipmentNumber=<?php echo $order->info['dhl_track_num']; ?>&action=track&language=english&cntry_code=us">Track</a></td>
			  </tr>
<?php
}
...
?>
              <tr>
                ...
                <td class="main" align="left"><a class="btn btn-default" target="_blank" href="http://track.dhl-usa.com/atrknav.asp?ShipmentNumber=<?php echo $order->info['dhl_track_num2']; ?>&action=track&language=english&cntry_code=us"><?php echo $order->info['dhl_track_num']; ?></a></td>
                <td class="main" align="left"><a class="btn btn-default" target="_blank" href="http://track.dhl-usa.com/atrknav.asp?ShipmentNumber=<?php echo $order->info['dhl_track_num2']; ?>&action=track&language=english&cntry_code=us">Track</a></td>
			  </tr>
<?php
}
?>
          ...
          <tr class="infoBoxContents">
            ...
            <td><table border="0" width="100%" cellspacing="0" cellpadding="2">
              ...
              <tr>
	            ...
	            <td class="main"><a class="btn button-default" href="javascript:history.go(-1)"><i class="fa fa-arrow-circle-left"></i> <?php echo ''. IMAGE_BUTTON_BACK.''; ?></a></td>
