...
<p><?php echo $messageStack -> output('account_edit'); ?></p>
...
<?php } ?>
                <div class="form-group">    <label> <?php echo ENTRY_FIRST_NAME; ?> *</label>
                  <?php echo tep_draw_input_field('firstname', $account['customers_firstname']) . '&nbsp;' . (tep_not_null(ENTRY_FIRST_NAME_TEXT) ? '' : ''); ?>
               </div>

                <div class="form-group">     <label><?php echo ENTRY_LAST_NAME; ?> *</label>
                
<?php echo tep_draw_input_field('lastname', $account['customers_lastname']) . '&nbsp;' . (tep_not_null(ENTRY_LAST_NAME_TEXT) ? '' : ''); ?>
                </div>
...
?>
              <div class="form-group">     <label><?php echo ENTRY_DATE_OF_BIRTH; ?></label>
                   <?php echo tep_draw_input_field('dob', tep_date_short($account['customers_dob'])) . '&nbsp;' . (tep_not_null(ENTRY_DATE_OF_BIRTH_TEXT) ? '' : ''); ?>
                
 </div>
<?php } ?>
             <div class="form-group">       <label><?php echo ENTRY_EMAIL_ADDRESS; ?> *</label>
               <?php echo tep_draw_input_field('email_address', $account['customers_email_address']) . '&nbsp;' . (tep_not_null(ENTRY_EMAIL_ADDRESS_TEXT) ? '' : ''); ?>
           </div>

             <div class="form-group">         <label><?php echo ENTRY_TELEPHONE_NUMBER; ?></label>
                    
<?php echo tep_draw_input_field('telephone', $account['customers_telephone']) . '&nbsp;' . (tep_not_null(ENTRY_TELEPHONE_NUMBER_TEXT) ? '' : ''); ?>
          </div>

             <div class="form-group">         <label><?php echo ENTRY_FAX_NUMBER; ?></label>
                   
<?php echo tep_draw_input_field('fax', $account['customers_fax']) . '&nbsp;' . (tep_not_null(ENTRY_FAX_NUMBER_TEXT) ? '' : ''); ?>
             </div>
