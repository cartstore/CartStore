...
<?php echo '<div class="form-group"><label>' . ENTRY_EMAIL_ADDRESS . '</label> <div class="input-group margin-bottom-sm"> <span class="input-group-addon"><i class="fa fa-envelope-o fa-fw"></i></span>' . tep_draw_input_field('email_address'); ?>
</div></div>
		

<p class="pull-right">  
<?php echo tep_image_submit('button_continue.gif', IMAGE_BUTTON_CONTINUE); ?></p>



<?php echo '<a "btn button-info" href="' . tep_href_link(FILENAME_LOGIN, '', 'SSL') . '"><i class="fa fa-arrow-circle-o-left"></i> ' . IMAGE_BUTTON_BACK . '</a>'; ?>
...
<i class="fa fa-info-circle"></i> Would you like to <a href="create_account.php">create a account</a>?
