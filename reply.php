...
//       echo "das: " . $customer_info['customers_email_address'] , "<br>";
  ...
  $last_title=tep_db_fetch_array($title_query);
   ...
   echo TEXT_MESSAGE . ': <TEXTAREA COLS=25 ROWS=10 name="m"></TEXTAREA><BR><input type="submit" class="btn btn-default"><INPUT TYPE=HIDDEN NAME="action" VALUE="postreply"></FORM>';
