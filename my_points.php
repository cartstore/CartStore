...
<!-- body_text //-->
 <table border="0" width="100%" cellspacing="0" cellpadding="0">
          ...
          <p class="lead"><?php echo MY_POINTS_HELP_LINK; ?></p>
...
<?php echo '<b>' . MY_POINTS_EXPIRE . '</b> ' . tep_date_short($points['customers_points_expires']); ?>

<?php
  } else {
         echo'<table class="table"><tr class="warning"><td>' . TEXT_NO_POINTS . '</td></tr></table>';
  }
?>
...
?>
         ...
         <p><?php echo $pending_points_split->display_count(TEXT_DISPLAY_NUMBER_OF_RECORDS); ?></p>
          <?php echo  '<ul class="pagination">' . $pending_points_split->display_links(MAX_DISPLAY_PAGE_LINKS, tep_get_all_get_params(array('page', 'info', 'x', 'y'))); ?></ul>
...
<div class="clear"></div>
		      ...
		      <a class="btn button-default" href="javascript:history.go(-1)">Back</a> 
        </td>
      </tr>
    </table> 
<!-- body_text_eof //-->
