...
getObject("states").innerHTML = '&nbsp;<img src="images/core/loading.gif" width="32px" hieght="32px">Please wait...';
...
jQuery(document).ready(function(){docInit();});
jQuery(document).bind('pageinit',function(){ docInit(); });

function docInit(){
	if (jQuery("#ajaxRecaptcha").length > 0){
	  Recaptcha.create("<?php echo RECAPTCHA_PUBLIC_KEY; ?>",
		"ajaxRecaptcha",{
			theme: "red"
		}
	...
	var validator = jQuery("form[name='create_account']").attr("validate",true).validate({
...
jQuery(document).ready(function($){
	$("a[rel='view-grid'], a[rel='view-list']").click(function(ev){
		$(this).addClass("active").siblings().removeClass("active");
		if ($(this).attr('rel') == 'view-list'){
			jQuery("div.productitem").removeClass("productitem-grid col-lg-3 col-md-3 col-sm-4 col-xs-12").addClass("productitem-list clear");
		} else {
			jQuery("div.productitem").removeClass("productitem-list clear").addClass("productitem-grid col-lg-3 col-md-3 col-sm-4 col-xs-12");
		}
                
                if ($(this).attr('rel') == 'view-list'){
			jQuery("div.media-image").removeClass("media-image col-lg-12 col-md-12 col-sm-12 col-xs-12").addClass("media-image col-lg-4 col-md-4 col-sm-4 col-xs-12");
		} else {
			jQuery("div.media-image").removeClass("media-image col-lg-4 col-md-4 col-sm-4 col-xs-12").addClass("media-image col-lg-12 col-md-12 col-sm-12 col-xs-12");
		}
                
                
                
                    if ($(this).attr('rel') == 'view-list'){
			jQuery("div.media-body").removeClass("media-body col-lg-12 col-md-12 col-sm-12 col-xs-12").addClass("media-body col-lg-8 col-md-8 col-sm-8 col-xs-12");
		} else {
			jQuery("div.media-body").removeClass("media-body col-lg-3 col-md-3 col-sm-3 col-xs-12").addClass("media-body col-lg-12 col-md-12 col-sm-12 col-xs-12");
		}
