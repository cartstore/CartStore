...
<?php if ($action == 'submited'){ ?>
 ...
 <tr><td align="center"><?php echo  tep_draw_form(add_link,tep_href_link('links.php',tep_get_all_get_params(array('action'))));?><INPUT class="btn btn-default" type=submit value="<?php echo 'BACK'?>"></FORM></td></tr>
 </table>
 <?php } else {
...
?>
        ...
        <P>
          <INPUT class="btn btn-default"  type=submit id="submit" value="<?php echo ADD;?>">
        </P>
      </FORM></td>
  </tr>
	<tr><td align="center"><br /><?php echo  tep_draw_form(add_link,tep_href_link('links.php',tep_get_all_get_params(array('action'))));?><INPUT class="btn btn-default" type=submit value="<?php echo 'BACK'?>"></FORM></td></tr>
	     <tr>
        <td><?php echo tep_draw_separator('pixel_trans.gif', '1', '10'); ?></td>
      </tr>
</table>
