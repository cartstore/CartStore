...
<base
	href="<?php
	echo (getenv ( 'HTTPS' ) == 'on' ? HTTPS_SERVER : HTTP_SERVER) . DIR_WS_CATALOG;
	?>">
...
<?php
	...
	echo tep_image_submit2 ( 'button_delete.gif', 'Delete From Wishlist', 'name="delete_prod"' );
	?>
    
     <?php
	echo tep_image_submit2 ( 'button_in_cart.gif', 'Add to Cart', 'name="add_prod" ' );
	?></div>
				<div class="clear"></div>
