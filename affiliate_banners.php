          ...
          <tr class="infoBoxContents">
            <td><table border="0" width="100%" cellspacing="0" cellpadding="2">
              <tr>
                ...
                <td width="60"><img src="images/account_orders.gif" border="0" alt="" width="60" height="60"></td>
                <td width="10"><img src="images/pixel_trans.gif" border="0" alt="" width="10" height="1"></td>
                <td><table border="0" width="100%" cellspacing="0" cellpadding="2">
                  <tr>
                    ...
                    <td width="200" class="main" align="left"><?php echo '<a class="button" href="' . tep_href_link(FILENAME_AFFILIATE_BANNERS_BANNERS, '', 'SSL') . '">' . IMAGE_BANNERS . '</a>';?></td>
                  </tr>
                  </table></td>
              ...
              <tr>
                ...
                <td><table border="0" width="100%" cellspacing="0" cellpadding="2">
                  <tr>
                    ...
                    <td width="200" class="main" align="left"><?php echo '<a class="button" href="' . tep_href_link(FILENAME_AFFILIATE_BANNERS_PRODUCT, '', 'SSL') . '">' .  IMAGE_PRODUCT . '</a>';?></td>
                  </tr>
                  </table></td>
               <td width="10" align="right"><img src="images/pixel_trans.gif" border="0" alt="" width="10" height="1"></td>
             </tr>
              ...
              <tr>
                ...
                <td><table border="0" width="100%" cellspacing="0" cellpadding="2">
                  <tr>
                    ...
                    <td width="200" class="main" align="left"><?php echo '<a class="button" href="' . tep_href_link(FILENAME_AFFILIATE_BANNERS_BUILD, '', 'SSL') . '">' . IMAGE_BUILD . '</a>';?></td>
                  </tr>
                  </table></td>
               <td width="10" align="right"><img src="images/pixel_trans.gif" border="0" alt="" width="10" height="1"></td>
             </tr>
              ...
              <tr>
                ...
                <td><table border="0" width="100%" cellspacing="0" cellpadding="2">
                  <tr>
                    ...
                    <td width="200" class="main" align="left"><?php echo '<a class="button" href="' . tep_href_link(FILENAME_AFFILIATE_BANNERS_TEXT, '', 'SSL') . '">' .  IMAGE_TEXT . '</a>';?></td>
                  </tr>
                  </table></td>
               <td width="10" align="right"><img src="images/pixel_trans.gif" border="0" alt="" width="10" height="1"></td>
             </tr>
