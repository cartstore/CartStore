...
?>
       ...
       <div class="page-header">    <h1>
            <?php
                 ...
                 include(DIR_WS_TEMPLATES . 'system/front-admin-editor/edit-information-article.php');
...
?>
          <?php
                      echo '<a class="btn btn-default" href="' . tep_href_link(FILENAME_ARTICLE_REVIEWS_WRITE, tep_get_all_get_params()) . '">' . IMAGE_BUTTON_WRITE_REVIEW . '</a>';
?>
          <?php
                      } else
                      {
...
?>
          <?php
                          echo '<a class="btn btn-default" href="' . tep_href_link(FILENAME_ARTICLE_REVIEWS, tep_get_all_get_params()) . '">' . IMAGE_BUTTON_REVIEWS . '</a>';
?>
          <?php
                      }
                  } //if ($reviews["s_52"] <= 0)
