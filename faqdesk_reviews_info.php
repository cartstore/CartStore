...
require(DIR_WS_LANGUAGES . $language . '/' . FILENAME_FAQDESK_REVIEWS_INFO);
...
<?php
tep_db_query("update " . TABLE_FAQDESK_REVIEWS . " set reviews_read = reviews_read+1 where reviews_id = '" . $_GET['reviews_id'] . "'");

$reviews = tep_db_query("select rd.reviews_text, r.reviews_rating, r.reviews_id, r.faqdesk_id, r.customers_name, r.date_added, r.last_modified, r.reviews_read from " . TABLE_FAQDESK_REVIEWS . " r, " . TABLE_FAQDESK_REVIEWS_DESCRIPTION . " rd where r.reviews_id = '" . $_GET['reviews_id'] . "' and r.reviews_id = rd.reviews_id");
