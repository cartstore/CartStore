		...
		<table class="table">
			<tr>
				...
				<tr class="active"> 
					...
					<td class="main" align="right"><?php echo '<a class="btn btn-success" href="' . tep_href_link(FILENAME_ACCOUNT_HISTORY_INFO, 'order_id=' . $orders['orders_id'], 'SSL') . '">' . SMALL_IMAGE_BUTTON_VIEW . '</a>'; ?></td>
				</tr>
