...
<ul class="pagination">
 ...
 <li  class="active"><?php echo '<a href="' . tep_href_link(FILENAME_CHECKOUT_SHIPPING, '', 'SSL') . '" class="ui-state-default  ui-tabs-selected ui-state-active ui-corner-all"><span class="">1. ' . CHECKOUT_BAR_DELIVERY . '</span></a></li>';?>
    <li><?php echo '<span class="">2.  ' . CHECKOUT_BAR_PAYMENT . '</span>';?></li>

	<li><span class="">3. <?php echo CHECKOUT_BAR_CONFIRMATION;?></span></li>

<li><span class="">4. <?php  echo CHECKOUT_BAR_FINISHED; ?></span></li>
  </ul>
...
<?php
  echo'
<a class="btn btn-default btn-xs" href="' . tep_href_link(FILENAME_CHECKOUT_SHIPPING_ADDRESS, '', 'SSL') . '"><span class="ui-icon ui-icon-gear" style="float:left"></span>Change Address</a>';
?>
...
?></td>-->
                      ...
                      <!-- PWA EOF -->
                      <td colspan="2"><?php
              echo '<span class="pull-right">' . TITLE_PLEASE_SELECT . '</b><br>' . tep_image(DIR_WS_IMAGES . 'arrow_east_south.gif');
?></span>
...
?></td>
                      <td class="main" align="right"><span class="pull-right"><?php
...
<ul class="pagination">
	    ...
	    <li class="active"><span><?php echo '<span>2.  ' . CHECKOUT_BAR_DELIVERY . '</span>';?></li>

    <li><span><?php echo '<span>2.  ' . CHECKOUT_BAR_PAYMENT . '</span>';?></li>

	<li> <span>3. <?php
                                                                 echo CHECKOUT_BAR_CONFIRMATION;?></span></li>
