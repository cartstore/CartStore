...
<div id="pageHeader">
  <div>
    ...
    <a href="index.php"><img src="images/logo.png" border="0" style="margin: 10px 10px 0px 10px;" /></a>
  </div>
</div>
...
<div id="pageFooter">
 <a href="../copyright.html" onclick="window.open(this.href, '', 'resizable=no,status=no,location=no,toolbar=no,menubar=no,fullscreen=no,scrollbars=yes,dependent=no,width=640,height=480'); return false;">Copyright &copy; 2011 CartStore</a>  </a></div>
