...
?></h1></div>
 ...
 <li  class="active"><a href="javascript:;" class="ui-state-default  ui-tabs-selected ui-state-active ui-corner-all"><span>3. <?php
...
<table  class="table table-striped">
  ...
  if ($sendto != false) {
?>
                <td width="30%" valign="top"><table  class="table">
                    <!-- <tr>
...
<?php echo '<b>' . HEADING_PRODUCTS . '</b> <a class="general_link" href="' . tep_href_link(FILENAME_SHOPPING_CART) . '"><span class="orderEdit">(' . TEXT_EDIT . ')</span></a>'; ?>
	<table border="0" width="100%" cellspacing="0" cellpadding="0">
      	<thead>
      		<th style="text-align:left"><?php echo TABLE_HEADING_QTY; ?></th>
      		<th><?php echo TABLE_HEADING_ITEM; ?></th>
      		<th style="text-align:left"><?php echo TABLE_HEADING_UNIT_PRICE; ?></th>
  			<?php if (sizeof($order->info['tax_groups']) > 1) { ?>
      			<th style="text-align:left"><?php echo TABLE_HEADING_TAX; ?></th>
      		<?php } ?>
...
<table>
	<?php
          echo '<p>' . HEADING_ORDER_COMMENTS . ' <a class="general_link" href="' . tep_href_link(FILENAME_CHECKOUT_PAYMENT, '', 'SSL') . '"><span class="orderEdit">(' . TEXT_EDIT . ')</span></a></p>';
?>
<?php
