                      ...
                      <table border="0" width="100%" cellspacing="1" cellpadding="2" class="infoBox">
                        <tr class="infoBoxContents">
                          <td>
                            <table border="0" width="100%" cellspacing="0" cellpadding="2">
                              <tr>
                                <td class="main"><?php echo '<a class="btn btn-default" href="' . tep_href_link(FILENAME_ARTICLE_INFO, tep_get_all_get_params()) . '">' .  IMAGE_BUTTON_BACK . '</a>'; ?></td>
                                <td class="main" align="right"><?php echo '<a class="btn btn-primary" href="' . tep_href_link(FILENAME_ARTICLE_REVIEWS_WRITE, tep_get_all_get_params()) . '">' . IMAGE_BUTTON_WRITE_REVIEW . '</a>'; ?></td>
                              </tr>
                            </table>
                          </td>
                        </tr>
