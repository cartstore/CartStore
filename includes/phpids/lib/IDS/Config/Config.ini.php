...
[General]
    ...
    html[]          = POST.articles_description.1
    
    
    
html[]          = POST.products_info_desc.1
html[]          = POST.products_info_desc 
html[]          = REQUEST.products_info_desc.1 
html[]          = REQUEST.products_info_desc 

exceptions[]          = REQUEST.enquiry 
