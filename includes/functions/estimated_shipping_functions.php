...
function tep_get_estimated_shipping_quotes($country, $getvar, $customer_country) {
	...
	$return .= '<table class="table"><th align="left" colspan="2"><h3>' . TABLE_HEADING_SHIPPING_METHOD . $country_name . '</h3></th>';
	...
	if(isset($_POST['estzipcode']) && $_POST['estzipcode']!=""){
			...
			$return .= '<tr width="100%"><td class="active" align="left" colspan="2" nowrap><h4>' . $quotes[$i]['module'] . '</h4></td></tr>';
