...
define('defualtcatimage', 'default.gif');
  ...
  define('FILENAME_CONTACT_US', 'contact_us.php');
    define('FILENAME_EMAIL_FOR_PRICE', 'email_for_price.php');
...
//define('FILENAME_FAQDESK_SEARCH', 'faqdesk_search.php');
  ...
  define('FILENAME_FAQDESK', DIR_WS_INCLUDES . 'modules/faqdesk/faqdesk.php');
  define('FILENAME_FAQDESK_LISTING', DIR_WS_INCLUDES . 'modules/faqdesk/faqdesk_listing.php');
  ...
  define('FILENAME_FAQDESK_STICKY', DIR_WS_INCLUDES . 'modules/faqdesk/faqdesk_sticky.php');
...
// Wholesale Inquiries
define('FILENAME_WHOLESALE', 'wholesale.php');
// Wholesale Inquiries
...
define('FILENAME_ASK_QUESTION2', 'ask_a_question2.php');
...
define('FILENAME_MANUFACTURERS', 'allmanufacturers.php');
//END allmanufacturers modification
//Begin RSS news
  define('FILENAME_LAST_RSS', 'lastRSS.php');
  define('FILENAME_RSS_NEWS', 'rss_news.php');
    define('FILENAME_LAST_RSS2', 'lastRSS2.php');
  define('FILENAME_RSS_NEWS2', 'rss_news2.php');
//End RSS news
  //DELIVERY MODULE - START
  define('FILENAME_CHECK_AVAILABILITY', 'availability.php');
//DELIVERY MODULE - END
