...
define('BOX_HEADING_CATEGORIES', 'Candy Making Supplies');
...
define('ENTRY_CITY', 'Town/City/County:');
...
define('HEADER_TITLE_AVAILABILITY', 'Availability Calendar');
//DELIVERY MODULE - END
...
define('TEXT_GREETING_PERSONAL', 'Welcome back <span class="greetUser">%s!</span> Would you like to see which <a class="general_link" href="%s"><u>new products</u></a> are available to purchase?');
define('TEXT_GREETING_PERSONAL_RELOGON', '<small>If you are not %s, please <a class="general_link" href="%s"><u>log yourself in</u></a> with your account information.</small>');
...
define('REVIEW_HELP_LINK', ' Write a Review and earn <b>' .  $currencies->format(USE_POINTS_FOR_REVIEWS * REDEEM_POINT_VALUE) . '</b> worth of points.<br />Please check the <a class="general_link" href="' . tep_href_link(FILENAME_MY_POINTS_HELP,'faq_item=13', 'NONSSL') . '" title="Reward Point Program FAQ"><u>Reward</u></a> Point Program FAQ for more information.');
#### Points/Rewards Module V2.00 EOF ####

define('FOOTER_TEXT_BODY', 'Copyright &copy; ' . date('Y') . ' <a class="general_link" href="' . tep_href_link(FILENAME_DEFAULT) . '">' . STORE_NAME . '</a><br>Powered by <a class="general_link" href="http://www.cartstore.com" target="_blank">CartStore</a>');
...
define('TABLE_HEADING_ESTIMATED_SHIPPING', 'Shipping Cost For Your Shopping Cart');
...
//BEGIN allmanufacturers modification
define('BOX_INFORMATION_ALLMANUFACTURERS', 'View All Manufacturers');
//END allmanufacturers modification
...
define('ENTRY_STREET_ADDRESS_2', 'Address Line 2:');
