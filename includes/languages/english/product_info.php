...
define('TABLE_HEADING_FAMILY_PRODUCTS', 'Family Products');
//Family: End Changed code
define('TEXT_XSELL_PRODUCTS', 'We Also Recommend :');

//WISHLIST ADDITION
define('PRODUCT_ADDED_TO_WISHLIST', '<span class="success"><center>Product has been successfully added to your wishlist</center></span>');
