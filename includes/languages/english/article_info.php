...
define('TEXT_DATE_ADDED', 'Published on %s.');
define('TEXT_DATE_AVAILABLE', '<font color="#FF0000">Will be published on %s.</font>');
define('TEXT_BY', 'by ');
define('TEXT_CURRENT_REVIEWS', 'Current Reviews:');
define('BOX_TEXT_TELL_A_FRIEND', 'Tell a friend'); 
define('TEXT_TELL_A_FRIEND', 'Tell a friend about this article:');
define('TEXT_XSELL_ARTICLES', 'Related Products:');
