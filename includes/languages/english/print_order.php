<?php
/*
  $Id: print_order.php,v 1.17 2003/06/05 15:43:49 dgw_ Exp $
...
define('HEADING_TITLE', 'Customer Receipt');
...
define('PRINT_ORDER_HEADER_TEXT', '<u>Print Order</u>');
define('PRINT_ORDER_FOOTER_TEXT', 'Thank You For Your Order');
