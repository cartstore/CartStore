...
/*
  ...
  Edited by VK 05.11.05
*/
define('MODULE_SHIPPING_FREEAMOUNT_TEXT_UNIT', ' lbs ');
define('MODULE_SHIPPING_FREEAMOUNT_TEXT_TITLE', 'Free Shipping (USA Only)');
...
define('MODULE_SHIPPING_FREEAMOUNT_TEXT_ERROR', 'Free shipping only for an order of $' . MODULE_SHIPPING_FREEAMOUNT_AMOUNT . ' or more.'  . MODULE_SHIPPING_FREEAMOUNT_WEIGHT_MAX . ' ' . MODULE_SHIPPING_FREEAMOUNT_TEXT_UNIT);
