...
*/
  ...
  define('CATEGORY_ANTIROBOTREG', '<font color="#993300">Validation Code</font>');

  define('ENTRY_ANTIROBOTREG', 'We use visual verification to ensure that you are <br />a real person and not a robot.<BR><small><font color="#993300"><i><b>This help prevent automated registrations.</b></i></font></small>');
  define('ENTRY_ANTIROBOTREG_TEXT', '&nbsp;<small><font color="#993300"> <b><-- Enter the letters as shown above.</b></font></small>');
