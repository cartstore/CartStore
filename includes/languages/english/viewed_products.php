...
define('TEXT_HIST_EXPL2',' products you have viewed. This is to enable you to go back and re-visit those products at your convenience.');
// start user switch //
define('TEXT_VIEWED_NOT_AGAIN', 'Do not display again');
// end user switch //
?>