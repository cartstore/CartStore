<?php
  ...
  define('HTTP_COOKIE_PATH', '/dev.cartstore.com/');
  define('HTTPS_COOKIE_PATH', '/dev.cartstore.com/');
  define('DIR_WS_HTTP_CATALOG', '/dev.cartstore.com/');
  define('DIR_WS_HTTPS_CATALOG', '/dev.cartstore.com/');
