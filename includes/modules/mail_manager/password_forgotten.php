...
// define subject
$output_subject = EMAIL_PASSWORD_REMINDER_SUBJECT;
...
$newpwandmsg = sprintf(EMAIL_PASSWORD_REMINDER_BODY, $new_password);
...
$values=array(HTTP_CATALOG_SERVER,STORE_NAME,STORE_OWNER_EMAIL_ADDRESS, $firstname,$lastname, $email_address, EMAIL_PASSWORD_REMINDER_SUBJECT, $newpwandmsg);
