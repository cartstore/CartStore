...
<?php
    if ($is_read_only == true) {
      ...
      if ($entry_suburb_error == true) {
        echo tep_draw_input_field('a_suburb') . '' ;
      } else {
        echo $a_suburb . tep_draw_hidden_field('a_suburb');
      }
    } else {
      echo tep_draw_input_field('a_suburb', $affiliate['affiliate_suburb']) . '' ;
    }
?>
            </div>
<?php
...
<?php
  if ($is_read_only == true) {
    ...
    echo tep_draw_input_field('a_homepage', $affiliate['affiliate_homepage']) . '';
  }
?>
            </div>
<?php
