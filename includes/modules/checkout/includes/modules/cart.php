...
?>
 <tr>
  ...
  <td class="main" valign="top"><?php
   echo tep_draw_input_field('qty[' . $order->products[$i]['id'] . ']', $order->products[$i]['qty'], 'size="3" onkeyup="jQuery(\'input[name^=qty]\').attr(\'readonly\', true); jQuery(\'#updateCartButton\').trigger(\'click\')"');
  ?></td>
  ...
  ?></td>
  <td class="main" align="right" valign="top"><a href="Javascript:void();" linkData="action=removeProduct&pID=<?php echo $order->products[$i]['id'];?>" class="removeFromCart"><i class="fa fa-times-circle fa-1x"></i></a></td>
 </tr>
<?php
 }
?>
