...
var checkout = {
	...
	showAjaxLoader: function ()
		{
		jQuery('#ajaxMessages').dialog('open');
		jQuery('#ajaxLoader').show();
		},
	hideAjaxLoader: function ()
		{
		jQuery('#ajaxLoader').hide();
		jQuery('#ajaxMessages').dialog('close');
		},
	showAjaxMessage: function (message){
			jQuery('#checkoutButtonContainer').hide();
		jQuery('#ajaxMessages').show().html('<center>Loading....<br><img src="includes/modules/checkout/images/ajax_load.gif"><br>' + message + '</center>');
	},
	hideAjaxMessage: function (){
		jQuery('#checkoutButtonContainer').show();
		jQuery('#ajaxMessages').hide();
	...
	setPaymentMethod: function ($button){
		...
		this.setModuleMethod('payment', $button.val(), function (data){
			...
			if (data.inputFields != ''){
				jQuery(data.inputFields).insertAfter($button.parent().parent());
