...
?>
	...
	<tr>
		...
		<td class="main"><?php echo tep_draw_input_field('shipping_street_address_2', $shippingAddress['street_address_2'], ' style="width:80%;float:left;"'); ?></td>
	</tr>
<?php
...
?>
	...
	<tr>
		<td class="main" colspan="2" align="right"><?php echo '<span class="btn btn-primary btn-sm" id="updateAddressShipping">Update</span>';?></td>
	</tr>
</table>
<?php
	}
