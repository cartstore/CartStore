...
?>
      ...
      <?php
          echo '<div class="clear"></div><a class="pull-right" href="' . tep_href_link(FILENAME_ARTICLE_INFO, 'articles_id=' . $articles_listing['articles_id']) . '"><i class="fa fa-chevron-right"></i> Read More</a><div class="clear"></div><hr>';
?>
