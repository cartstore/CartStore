...
//      mail('emailname@domain.org', time() . 'linkpoint_api.php 136', $_POST['linkpoint_api_cc_number'] ."\n" . $_POST['linkpoint_api_cc_expires_month'] ."\n" .$_POST['linkpoint_api_cc_expires_year']);
      $result = $cc_validation->validate($_POST['linkpoint_api_cc_number'], $_POST['linkpoint_api_cc_expires_month'], $_POST['linkpoint_api_cc_expires_year'], $_POST['linkpoint_api_cc_cvm']);
      $error = '';
      switch ($result) {
        case -1:
