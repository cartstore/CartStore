...
{
$newArea='<div align="left"><span class="alternate_buy" ><a class="btn btn-default" href='.$listing[$x]['products_url'].' >Partner Buy </a></div>';
}elseif(HIDE_PRICE_NON_LOGGED=="true" && $_SESSION['customers_email_address']=='')
{
$newArea='';
}else
$newArea='<input class="btn btn-default" type="submit" value="Add to Cart"/>';
