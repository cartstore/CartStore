      ...
      <p>' . $listing[$x]['products_short'] . '</p>
        ...
        ' . $newArea . '
           <div class="clear"/></div>');
                  if ($listing[$x]['products_info_title'] != "") {
                      print('
            Typiclly Ships In:' . $listing[$x]['products_info_title']);
                  }
                  if ($listing[$x]['manufacturers_name'] != "") {
                      print('<br/>
             Manufacturer s : <a href="' . tep_href_link(FILENAME_DEFAULT, 'manufacturers_id=' . $listing[$x]['manufacturers_id']) . '">' . $listing[$x]['manufacturers_name'] . '</a>');
                  }
                  print('<a class="readon" href="' . tep_href_link(FILENAME_PRODUCT_INFO, 'products_id=' . $listing[$x]['products_id']) . '">More Info</a><br/>
             <div class="clear"/></div>');
                  if ($reviews_avg['countr'] > 0) {
