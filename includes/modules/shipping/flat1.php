...
// class constructor
    function flat1() {
      ...
      if ( ($this->enabled == true) && ((int)MODULE_SHIPPING_FLAT1_ZONE > 0) ) {
        ...
        $check_query = tep_db_query("select zone_id from " . TABLE_ZONES_TO_GEO_ZONES . " where geo_zone_id = '" . MODULE_SHIPPING_FLAT1_ZONE . "' and zone_country_id = '" . $zoneRow['entry_country_id'] . "' order by zone_id");
...
// class methods
    ...
    function install() {
      tep_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) values ('Enable Flat Shipping', 'MODULE_SHIPPING_FLAT1_STATUS', 'True', 'Do you want to offer flat1 rate shipping?', '6', '0', 'tep_cfg_select_option(array(\'True\', \'False\'), ', now())");
	  ...
	  tep_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('Flat Rate Title Text', 'MODULE_SHIPPING_FLAT1_TEXT_TITLE', 'Flat Rate 1', 'The title of the module', '6', '0', now())");
    }
    ...
    function keys() {
      return array('MODULE_SHIPPING_FLAT1_STATUS', 'MODULE_SHIPPING_FLAT1_TAX_CLASS', 'MODULE_SHIPPING_FLAT1_SORT_ORDER', 'MODULE_SHIPPING_FLAT1_ZONE', 'MODULE_SHIPPING_FLAT1_TEXT_TITLE', 'MODULE_SHIPPING_FLAT1_COST');
    }
  }
?>