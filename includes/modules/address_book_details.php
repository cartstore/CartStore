...
?>
          ...
          <tr>
            ...
            <td class="main"><?php echo tep_draw_input_field('street_address_2', $entry['entry_street_address_2']) . '&nbsp;' . (tep_not_null(ENTRY_STREET_ADDRESS_TEXT_2) ? '<span class="inputRequirement">' . ENTRY_STREET_ADDRESS_TEXT_2 . '</span>': ''); ?></td>
          </tr>
<?php
