...
<h1> <?php 
          include(DIR_WS_TEMPLATES . '/system/front-admin-editor/edit-all-blog-articles-categories.php');
          
          echo 'Blog ';



echo $categories['categories_name']; ?></h1>
...
<p><?php echo $listing_split->display_count(TEXT_DISPLAY_NUMBER_OF_ARTICLES); ?></p>

<ul class="pagination pagination-centered"><?php echo '' . $listing_split->display_links(MAX_DISPLAY_NEWSDESK_PAGE_LINKS, tep_get_all_get_params(array('page', 'info', 'x', 'y'))); ?></ul>
