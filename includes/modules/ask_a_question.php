...
*/
  ...
  if (isset($_GET['action']) && ($_GET['action'] == 'process')) {
    ...
    if ($error == false) {
      ...
      tep_redirect(tep_href_link(FILENAME_ASK_GUESTION, 'action=success'));
    }
...
<!-- body_text //-->
    <td width="100%" valign="top"><?php echo tep_draw_form('email_friend', tep_href_link(FILENAME_ASK_QUESTION, 'action=process&products_id=' . $_GET['products_id'])); ?>
