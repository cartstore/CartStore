...
<ul class="pager">
	...
	?>
	<?php echo '<li class="previous"><a class="" href="' . tep_href_link(FILENAME_PRODUCT_INFO, "$fPath&products_id=$previous") . '">&larr; Prev</a></li>';?>
	...
	*
	...
	?>
        <span class="hidden-xs"><?php echo PREV_NEXT_PRODUCT . $position . PREV_NEXT_OF . $counter;?></span>
	<?php
	if ($last != (int)$_GET['products_id']) {
	?>
	<?php echo '<li class="next"><a class="" href="' . tep_href_link(FILENAME_PRODUCT_INFO, "$fPath&products_id=$next_item") . '">Next &rarr;</a></li>';?>
	<?php
	} else {
	?>
	*
