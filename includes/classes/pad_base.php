              ...
              foreach ($attributes as $stocked) {
                  switch ($stocked['otype']) {
                      case PRODUCTS_OPTIONS_TYPE_TEXT:
                          $tmp_html = '<input type="text" name ="id[' . TEXT_PREFIX . $stocked['oid'] . ']" size="' . $stocked['olength'] . '" maxlength="' . $stocked['olength'] . '" value="' . $cart->contents[$_GET['products_id']]['attributes_values'][$stocked['oid']] . '" class="form-control">  ' . $stocked['ocomment'];
                          $out .= ' <label>' . $stocked['oname'] . ' ' . $tmp_html . '</label>';
                          break;
                      case PRODUCTS_OPTIONS_TYPE_CALENDER:
                          $tmp_html = '
<input id="datepicker" type="text" name ="id[' . TEXT_PREFIX . $stocked['oid'] . ']" size="' . $stocked['olength'] . '" maxlength="' . $stocked['olength'] . '" value="' . $cart->contents[$_GET['products_id']]['attributes_values'][$stocked['oid']] . '" class="form-control" />  ' . $stocked['ocomment'];
                          $out .= ' <label>' . $stocked['oname'] . " " . $tmp_html . "</label>";
                          break;
                   ...
                   rows=5 
                   value="' . $cart->contents[$_GET['products_id']]['attributes_values'][$stocked['oid']] . '" class="form-control"></textarea>';
                          $out .= ' <label>' . $stocked['oname'] . " " . $tmp_html . "</label>";
                          break;
      ...
      function _draw_nonstocked_attributes()
      {
          ...
          foreach ($nonstocked_attributes as $nonstocked) {
              switch ($nonstocked['otype']) {
                  case PRODUCTS_OPTIONS_TYPE_TEXT:
                      $tmp_html = '<input type="text" name ="id[' . TEXT_PREFIX . $nonstocked['oid'] . ']" size="' . $nonstocked['olength'] . '" maxlength="' . $nonstocked['olength'] . '" value="' . $cart->contents[$_GET['products_id']]['attributes_values'][$nonstocked['oid']] . '" class="form-control">  ' . $nonstocked['ocomment'];
                      $out .= ' <label>' . $nonstocked['oname'] . str_replace('TEXT', '', $nonstocked['ovals']['0']['text']) . " </label>" . $tmp_html . "";
                      break;
                  case PRODUCTS_OPTIONS_TYPE_CALENDER:
                      $tmp_html = '<input type="text" name ="id[' . TEXT_PREFIX . $stocked['oid'] . ']" size="' . $stocked['olength'] . '" maxlength="' . $stocked['olength'] . '" value="' . $cart->contents[$_GET['products_id']]['attributes_values'][$stocked['oid']] . '" class="form-control" id="datepicker" />' . $stocked['ocomment'];
                      $out .= ' <label>' . $nonstocked['oname'] . ' ' . $tmp_html . '</label>';
                      break;
                  case PRODUCTS_OPTIONS_TYPE_TEXTAREA:
                      $tmp_html = '<textarea wrap="soft" 
                   name="id[' . TEXT_PREFIX . $nonstocked['oid'] . ']" 
                   rows=5 
                   value="' . $cart->contents[$_GET['products_id']]['attributes_values'][$nonstocked['oid']] . '" class="form-control"></textarea>';
                      $out .= ' <label>' . $nonstocked['oname'] . " " . $tmp_html . "</label></div>\n";
                      break;
                  case PRODUCTS_OPTIONS_TYPE_RADIO:
                      $tmp_html = '';
                      $checked = true;
                  ...
                  case PRODUCTS_OPTIONS_TYPE_FILE:
                      $number_of_uploads++;
                      $out .= ' <label>' . $nonstocked['oname'] . '</label><input class="form-control" type="file" name="id[' . TEXT_PREFIX . $nonstocked['oid'] . ']">' . $cart->contents[$_GET['products_id']]['attributes_values'][$nonstocked['oid']] . tep_draw_hidden_field(UPLOAD_PREFIX . $number_of_uploads, $nonstocked['oid']) . tep_draw_hidden_field('number_of_uploads', $number_of_uploads) . "\n";
