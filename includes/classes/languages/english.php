...
define('WARNING_INSTALL_DIRECTORY_EXISTS', '<div id="dialog-message" title="Warning">Warning: Installation directory exists at: ' . dirname($_SERVER['SCRIPT_FILENAME']) . '/install. Please remove this directory for security reasons.</div>');
...
define('REVIEW_HELP_LINK', ' Write a Review and earn <b>' .  $currencies->format(USE_POINTS_FOR_REVIEWS * REDEEM_POINT_VALUE) . '</b> worth of points.<br />Please check the <a href="' . tep_href_link(FILENAME_MY_POINTS_HELP,'faq_item=13', 'NONSSL') . '" title="Reward Point Program FAQ"><u>Reward</u></a> Point Program FAQ for more information.');
#### Points/Rewards Module V2.00 EOF ####

define('FOOTER_TEXT_BODY', 'Copyright &copy; ' . date('Y') . ' <a href="' . tep_href_link(FILENAME_DEFAULT) . '">' . STORE_NAME . '</a><br>Powered by <a href="http://www.cartstore.com" target="_blank">CartStore</a>');
