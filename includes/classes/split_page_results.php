...
// previous button - not displayed on first page
      ...
      if ($this->current_page_number > 1) $display_links_string .= '<li class="last"><a href="' . tep_href_link(basename($PHP_SELF), $parameters . $this->page_name . '=' . ($this->current_page_number - 1), $request_type) . '" class="ui-state-default ui-corner-all" title=" ' . PREVNEXT_TITLE_PREVIOUS_PAGE . ' "><span>' . PREVNEXT_BUTTON_PREV . '</span></a></li>';
