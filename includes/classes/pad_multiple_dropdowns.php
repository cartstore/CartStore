    ...
    function _draw_stocked_attributes() {
      ...
      if (sizeof($attributes)>0) {
        for($o=0; $o<sizeof($attributes); $o++) {
          ...
          $out.='<label>'.$attributes[$o]['oname']." </label>".tep_draw_pull_down_menu('id['.$attributes[$o]['oid'].']',array_values($attributes[$o]['ovals']),$attributes[$o]['default'], "onchange=\"stkmsg(this.form);\"")."<br />
\n";
        }        
