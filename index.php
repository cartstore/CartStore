...
$category = tep_db_fetch_array($category_query);
		?>
		<?php
		echo '<div class="page-header"><h1 class="cat_listing">';

               include(DIR_WS_TEMPLATES . '/system/front-admin-editor/edit-store-category.php');

		print($category['categories_name']);
		echo ' </h1></div>';
		?>

 <ul class="breadcrumb clear" itemscope itemtype="http://data-vocabulary.org/Breadcrumb">
			<li itemscope  itemtype="http://data-vocabulary.org/Breadcrumb"><a class="linkup" href="index.php" itemprop="url"><span itemprop="title">Home</span></a> </li> <?php
			echo $breadcrumb -> trail(' >> ');
			?>
</ul>
 <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 category-listing-description">
         <span class="col-lg-4 col-md-4 col-sm-4 col-xs-4 pull-right" style="align:right;">
    <?php
...
<div class="clear"></div>
    ...
    <ul class="media-list category-listing">
    <li class="media">
    <a class="pull-left" href="' . tep_href_link(FILENAME_DEFAULT, $cPath_new) . '">
    ' . tep_image(DIR_WS_IMAGES . $categories['categories_image'], $categories['categories_name'], SUBCATEGORY_IMAGE_WIDTH, SUBCATEGORY_IMAGE_HEIGHT) . '
    </a>
    <div class="media-body">
    <h3 class="media-heading">
<a href="' . tep_href_link(FILENAME_DEFAULT, $cPath_new) . '">' . $categories['categories_name'] . ' </a></h3>
  ...
  ';
				...
				while ($categories12 = tep_db_fetch_array($categories_query12)) {
					if (tep_count_products_in_category((int)$categories12['categories_id']) > 0 || tep_has_category_subcategories($categories12['categories_id']))
						...
						print('
										          <li class="">
												   <a href="' . tep_href_link(FILENAME_DEFAULT, tep_get_path($categories12['categories_id'])) . '"> <i class="fa fa-angle-double-right"></i> ' . $categories12['categories_name'] . '  </a>
												  </li>
...
include(DIR_WS_TEMPLATES . 'listing_sort_order_conf.php');
	...
	?>
		...
		</table><div class="page-header"><h1 class="product_listing">

                              <?php     include(DIR_WS_TEMPLATES . '/system/front-admin-editor/edit-store-category.php'); ?>
		...
		?></h1></div>
			...
			<li><a class="linkup" href="index.php">Home</a> </li><?php
		echo $breadcrumb -> trail('');
                ?></ul>

                               <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">

                                        <span class="category-image col-lg-3 col-md-3 col-sm-3 col-xs-3 pull-right" style="align:right;">
...
<!-- AddThis Smart Layers END -->
		...
		?><div class="clear"></div>
 <ul class="breadcrumb clear home">
			<li><a class="linkup" href="index.php">Home</a> </li> <?php
			echo $breadcrumb -> trail(' >> ');
			?>
</ul>
		<?php
			if (IS_MOBILE_DEVICE == TRUE)
				require (DIR_FS_CATALOG . 'templates/includes/sts_templates/'. MODULE_STS_TEMPLATE_FOLDER .'/index_body_mobile.php');
			else
				require (DIR_FS_CATALOG . 'templates/includes/sts_templates/'. MODULE_STS_TEMPLATE_FOLDER .'/index_body.php');
		?>
