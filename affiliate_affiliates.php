...
?>
      ...
      <tr>
       ...
       <tr>
        <td align="right" class="main"><?php echo tep_image_submit('button_update.gif', IMAGE_UPDATE) . ' <a class="btn btn-default" href="' . tep_href_link(FILENAME_AFFILIATE, tep_get_all_get_params(array('action'))) .'">' . IMAGE_CANCEL . '</a>';?></td>
      </tr></form>
<?php
  } else {
?>
          ...
          ?>			
			<td valign="top"><table border="0" width="100%" cellspacing="0" cellpadding="2">
              <tr class="dataTableHeadingRow">			  
                <td class="dataTableHeadingContent"><a href="<?php echo "$PHP_SELF?listing=id-asc"; ?>"><?php echo tep_image(DIR_WS_IMAGES . 'arrow_up.png', 'Ascending'); ?></a>&nbsp;<?php echo TABLE_HEADING_AFFILIATE_ID; ?>&nbsp;<a href="<?php echo "$PHP_SELF?listing=id-desc"; ?>"><?php echo tep_image(DIR_WS_IMAGES . 'arrow_down.png', 'Descending'); ?></a>			
...
?>
                  <tr>
                    <td align="right" colspan="2"><?php echo '<a class="btn btn-default" href="' . tep_href_link(FILENAME_AFFILIATE) . '">' .  IMAGE_RESET . '</a>'; ?></td>
                  </tr>
<?php
    }
?>
...
<?php
  ...
  switch ($_GET['action']) {
    case 'confirm':
      ...
      $contents[] = array('align' => 'center', 'text' => '<br>' . tep_image_submit('button_delete.gif', IMAGE_DELETE) . ' <a class="btn btn-default" href="' . tep_href_link(FILENAME_AFFILIATE, tep_get_all_get_params(array('acID', 'action')) . 'acID=' . $aInfo->affiliate_id) . '">' . IMAGE_CANCEL . '</a>');
      break;
    default:
      if (is_object($aInfo)) {
