...
?>
        ...
        <ul class="pagination">
          <li>
            <?php
  echo '<span><a href="' . tep_href_link(FILENAME_CHECKOUT_SHIPPING, '', 'SSL') . '" class="ui-state-default ui-corner-all"><span>1. ' . CHECKOUT_BAR_DELIVERY . '</span></a></li>';
?>
...
?>
      <table class="table">
      	<thead>
      		...
      		<th style="text-align:left"><?php echo TABLE_HEADING_UNIT_PRICE; ?></th>
      		<th style="text-align:left"><?php echo TABLE_HEADING_ITEM_PRICE; ?></th>
      	</thead>
      	<tbody>
        <?php
...
?>        </address> 
        	...
        	<td>  <?php
  echo '<a class="btn btn-default btn-xs-" href="' . tep_href_link(FILENAME_CHECKOUT_PAYMENT_ADDRESS, '', 'SSL') . '"><span class="ui-icon ui-icon-gear" style="float:left";></span>Change Address</a>';
?></td>
        </tr>
        	</table>
...
?>
          <div class="payment_module_outputXXXX" style="display: block;padding:15px;" id="<?php
              echo $selection[$i]['id'];
?>">
            <?php
