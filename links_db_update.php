...
*/
  ...
  tep_db_query("DELETE FROM configuration WHERE configuration_group_id= '" . $cgID['configuration_group_id']. "'")  or die(tep_db_error()); 
...
?>
      ...
      <tr>
        <td><?php echo '<a class="btn btn-default" href="' . tep_href_link(FILENAME_DEFAULT) . '">' . IMAGE_BUTTON_CONTINUE . '</a>'; ?></td>
      </tr>
    </table></td>
<!-- body_text_eof //-->
  </tr>
