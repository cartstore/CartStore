...
<input type="text" name="email_address" class="form-control" />
 ...
 <div class="form-group">
<label><?php echo ENTRY_PASSWORD; ?></label><div class="input-group margin-bottom-sm">
...
?>
    ...
    <ul class="ui-login">
<li><span class="ui-icon ui-icon-home" style="float:left;margin-right:5px;"></span><a href="<?php echo '' . tep_href_link ( FILENAME_CREATE_ACCOUNT, '', 'SSL' ); ?> ">Create Account</a></li>
<li><span class="ui-icon ui-icon-check" style="float:left;margin-right:5px;"></span><?php echo ' <a href="' . tep_href_link ( FILENAME_PASSWORD_FORGOTTEN, '', 'SSL' ) . '">Forgot Passsword?</a>'; ?></li>
</ul>
 </div>
<br clear="both" />
<hr>
