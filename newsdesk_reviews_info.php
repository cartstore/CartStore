...
<table border="0" width="100%" cellspacing="0" cellpadding="0">
	...
	<tr>
		<td class="newdeskmain"><b><?php echo SUB_TITLE_PRODUCT; ?></b> <?php echo $product_info_values['newsdesk_article_name']; ?></td>
		<td class="smallText" rowspan="3" align="center">
<?php echo tep_image(DIR_WS_IMAGES . $product_info_values['newsdesk_image'], $product_info_values['newsdesk_article_name'], SMALL_IMAGE_WIDTH, SMALL_IMAGE_HEIGHT, 'align="center" hspace="5" vspace="5"'); ?>
		</td>
	</tr>
	<tr>
		<td class="newdeskmain"><b><?php echo SUB_TITLE_FROM; ?></b> <?php echo $reviews_values['customers_name']; ?></td>
	</tr>
	<tr>
		<td class="newdeskmain"><b><?php echo SUB_TITLE_DATE; ?></b> <?php echo tep_date_long($reviews_values['date_added']); ?></td>
	</tr>
</table>
		</td>
	</tr>
	<tr>
		<td class="newdeskmain"><b><?php echo SUB_TITLE_REVIEW; ?></b></td>
	</tr>
	<tr>
